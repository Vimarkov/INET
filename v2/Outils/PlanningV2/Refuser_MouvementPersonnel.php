...
<head>
	...
	<script language="javascript">
		...
		{
			window.opener.location="Liste_MouvementPersonnel.php?Menu="+Menu+"&TDB="+TDB+"&OngletTDB="+OngletTDB;
			window.close();
		}
	</script>
</head>
...
if($_POST){
	$requeteUpdate="UPDATE rh_personne_mouvement SET 
			...
			EtatValidation=-1,
			Id_RaisonRefus=".$_POST['raisonRefus'].",
...
<form id="formulaire" class="test" action="Refuser_MouvementPersonnel.php" method="post" onsubmit=" return VerifChamps();">
