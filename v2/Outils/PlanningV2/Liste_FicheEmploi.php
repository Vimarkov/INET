...
<script type="text/javascript">
	function OuvreFenetreModif(Mode,Id)
	{
		...
		{
			var w= window.open("Ajout_FicheEmploi.php?Mode="+Mode+"&Id="+Id,"PageLieu","status=no,menubar=no,width=450,height=200");
			w.focus();
		}
	}
</script>
		...
		<td colspan="5">
			<table class="GeneralPage" style="width:100%; border-spacing : 0; background-color:#a988b2;">
				<tr>
					...
					if($LangueAffichage=="FR"){echo "Contrats # Fiche emploi";}else{echo "Contracts # Job sheet";}
					?>
					</td>
				</tr>
			</table>
	...
	<tr>
		...
		<td align="left">
			<table class="TableCompetences" width="30%">
				<tr>
					<td class="EnTeteTableauCompetences" width="50%"><?php if($_SESSION["Langue"]=="FR"){echo "Libellé";}else{echo "Wording";}?></td>
					<td class="EnTeteTableauCompetences" width="45%"><?php if($_SESSION["Langue"]=="FR"){echo "Cotation";}else{echo "Quotation";}?></td>
			...
			?>
				<tr bgcolor="<?php echo $Couleur;?>">
					...
					<td><?php echo stripslashes($row['Cotation']);?></td>
					<td>
