...
<head>
	...
	<script type="text/javascript">
		...
		{
			window.opener.location="Liste_RaisonRefusMouvementPersonnel.php?Menu="+Menu;
			window.close();
		}
	</script>
</head>
...
if($_POST)
{
	if($_POST['Mode']=="Ajout")
	{
		...
		$requeteInsertUpdate.="'MouvementPersonnel'";
		$requeteInsertUpdate.=")";
	}
	else
	{		
...
?>
		<form id="formulaire" enctype="multipart/form-data" method="POST" action="Ajout_RaisonRefusMouvementPersonnel.php" onSubmit="return VerifChamps();">
