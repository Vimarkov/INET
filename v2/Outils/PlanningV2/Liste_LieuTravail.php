...
<script type="text/javascript">
	function OuvreFenetreModif(Mode,Id)
	{
		...
		{
			var w= window.open("Ajout_LieuTravail.php?Mode="+Mode+"&Id="+Id,"PageLieu","status=no,menubar=no,width=450,height=200");
			w.focus();
		}
	}
</script>
		...
		<td colspan="5">
			<table class="GeneralPage" style="width:100%; border-spacing : 0; background-color:#a988b2;">
				<tr>
					...
					if($LangueAffichage=="FR"){echo "Contrats # Lieu de travail";}else{echo "Contracts # Workplace";}
					?>
					</td>
				</tr>
			</table>
	...
	<tr>
		...
		<td align="left">
			<table class="TableCompetences" width="30%">
				<tr>
					<td class="EnTeteTableauCompetences" width="95%"><?php if($_SESSION["Langue"]=="FR"){echo "Libellé";}else{echo "Wording";}?></td>
