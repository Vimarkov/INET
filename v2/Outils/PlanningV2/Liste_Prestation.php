		...
		<td colspan="5">
			<table class="GeneralPage" style="width:100%; border-spacing : 0; background-color:#edf430;">
				<tr>
					...
					if($LangueAffichage=="FR"){echo "Congés / Absences # Prestation";}else{echo "Leave / Absence # Site";}
					?>
					</td>
				</tr>
			</table>
		...
		<td align="left">
			<table class="TableCompetences" width="60%">
				<tr>
					...
					<td class="EnTeteTableauCompetences" width="20%"><?php if($_SESSION["Langue"]=="FR"){echo "Nb niveau de validation des congés";}else{echo "Number of leave validation levels";}?></td>
