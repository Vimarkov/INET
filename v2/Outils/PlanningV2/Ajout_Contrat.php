				...
				<tr><td>
					<table class="TableCompetences" width="90%" align="center" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td width="10%" class="Libelle agence" style="display:none;"><?php if($_SESSION["Langue"]=="FR"){echo "Agence d'intérim : ";}else{echo "Acting Agency : ";} ?><?php echo $etoile;?></td>
						...
						<tr class="agence" style="display:none;">
							...
							<td width="10%">
								<select name="typeCoeff" id="typeCoeff" style="width:100px" onchange="Afficher_CoeffFacturation();">
									...
									<option value="Delegation"><?php if($_SESSION["Langue"]=="FR"){echo "Délégation";}else{echo "Delegation";} ?></option>
								</select>
							</td>
						...
						<tr><td height="4"></td></tr>
						<tr>
							<td width="10%" class="Libelle" valign="top"><?php if($_SESSION["Langue"]=="FR"){echo "Classification métier :";}else{echo "Business Classification :";} ?></td>
							<td width="10%" valign="top">
						...
						<tr><td height="4"></td></tr>
						<tr>
							<td width="10%" class="Libelle" valign="top"><?php if($_SESSION["Langue"]=="FR"){echo "Salaire de référence conventionnel 2024: ";}else{echo "Conventional reference salary 2024: ";} ?><?php echo $etoile;?></td>
							<td width="10%" valign="top">
						...
						<tr><td height="4"></td></tr>
						<tr>
							<td width="10%" class="Libelle"><?php if($_SESSION["Langue"]=="FR"){echo "Date de début : ";}else{echo "Start date : ";} ?><?php echo $etoile;?></td>
							<td width="10%">
						...
						<tr><td height="4"></td></tr>
						<tr>
							<td width="10%" class="Libelle"><?php if($_SESSION["Langue"]=="FR"){echo "Date de fin période d'essai :";}else{echo "End date of the trial period :";} ?> </td>
							<td width="10%">
						...
						<tr><td height="4"></td></tr>
						<tr>
							<td width="10%" class="Libelle"><?php if($_SESSION["Langue"]=="FR"){echo "Date souplesse négative :";}else{echo "Negative flexibility date :";} ?> </td>
							<td width="10%">
						...
						<tr><td height="4"></td></tr>
						<tr>
							<td width="10%" class="Libelle"><?php if($_SESSION["Langue"]=="FR"){echo "Unité d'exploitation d'affectation :";}else{echo "Operating unit of assignment :";} ?></td>
							<td width="10%">
