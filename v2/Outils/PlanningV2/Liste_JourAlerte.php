...
<script type="text/javascript">
	function OuvreFenetreModif(Mode,Id)
	{
		...
		{
			var w= window.open("Ajout_JourAlerte.php?Mode="+Mode+"&Id="+Id,"PageLieu","status=no,menubar=no,width=550,height=200");
			w.focus();
		}
	}
</script>
		...
		<td colspan="5">
			<table class="GeneralPage" style="width:100%; border-spacing : 0; background-color:#edf430;">
				<tr>
					...
					if($LangueAffichage=="FR"){echo "Congés / Absences # Jour d'alerte";}else{echo "Leave / Absence # Alert day";}
					?>
					</td>
				</tr>
			</table>
