	...
	if($Id_Personne<>"" && $Id_Personne<>"0"){
		...
		if($nb>0){
			if($_SESSION['Langue']=="FR"){
				$Attention="<img width='25px' src='../../Images/attention.png'/>Des absences sont déjà déclarées pendant ce créneau ";
			}
			else{
				$Attention="<img width='25px' src='../../Images/attention.png'/>Absences are already declared during this date window";
			}
		}
	}
}
