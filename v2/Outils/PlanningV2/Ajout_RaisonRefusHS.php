...
<head>
	...
	<script type="text/javascript">
		...
		{
			window.opener.location="Liste_RaisonRefusHS.php?Menu="+Menu;
			window.close();
		}
	</script>
</head>
...
if($_POST)
{
	if($_POST['Mode']=="Ajout")
	{
		...
		$requeteInsertUpdate.="'HeureSupplementaire'";
		$requeteInsertUpdate.=")";
	}
	else
	{		
...
?>
		<form id="formulaire" enctype="multipart/form-data" method="POST" action="Ajout_RaisonRefusHS.php" onSubmit="return VerifChamps();">
