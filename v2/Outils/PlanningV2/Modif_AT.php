...
<head>
	...
	<script language="javascript" src="AccidentTravail.js"></script>
...
<form id="formulaire" enctype="multipart/form-data" class="test" action="Modif_AT.php" method="post">
					...
					<table class="TableCompetences" width="90%" align="center" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td <?php if($Menu==3){echo "width='60%'";}else{echo "width='10%'";} ?>>
								...
								?>
								<input name="contrat" id="contrat" size="10" value="<?php echo $rowContrat['Libelle']; ?>" readonly="readonly">
								...
								<select name="Id_PrestationPole" id="Id_PrestationPole" class="Id_PrestationPole" <?php echo $disabled; ?> style="width:400px">
									...
									<?php
										...
										while($rowsite=mysqli_fetch_array($resultsite))
										{
											...
											echo "<script>Liste_PrestaPole[".$i."] = new Array(".$rowsite['Id'].",".$rowsite['Id_Pole'].",".$rowsite['Id_Plateforme'].");</script>";
											$i++;
										}
									?>
								</select>
