...
<head>
	...
	<script type="text/javascript">		
		...
		{
			window.opener.location="Liste_PoleAdresse.php?Menu="+Menu;
			window.close();
		}
	</script>
</head>
...
if($_POST)
{	
	$requeteInsertUpdate="UPDATE new_competences_pole SET";
...
elseif($_GET)
{
	...
	if($_GET['Mode']=="Ajout" || $_GET['Mode']=="Modif")
	{
		...
		{
			$Modif=True;
			$result=mysqli_query($bdd,"SELECT Id,Libelle, Adresse FROM new_competences_pole WHERE Id=".$_GET['Id']."");
			$row=mysqli_fetch_array($result);
		}
?>
		<form id="formulaire" enctype="multipart/form-data" method="POST" action="Ajout_PoleAdresse.php">
