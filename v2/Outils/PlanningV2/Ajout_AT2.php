...
if($_POST){
	if(isset($_POST['btnEnregistrer2'])){
		...
		$req="INSERT INTO rh_personne_at (Id_Personne,Id_Createur,Id_Prestation,Id_Pole,Id_Metier,Id_Lieu_AT,FichierPassageInfirmerie,
				DateCreation,DateAT,HeureAT,Id_TypeContrat,Contrat,Adresse,CP,Ville,NumSecurite,DateNaissance,Anciennete,HeureDebutAM,HeureFinAM,
			...
			VALUES 
				...
				".$_POST['lieus'].",'".$fichierPassage."','".$DateJour."','".TrsfDate_($_POST['dateAT'])."','".$_POST['heureAT']."',".$_POST['Id_Contrat'].",'".addslashes($_POST['contrat'])."',
		...
		if($IdCree>0){
			...
			if($nbPresta>0){
				...
				//Resp Plateforme, Resp HSE, Resp RH, Assistant RH + backup, Coor sécurité
				...
				$reqMail="SELECT DISTINCT EmailPro 
						...
						OR (new_competences_personne_poste_plateforme.Id_Poste IN (15,41)
							AND new_competences_personne_poste_plateforme.backup=0
			...
			echo "<script>window.location='Tableau_De_Bord.php?Menu=1';</script>";
		}
	}
}
...
if(DroitsFormation1Plateforme("1,3,4,5,9,10,13,17,19,23,24,27,28,29",array($IdPosteResponsableRH,$IdPosteAssistantRH,$IdPosteOperateurSaisieRH))){
	$etoile="";
	$RH="1";
}
?>

<form id="formulaire" enctype="multipart/form-data" class="test" action="Ajout_AT2.php" method="post">
<table width="100%" cellpadding="0" cellspacing="0" align="center">
	<input type="hidden" name="Langue" id="Langue" value="<?php echo $_SESSION['Langue']; ?>" />
	<input type="hidden" name="RH" id="RH" value="<?php echo $RH; ?>" />
					...
					<table class="TableCompetences" width="95%" align="center" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td width="10%">
								...
								$rq="SELECT DISTINCT new_rh_etatcivil.Id, CONCAT (new_rh_etatcivil.Nom,' ',new_rh_etatcivil.Prenom) AS Personne
									...
									(
										...
										OR 
										CONCAT(Id_Prestation,'_',Id_Pole) IN 
										(
							...
							<?php 
								...
								$reqPers="SELECT Id, Adresse,CP,Ville,Num_SS,Date_Naissance,DateAncienneteCDI,Contrat 
										FROM new_rh_etatcivil
								...
								if($nbPers>0){
									...
									if($Contrat==""){
										$Contrat=$rowPers['Contrat'];
										if($Contrat=="Intérimaire"){
											$Est_Interim=1;
										}
									}
						...
						<tr>
							...
							<td width="10%">
								<select name="metier" id="metier" style="width:250px">
								<?php
							...
							<?php
								...
								if($Id_PrestaPole==0){
									$Id_PrestaPole=PrestationPoleCompetence_Personne($dateAT,$Id_Personne);
								}
							?>
						...
						<tr><td height="4"></td></tr>
						<tr>
							<td width="10%" class="Libelle"><?php if($_SESSION["Langue"]=="FR"){echo "Prestation : ";}else{echo "Site : ";} ?><?php echo $etoile; ?></td>
							<td width="10%">
						...
						<tr>
							...
							<td colspan="4">
									...
									echo "<tr>
										<td width='25%'>Conditions climatiques particulières : </td>
										<td width='15%'><input type='checkbox' class='conditions' name='conditionsClim' id='conditionsClim' ".$valeur."></td>
										<td width='60%' rowspan='2'><textarea name='commentaireCondition1' id='commentaireCondition1' cols='30' rows='2' noresize='noresize'>";
									...
									echo "<tr>
											<td width='25%'>Mauvais état des infrastructures : </td>
									...
									echo "<tr>
										<td width='25%'><input type='radio' class='trajet' name='trajet' value='1' ".$select1.">Trajet Aller</td>
									...
									echo "<tr>
											<td width='25%'>Horaires de travail spécifiques : </td>
											<td width='15%'><input type='checkbox' class='conditions' name='horairesSpec' id='horairesSpec' ".$valeur."></td>
											<td width='60%' rowspan='2'><textarea name='commentaireCondition2' id='commentaireCondition2' cols='30' rows='2' noresize='noresize'>";
									...
									echo "<tr>
											<td width='25%'>Problème technique du véhicule accidenté : </td>
						...
						<tr>
							...
							else{echo "Immediate security actions (Ex: defective tool isolation / marking / stopping the intervention / awareness of the rest of the team ...)";} ?><?php echo $etoile; ?></td>
						</tr>
						<tr>
							<td colspan="2">
