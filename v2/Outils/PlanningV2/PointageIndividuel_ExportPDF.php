...
$reqPrestation = "SELECT Libelle, Code_Analytique FROM new_competences_prestation WHERE Id='".$_SESSION['FiltreRHPlanning_Prestation']."'";
...
if ($nbPrestation>0)
{
	...
	$NomPrestation = $row['Libelle'];
	$codePrestation = AfficheCodePrestation($NomPrestation);
	$codeAnalytique = $row['Code_Analytique'];
}
...
$DateCalcul = date("Y-m-01",strtotime($_SESSION['FiltreRHPlanning_DateDebut']." +0 day"));
...
$dateFin = date("Y-m-1",strtotime($_SESSION['FiltreRHPlanning_DateDebut']." +0 day"));
...
$Personne = "";
$MatriculeAAA="";
$reqPers = "SELECT Nom, Prenom, IF(MatriculeAAA<>'',MatriculeAAA,MatriculeDaher) AS MatriculeAAA FROM new_rh_etatcivil WHERE Id=".$IdPersonne."";
...
$formulaire.="
<table width='100%' style='background-color:#ffffff;' height='100%'>
	<tr>
		<td width='10%' rowspan='3'><img width='80px' src='../../Images/Logos/Logo Daher_posi.png' border='0' /></td>
	</tr>
	<tr>
		<td width='10%'></td>
		<td width='80%' height='10px' style='font:bold 14px;border:1px black solid;border-spacing:1px 1px;' align='center'>Relevé d'Heures Individuel Mensuel</td>
		<td width='10%'></td>
	</tr>
</table>
<table width='100%' style='background-color:#ffffff;'>
	<tr>
		<td style='font:bold 10px;' width='15%'>Matricule</td>
		<td width='20%' height='10px' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$MatriculeAAA."</td>
		<td width='10%'></td>
		<td style='font:bold 10px;' width='15%'>Code analytique</td>
		<td width='25%' height='10px' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$codeAnalytique."</td>
		<td width='5%'></td>
	<tr>
		<td style='font:bold 10px;'>Nom / Prénom</td>
		<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$Personne."</td>
		<td></td>
		<td style='font:bold 10px;'>Divers</td>
		<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'></td>
	</tr>
	<tr>
		<td style='font:bold 10px;'>Plateforme / Site</td>
		<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$codePrestation."</td>
		<td></td>
		<td style='font:bold 10px;'>Mois / Année</td>
		<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$MoisLettre[$moisAffichage-1]." ".$annee."</td>
	</tr>
</table>
<table width='100%' style='background-color:#ffffff;border-spacing : 0;'>
	<tr>
		<td width='47%'>
			<table width='100%' style='background-color:#ffffff;border-spacing : 0;'>
				<tr>
					...
					<td></td>
					<td></td>
					<td colspan='3' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>EQUIPE</td>
					<td></td>
				</tr>
				<tr>
					<td width='8%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'></td>
					<td width='10%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center' height='14px'>Date</td>
					<td width='10%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>Formation</td>
					<td width='10%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>Jour</td>
					<td width='10%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>Nuit</td>
					<td width='10%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>Jour</td>
					<td width='10%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>Nuit</td>
					<td width='10%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>Pause</td>
					<td width='15%'></td>
				</tr>
";
...
$ligne = 15 + $JourCalcul;
$divers="";
$JourLettre = array("Lu", "Mar", "Me", "Je", "Ve", "Sa", "Di");
$leJour=0;
$nbPanier=0;
...
while($i < $JourCalcul){
	$formulaire.="
		<tr>
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='14px' align='left'>".$JourLettre[$leJour]."</td>
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'></td>
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'></td>
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'></td>
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'></td>
			...
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'></td>
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'></td>
			<td style='font:8px;border-spacing:1px 1px;' align='center'></td>
		</tr>
	";
	
	$leJour++;
	if($leJour==7){$leJour=0;}
	$j++;
	$i++;
}
...
while ($DateCalcul  < $dateFin)
{
	...
	if(appartientPrestation($DateCalcul,$IdPersonne,$PrestationSelect,$PoleSelect)==1){
		if ($Couleur == ""){
		...
		$sousTotalForm+=$nbHeureForm;
		if (is_numeric($nbHeureJ)){$sousTotalJour+=$nbHeureJ;}
		$sousTotalEJ+=$nbHeureEJ;
		$sousTotalEN+=$nbHeureEN;
		$sousTotalPause+=$nbHeurePause;
		
		$TotalForm+=$nbHeureForm;
		if (is_numeric($nbHeureJ)){$TotalJour+=$nbHeureJ;}
		$TotalEJ+=$nbHeureEJ;
		$TotalEN+=$nbHeureEN;
		$TotalPause+=$nbHeurePause;
		...
		if($contenu=="VSD" || ($nbHeureJ=="" && $nbHeurePause=="0.5")){
			$nbPanier++;
		}
		if($nbHeureJ<>"" || $nbHeureForm<>"" || $nbHeureEJ<>"" || $nbHeureEN<>"" || $nbHeurePause<>"" || $valAstreinte<>""){
			$cellPrest=$Prestation;
		}
		if($nbHeureJ=="CP" || $nbHeureJ=="CPA" || $nbHeureJ=="CA"){$CP++;}
		elseif($nbHeureJ=="RTT" || $nbHeureJ=="RTTE" || $nbHeureJ=="RTTS"){$RTT++;}
		elseif($nbHeureJ=="MAL" || $nbHeureJ=="AM" || $nbHeureJ=="MA"){$MAL++;}
		elseif($nbHeureJ=="AT"){$AT++;}
		elseif($nbHeureJ=="MAT" || $nbHeureJ=="PAT"){$MAT++;}
		elseif($nbHeureJ=="AD"){$AD++;}
		elseif($nbHeureJ=="CSS"){$CSS++;}
		elseif($nbHeureJ=="ABS"){$ABS++;}
		elseif($nbHeureJ=="F"){$F++;}
		elseif($nbHeureJ=="EVT FAM" || $nbHeureJ=="EM (50%)" || $nbHeureJ=="EM (100%)" || $nbHeureJ=="NAI" || $nbHeureJ=="DEC"){$EVT++;}
		elseif($nbHeureJ=="RC"){$RC++;}
		
			$formulaire.="
			<tr>
				<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='14px' align='left'>".$JourLettre[$leJour]."</td>
				<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$tabDate[2]."</td>
				<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$nbHeureForm."</td>
				<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$nbHeureJ.$valAstreinte."</td>
				<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'></td>
				<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$nbHeureEJ."</td>
				<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$nbHeureEN."</td>
				<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$nbHeurePause."</td>
				<td style='font:8px;border-spacing:1px 1px;' align='center'>".$cellPrest."</td>
			</tr>
		";
		...
		if(($nbHeureEJ+$nbHeureEN+$nbHeurePause)>=3.5){
			$R1220++;
		}
		if($nbHeureEN>=6.5){
			$R8025++;
	...
	if($leJour==7){
		$leJour=0;
		$sousTotal=$sousTotalForm+$sousTotalJour+$sousTotalEJ+$sousTotalEN+$sousTotalPause;
		$formulaire.="
		<tr>
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='14px' align='left' colspan=2>Sous-Total</td>
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$sousTotalForm."</td>
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$sousTotalJour."</td>
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>0</td>
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$sousTotalEJ."</td>
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$sousTotalEN."</td>
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$sousTotalPause."</td>
			<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$sousTotal."</td>
		</tr>
		";
		$sousTotalForm=0;
		$sousTotalJour=0;
...
$Total=$TotalForm+$TotalJour+$TotalEJ+$TotalEN+$TotalPause;
$formulaire.="
			</table>
		</td>
	</tr>
	...
	<tr>
		<td width='47%'>
			<table width='100%' style='background-color:#ffffff;border-spacing : 0;'>
				<tr>
					<td style='font:bold 12px;' width='48%' height='14px'>Date</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' width='35%' align='center'></td>
					<td style='font:10px;' width='10%'></td>
				</tr>
			</table>
		</td>
		<td width='6%'>
		...
		<td width='47%'>
			<table width='100%' style='background-color:#ffffff;border-spacing : 0;'>
				<tr>
					<td width='15%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='14px' align='left' colspan=2>Total mois</td>
					<td width='10%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$TotalForm."</td>
					<td width='10%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$TotalJour."</td>
					<td width='10%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>0</td>
					<td width='10%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$TotalEJ."</td>
					<td width='10%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$TotalEN."</td>
					<td width='10%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$TotalPause."</td>
					<td width='10%' style='font:10px;border:1px black solid;border-spacing:1px 1px;' align='center'>".$Total."</td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td width='47%'>
			<table width='100%' style='background-color:#ffffff;border-spacing : 0;'>
				<tr>
					<td style='font:bold 10px;border:1px black solid;border-spacing:1px 1px;' width='30%' height='15px'>Signature Salarié</td>
					<td style='font:bold 12px;' width='18%' height='15px'></td>
					<td style='font:bold 10px;border:1px black solid;border-spacing:1px 1px;' width='35%' align='center'>Signature Resp AAA</td>
					<td style='font:10px;' width='10%'></td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td width='47%'>
			<table width='100%' style='background-color:#ffffff;border-spacing : 0;'>
				<tr>
					<td style='font:bold 8px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:bold 8px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:bold 8px;' height='15px' align='center'></td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' colspan='2' align='center'>ABSENCES</td>
					<td style='font:bold 8px;' height='15px' align='center'></td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' align='center' height='15px'>DIVERS</td>
				</tr>
				<tr>
					<td style='font:bold 8px;' height='15px' align='center' width='10%'></td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center' width='10%'>CP/CPA</td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center' width='10%'>".$CP."</td>
					<td style='font:bold 8px;' height='15px' align='center' width='10%'></td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' align='center' height='15px' rowspan='11' width='60%'>".$divers."</td>
				</tr>
				<tr>
					<td style='font:bold 8px;' height='15px' align='center'></td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>RTT</td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>".$RTT."</td>
					<td style='font:bold 8px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:bold 8px;' height='15px' align='center'></td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>MAL</td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>".$MAL."</td>
					<td style='font:bold 8px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:bold 8px;' height='15px' align='center'></td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>AT</td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>".$AT."</td>
					<td style='font:bold 8px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:bold 8px;' height='15px' align='center'></td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>MAT/PAT</td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>".$MAT."</td>
					<td style='font:bold 8px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:bold 8px;' height='15px' align='center'></td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>AD</td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>".$AD."</td>
					<td style='font:bold 8px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:bold 8px;' height='15px' align='center'></td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>CSS</td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>".$CSS."</td>
					<td style='font:bold 8px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:bold 8px;' height='15px' align='center'></td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>ABS</td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>".$ABS."</td>
					<td style='font:bold 8px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:bold 8px;' height='15px' align='center'></td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>F</td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>".$F."</td>
					<td style='font:bold 8px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:bold 8px;' height='15px' align='center'></td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>EVT<BR>FAM</td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>".$EVT."</td>
					<td style='font:bold 8px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:bold 8px;' height='15px' align='center'></td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>RC</td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>".$RC."</td>
					<td style='font:bold 8px;' height='15px' align='center'></td>
				</tr>
			</table>
		...
		<td width='47%'>
			<table width='100%' style='background-color:#ffffff;border-spacing : 0;'>
				<tr>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;' height='15px' colspan='4' align='center'>A RENSEIGNER PAR LE SIEGE</td>
					<td style='font:bold 8px;border:1px black solid;border-spacing:1px 1px;background-color:#d8e4bc;' align='center' height='15px' colspan='3'>A RENSEIGNER PAR LA PLATEFORME</td>
				</tr>
				<tr>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' width='10%' height='15px'>R 335</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' width='15%' height='15px' align='center'>".$TotalEN."</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' width='10%' height='15px' align='center'>X</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' width='10%' height='15px' align='center'></td>
					
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' width='10%' height='15px' >R 6510</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' width='15%' height='15px' align='center'>Travail de nuit</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' width='8%' height='15px' align='center'></td>
					<td width='5%'></td>
				</tr>
				<tr>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px'>R 370</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>".$TotalPause."</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>X</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
					
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px'>R 6511</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>Travail équipe nuit</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px'>R 1220</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>".$R1220."</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>X</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>13.5</td>
					
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;background-color:#eaeaea;' height='15px' rowspan='2'></td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;background-color:#eaeaea;' height='15px' rowspan='2' align='center'></td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;background-color:#eaeaea;' height='15px' rowspan='2' align='center'></td>
				</tr>
				<tr>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px'>R 1262</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>X</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px'>R 8025</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>".$R8025."</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>X</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>3</td>
				...
				<tr>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px'>R 8030</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>X</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>5</td>
				</tr>
				<tr>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px'>R 8240</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>X</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
				...
				<tr>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px'>R 8250</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>X</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px'>R 8254</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>X</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
				...
				<tr>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px'>R 80306</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>".$nbPanier."</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>X</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>0.8</td>
				</tr>
				<tr>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px'>R 8263</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>X</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
				...
				<tr>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px'>R 8370</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>X</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
				</tr>
				<tr>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px'>R 8375</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>X</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
				...
				<tr>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px'>R 8035</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'>X</td>
					<td style='font:10px;border:1px black solid;border-spacing:1px 1px;' height='15px' align='center'></td>
				</tr>
	...
	<tr>
		<td colspan='3' style='font:9px;border-spacing:1px 1px;'>
			D-0708 - FR Edition 1
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			DOCUMENT QUALITE AAA - FR
		</td>
	</tr>
	<tr>
		<td colspan='3' style='font:9px;border-spacing:1px 1px;'>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Reproduction interdite sans autorisation écrite de AAA - FR   
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Page 1/1			
