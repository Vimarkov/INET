...
<head>
	...
	<script type="text/javascript">
		...
		{
			window.opener.location="Liste_RaisonRefusConges.php?Menu="+Menu;
			window.close();
		}
	</script>
</head>
...
if($_POST)
{
	if($_POST['Mode']=="Ajout")
	{
		...
		$requeteInsertUpdate.="'DemandeAbsence'";
		$requeteInsertUpdate.=")";
	}
	else
	{		
...
?>
		<form id="formulaire" enctype="multipart/form-data" method="POST" action="Ajout_RaisonRefusConges.php" onSubmit="return VerifChamps();">
