...
<script type="text/javascript">
	function OuvreFenetreModif(Mode,Id)
	{
		...
		{
			var w= window.open("Ajout_RaisonRefusHS.php?Mode="+Mode+"&Id="+Id,"PageLieu","status=no,menubar=no,width=450,height=200");
			w.focus();
		}
	}
</script>
		...
		<td colspan="5">
			<table class="GeneralPage" style="width:100%; border-spacing : 0; background-color:#11b9a7;">
				<tr>
					...
					if($LangueAffichage=="FR"){echo "Heures supplémentaires # Raisons de refus de validation";}else{echo "Overtime # Reasons for refusal of validation";}
					?>
					</td>
				</tr>
			</table>
