...
function completerReleve($sheet,$IdPersonne,$DateCalcul,$dateFin,$Id_Agence,$Id_Plateforme){
	...
	$sheet->setCellValue('I12',"BROUILLON");
	$sheet->getStyle('I12')->applyFromArray(array('fill'=>array('type'=>PHPExcel_Style_Fill::FILL_SOLID,'color'=>array('argb'=>'f40000'))));
