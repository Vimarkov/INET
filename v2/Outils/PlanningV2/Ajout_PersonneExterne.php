...
<script type="text/javascript">
	function Enregistrer(){
		...
		if(document.getElementById('Langue').value=="FR"){
			...
			if(formulaire.contrat.value==""){valide=false;alert("Veuillez compléter le contrat");return false;}
			if(formulaire.societe.value==""){valide=false;alert("Veuillez compléter la nom de la société");return false;}
		}
		else{
			...
			<table class="GeneralPage" style="width:100%; border-spacing:0; background-color:#f53939;">
				<tr>
					...
					<?php
						...
						echo "</a>"; 
						echo "&nbsp;&nbsp;&nbsp;";
						if($_SESSION["Langue"]=="FR"){echo "Déclaration d'une personne externe";}else{echo "Declaration of an external person";}
					?>
					</td>
				</tr>
			</table>
				...
				<tr><td>
					<table class="TableCompetences" width="90%" align="center" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td class="Libelle">Société :<?php echo $etoile;?></td>
						...
						<tr>
							<td colspan="6" class="cEmail">
								<i><?php 
									if($_SESSION["Langue"]=="FR"){echo "Veuillez vous adresser au service informatique (informatique.aaa@daher.com) si cette personne a besoin d'un accès à l'Extranet";}
