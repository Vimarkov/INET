...
if($_POST)
{
	if(isset($_POST['btnValider']) || isset($_POST['btnValiderModePapier']))
	{
		...
		if(isset($_POST['btnValiderModePapier'])){
			...
			echo "<script>window.location='Tableau_De_Bord.php?Menu=28';</script>";
		}
		else{
...
<table class="TableCompetences" style="width:70%; height:95%; align:center;">
	<tr>
	...
	<tr>
		<td colspan="5" align="center">
			<input class="Bouton" name="btnValider" type="submit" onclick="return VerifChampsSurveillanceP();" <?php if($LangueAffichage=="FR"){echo "value='Réaliser la surveillance immédiatement'";}else{echo "value='Perform monitoring immediately'";}?>/>
		</td>
		<td colspan="5" align="center">	
