...
if($_POST){
	if($_POST['Mode']=="A"){
		$req="INSERT INTO soda_superadministrateur (Id_Personne) VALUES (".$_POST['personne'].")";
			...
			<tr class="TitreColsUsers">
				...
				<td>
					...
					if($_GET['Mode']=="A"){
						...
						$req="SELECT DISTINCT new_rh_etatcivil.Id, Nom, Prenom FROM new_rh_etatcivil WHERE Id NOT IN (SELECT Id_Personne FROM soda_superadministrateur) ORDER BY Nom, Prenom;";
						$result=mysqli_query($bdd,$req);
...
<?php
	...
	//Mode suppression
	{
		$req="DELETE FROM soda_superadministrateur WHERE Id_Personne=".$_GET['Id'];
		$result=mysqli_query($bdd,$req);
