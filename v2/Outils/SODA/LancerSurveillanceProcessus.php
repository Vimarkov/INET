				...
				for($p=0;$p<3;$p++){
					if(isset($_POST['Id_Questionnaire_'.$value.'_'.$p]) && $_POST['Id_Questionnaire_'.$value.'_'.$p]<>0){
						...
						if($nbQuestionnaire>0){
							...
							$req="INSERT INTO soda_surveillance (Id_Old,Id_PlannifManuelle,Id_Questionnaire,Id_Plateforme,Id_Surveillant,Id_Surveille,Id_Metier,AutoSurveillance,DateSurveillance,Etat,DateHeureCreation,Enformation) 
							VALUES (".$_POST['Id_Old'].",".$_POST['Id'].",".$_POST['Id_Questionnaire_'.$value.'_'.$p].",".$_POST['Id_Plateforme'].",".$_SESSION['Id_Personne'].",".$_POST['Id_Surveille']."
