...
if($_SESSION['FiltreSODATDBOperation_Plage']=="12"){
...
$req = "SELECT soda_surveillance_question.Id_Question,
		...
		(SELECT Question FROM soda_question WHERE Id=Id_Question) AS Question,
			...
			AND YEAR(tab.DateSurveillance)='".$_SESSION['FiltreSODATDBProcessus_Plage']."'
		...
		AND YEAR(soda_surveillance.DateSurveillance)='".$_SESSION['FiltreSODATDBProcessus_Plage']."'
