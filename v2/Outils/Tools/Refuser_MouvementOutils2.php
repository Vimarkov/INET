...
if($_POST){
	...
	$req="SELECT Id_Materiel__Id_Caisse, Type FROM tools_mouvement WHERE Id=".$_POST['Id']." ";
	...
	echo "<script>FermerEtRecharger(".$_POST['Id_O'].",".$_POST['CaisseMateriel'].");</script>";
}

?>

<form id="formulaire" class="test" action="Refuser_MouvementOutils2.php" method="post" onsubmit=" return VerifChamps();">
<table width="100%" cellpadding="0" cellspacing="0" align="center">
	<input type="hidden" name="Langue" id="Langue" value="<?php echo $_SESSION['Langue']; ?>" />
	<input type="hidden" name="Id" id="Id" value="<?php echo $_GET['Id']; ?>" />
	<input type="hidden" name="CaisseMateriel" id="CaisseMateriel" value="<?php echo $_GET['CaisseMateriel']; ?>" />
	<input type="hidden" name="Id_O" id="Id_O" value="<?php echo $_GET['Id_Outil']; ?>" />
	<tr>
		<td>
