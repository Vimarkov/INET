...
if($_POST){
	...
	$_SESSION['FiltrePerteMateriel_Plateformes']=$Id_Platef;
	$_SESSION['FiltrePerteMateriel_Prestations']=$Id_Presta;
	$_SESSION['FiltrePerteMateriel_Types']=$Id_Type;
	$_SESSION['FiltrePerteMateriel_DateDebut']=$_POST['DateDebut'];
	$_SESSION['FiltrePerteMateriel_DateFin']=$_POST['DateFin'];
	$_SESSION['FiltrePerteMateriel_ModeAffichage']=$_POST['ModeAffichage'];
	$_SESSION['FiltrePerteMateriel_Plateforme']=$_POST['Id_Plateforme'];
} 
?>
...
<tr>
						...
						if($_POST){
							if($_POST['DateDebut']<>"" && $_POST['DateFin']<>""){
								...
								if($dateFin>=$dateDebut){
									...
									if($_SESSION['FiltrePerteMateriel_ModeAffichage']=="Plateforme"){
			...
			<tr>
				<td height="400px;">
					<table class="TableCompetences" width="99%" height="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td class="Libelle" height="5%" style="font-size:15px;"><?php if($_SESSION['Langue']=="FR"){echo "NOMBRE DE PERTES / ".$titre;}else{echo "NUMBER OF LOSSES / ".$titre;} ?></td>
		...
		<table>
			<tr>
				<td height="400px;">
					<table class="TableCompetences" width="99%" height="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td class="Libelle" height="5%" style="font-size:15px;"><?php if($_SESSION['Langue']=="FR"){echo "NOMBRE DE PERTES / MOIS";}else{echo "NUMBER OF LOSSES / MONTH";} ?></td>
							<td style="cursor:pointer;" align="right"></td>
						</tr>
						<tr><td style="border-bottom:2px solid #0b6acb;" colspan="2" height="4"></td></tr>
						<tr><td height="4"></td></tr>
	...
	<td align="right" valign="top" width="25%">
		<table class="GeneralInfo" style="border-spacing:0; width:70%; align:center;box-shadow: 0 8px 10px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);">
			...
			<tr>
				<td class="Libelle" width="10%"><input type="date" style="text-align:center;"id="DateDebut" name="DateDebut" size="10" value="<?php echo AfficheDateFR($_SESSION['FiltrePerteMateriel_DateDebut']); ?>"></td>
			</tr>
			<tr>
				<td class="Libelle" width="10%"><?php if($LangueAffichage=="FR"){echo "Date fin";}else{echo "End date";}?> : </td>
			</tr>
			<tr>
				<td class="Libelle" width="10%"><input type="date" style="text-align:center;"id="DateFin" name="DateFin" size="10" value="<?php echo AfficheDateFR($_SESSION['FiltrePerteMateriel_DateFin']); ?>"></td>
			</tr>
			...
			<tr style="display:none;">
				<td>
					...
					$selected="";
					if($_SESSION['FiltrePerteMateriel_ModeAffichage']=='Plateforme'){$selected="selected";}
					...
					$selected="";
					if($_SESSION['FiltrePerteMateriel_ModeAffichage']=='Prestation'){$selected="selected";}
					...
					$mode=$_SESSION['FiltrePerteMateriel_ModeAffichage'];
					echo "</select>";
					?>
				</td>
			</tr>
			...
			<tr <?php if($_POST){if($mode=="Plateforme"){echo "style='display:none';";} }else{echo "style='display:none';";} ?>>
				<td>
					...
					$Id_Plateforme=$_SESSION['FiltrePerteMateriel_Plateformes'];
					if($_POST)
					{
					...
					$_SESSION['FiltrePerteMateriel_Plateforme']=$Id_Plateforme;
