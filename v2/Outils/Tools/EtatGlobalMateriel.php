...
if($_POST){
	...
	$_SESSION['FiltreEtatGlobalMateriel_Plateformes']=$Id_Platef;
	$_SESSION['FiltreEtatGlobalMateriel_Prestations']=$Id_Presta;
	$_SESSION['FiltreEtatGlobalMateriel_Types']=$Id_Type;
	$_SESSION['FiltreEtatGlobalMateriel_ModeAffichage']=$_POST['ModeAffichage'];
	$_SESSION['FiltreEtatGlobalMateriel_Plateforme']=$_POST['Id_Plateforme'];
	$_SESSION['FiltreEtatGlobalMateriel_Fournisseur']=$_POST['Id_Fournisseur'];
} 
?>
		...
		<table class="GeneralInfo">
					<?php
						if($_POST){
							...
							if($_SESSION['FiltreEtatGlobalMateriel_ModeAffichage']=="Plateforme"){
						...
						<?php
								...
								while($row=mysqli_fetch_array($result)){
									...
									$req="SELECT Id, Type, Id_TypeMateriel,Id_Fournisseur
										...
										if($_SESSION['FiltreEtatGlobalMateriel_Fournisseur']<>"0"){$req.=" AND TAB.Id_Fournisseur=".$_SESSION['FiltreEtatGlobalMateriel_Fournisseur']." ";}
			...
			<tr>
				<td height="400px;">
					<table class="TableCompetences" width="99%" height="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td class="Libelle" height="5%" style="font-size:15px;"><?php if($_SESSION['Langue']=="FR"){echo "NOMBRE DE MATERIEL / ".$titre;}else{echo "NUMBER OF MATERIAL / ".$titre;} ?></td>
		...
		<table class="GeneralInfo" style="border-spacing:0; width:70%; align:center;box-shadow: 0 8px 10px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);">
			...
			<tr>
				<td>
					...
					$selected="";
					if($_SESSION['FiltreEtatGlobalMateriel_ModeAffichage']=='Semaine'){$selected="selected";}
					...
					$selected="";
					if($_SESSION['FiltreEtatGlobalMateriel_ModeAffichage']=='Prestation'){$selected="selected";}
					...
					$mode=$_SESSION['FiltreEtatGlobalMateriel_ModeAffichage'];
					echo "</select>";
					?>
				</td>
			</tr>
			...
			<tr><td height="4px"></td></tr>
			<tr>
				<td class="Libelle" width="10%"><?php if($LangueAffichage=="FR"){echo "Fournisseur";}else{echo "Provider";}?> : </td>
			</tr>
			<tr>
				<td>
					<?php 
					...
					echo "<select name='Id_Fournisseur' style='width:150px;' id='Id_Fournisseur' OnChange='submit()' >";
							echo "<option value='0' selected></option>";
					$Id_Fournisseur=$_SESSION['FiltreEtatGlobalMateriel_Fournisseur'];
					if($_POST)
					{
					...
					while($LigFournisseur=mysqli_fetch_array($result)){
						$selected="";
						if($_POST){
							if($_POST['Id_Fournisseur']==$LigFournisseur['Id']){
								$selected="selected";
								$Id_Fournisseur=$LigFournisseur['Id'];
							}
						}
						echo "<option value='".$LigFournisseur['Id']."' ".$selected.">".$LigFournisseur['Libelle']."</option>";
					}
					$_SESSION['FiltreEtatGlobalMateriel_Fournisseur']=$Id_Fournisseur;
			...
			<tr <?php if($_POST){if($mode=="Plateforme"){echo "style='display:none';";} }else{echo "style='display:none';";} ?>>
				<td>
					...
					$Id_Plateforme=$_SESSION['FiltreEtatGlobalMateriel_Plateformes'];
					if($_POST)
					{
					...
					$_SESSION['FiltreEtatGlobalMateriel_Plateforme']=$Id_Plateforme;
