...
<form class="test" action="TurnOver.php" method="post">
		...
		<td colspan="5">
			<table class="GeneralPage" style="width:100%; border-spacing : 0; background-color:#a988b2;">
				<tr>
					...
					if($LangueAffichage=="FR"){echo "Suivi / Turn over";}else{echo "Follow-up / Turn over";}
					?>
					</td>
				</tr>
			</table>
						...
						<td width="50%" valign="top">
							...
							<table class="TableCompetences" style="width:100%;">
								<tr>
									...
									<td class="EnTeteTableauCompetences" width="25%" style="text-decoration:none;color:#000000;font-weight:bold;"><?php if($_SESSION["Langue"]=="FR"){echo "Métier";}else{echo "Job";} ?></td>
									<td class="EnTeteTableauCompetences" width="10%" style="text-decoration:none;color:#000000;font-weight:bold;"><?php if($_SESSION["Langue"]=="FR"){echo "Prestation";}else{echo "Site";} ?></td>
									<td class="EnTeteTableauCompetences" width="10%" style="text-decoration:none;color:#000000;font-weight:bold;"><?php if($_SESSION["Langue"]=="FR"){echo "Date de sortie";}else{echo "Release date";} ?></td>
								</tr>
								<?php 
									$week = sprintf('%02d',$semaine);
									$start = strtotime($annee.'W'.$week);
									...
									if($nbEntree>0){
										while($rowpersonne=mysqli_fetch_array($resultEntree))
										{
											...
											if($nbDate>0){
												...
												$Type=stripslashes($rowDate['TypeContrat']);
												$Metier=$rowDate['Metier'];
											}
											
											echo "<tr bgcolor=".$couleur.">";
												echo "<td><a href='javascript:EditerRestitutionMateriel(".$rowpersonne['Id_Personne'].");' style='color:black;'>".$rowpersonne['Personne']."</a></td>";
												echo "<td>".$Type."</td>";
												echo "<td>".$Metier."</td>";
												echo "<td>".$Prestation."</td>";
