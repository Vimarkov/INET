<script language="javascript">
	function OuvreFenetreModifPostePrestation(Mode,Id_Prestation)
	{var w=window.open("Ajout_AccesSupplementaire.php?Mode="+Mode+"&Id_Prestation="+Id_Prestation,"PageFichier","status=no,menubar=no,width=1500,height=750,resizable=yes,scrollbars=yes");
	w.focus();
	}
</script>
<?php
...
<table align="center" width="100%" cellpadding="0" cellspacing="0">
	<tr bgcolor="#6EB4CD">
		<?php
		if($_SESSION["Langue"]=="FR"){SousTitre("ACCES SUPP.","Outils/MORIS2/TableauDeBord.php?Menu=16",true);}
		else{SousTitre("ADDITIONAL ACCESS","Outils/MORIS2/TableauDeBord.php?Menu=16",true);}
	...
	<tr><td colspan="11">
		<table cellpadding="0" cellspacing="0" align="center" class="GeneralInfo" style="width:70%;">
			<tr>
				...
				<td class="EnTeteTableauCompetences" width="15%" >&nbsp;<?php if($_SESSION['Langue']=="EN"){echo "Site";}else{echo "Prestation";} ?></td>
				<td class="EnTeteTableauCompetences" width="16%" >&nbsp;<?php if($_SESSION['Langue']=="EN"){echo "Service entry";}else{echo "Saisie prestation";} ?></td>
					...
					while($row=mysqli_fetch_array($result)){
						...
						<?php
							$requetePersonnePoste2="SELECT new_competences_personne_poste_prestation.Id_Poste, new_rh_etatcivil.Nom, new_rh_etatcivil.Prenom
								...
								AND new_competences_personne_poste_prestation.Id_Prestation=".$row['Id']." 
								AND Id_Poste=46 
								AND Id_Personne>0 
								ORDER BY Nom, Prenom";
							...
							if($NbLignePersonnePoste2>0)
							{
								...
								{
									$liste .= $rowPersonnePoste2['Nom']." ".$rowPersonnePoste2['Prenom']."<br>";
								}
							}
							echo $liste;
							?>
								...
								<td width="2%" align="center">
									<a class="Modif" href="javascript:OuvreFenetreModifPostePrestation('Modif','<?php echo $row['Id']; ?>');">
