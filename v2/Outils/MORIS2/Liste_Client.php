<script language="javascript">
	function OuvreFenetreAjout(){
		var w=window.open("Ajout_Client.php?Mode=A&Id=0","PageUtilisateur","status=no,menubar=no,scrollbars=yes,width=800,height=250");
		w.focus();
		}
	...
	function OuvreFenetreModif(Id)
		{
			var w= window.open("Ajout_Client.php?Mode=M&Id="+Id,"PageLieu","status=no,menubar=no,width=800,height=250");
			w.focus();
		}
</script>
<?php
...
<table align="center" width="100%" cellpadding="0" cellspacing="0">
	<tr bgcolor="#6EB4CD">
		...
		if($_SESSION["Langue"]=="FR"){SousTitre("CLIENT","Outils/MORIS2/TableauDeBord.php?Menu=10",true);}
		else{SousTitre("CLIENT","Outils/MORIS2/TableauDeBord.php?Menu=10",true);}
	...
	<tr>
		<td align="center" colspan="11">
			<a style='text-decoration:none;' class='Bouton' href='javascript:OuvreFenetreAjout()'>&nbsp;<?php if($_SESSION['Langue']=="EN"){echo "Add a client";}else{echo "Ajouter un client";} ?>&nbsp;</a>
		</td>
	</tr>
