		...
		if($nbResultaMoisPrestaEC>0){
			while($LigneMoisPrestationEC=mysqli_fetch_array($resultEC)){
				...
				if(($LigneMoisPrestationEC['NbLivrableConformeOTD']+$LigneMoisPrestationEC['NbLivrableToleranceOTD']+$LigneMoisPrestationEC['NbRetourClientOTD'])>0){
					$realise=round(($LigneMoisPrestationEC['NbLivrableConformeOTD']/($LigneMoisPrestationEC['NbLivrableConformeOTD']+$LigneMoisPrestationEC['NbLivrableToleranceOTD']+$LigneMoisPrestationEC['NbRetourClientOTD']))*100,1);
				}
				...
				$sheet->setCellValue('D'.$ligne,utf8_encode($LigneMoisPrestationEC['ObjectifClientOTD']));
				$sheet->setCellValue('E'.$ligne,utf8_encode($objectifClient));
				$sheet->setCellValue('F'.$ligne,utf8_encode($LigneMoisPrestationEC['NbLivrableConformeOTD']));
				$sheet->setCellValue('G'.$ligne,utf8_encode($LigneMoisPrestationEC['NbLivrableToleranceOTD']));
				$sheet->setCellValue('H'.$ligne,utf8_encode($LigneMoisPrestationEC['NbRetourClientOTD']));
				$sheet->setCellValue('I'.$ligne,utf8_encode($realise));
				$sheet->setCellValue('J'.$ligne,utf8_encode(stripslashes($LigneMoisPrestationEC['CauseOTD'])));
				$sheet->setCellValue('K'.$ligne,utf8_encode(stripslashes($LigneMoisPrestationEC['ActionOTD'])));
				$sheet->setCellValue('L'.$ligne,utf8_encode(stripslashes($LigneMoisPrestationEC['ModeCalculOTD'])));
