...
<script type="text/javascript">
	function OuvreFenetreModif(Mode,Id)
	{
		...
		{
			var w= window.open("Ajout_SavoirEtre.php?Mode="+Mode+"&Id="+Id,"PageSavoirEtre","status=no,menubar=no,width=450,height=200");
			w.focus();
		}
	}
</script>
		...
		<td colspan="5">
			<table class="GeneralPage" style="width:100%; border-spacing : 0; background-color:#f5f74b;">
				<tr>
					...
					if($LangueAffichage=="FR"){echo "Savoir-être";}else{echo "Know-how";}
					?>
					</td>
				</tr>
			</table>
	...
	<tr>
		...
		<td align="left">
			...
			<?php
				$req="SELECT Id, 
					Libelle
					FROM talentboost_savoiretre WHERE Suppr=0 
					ORDER BY Libelle ";
