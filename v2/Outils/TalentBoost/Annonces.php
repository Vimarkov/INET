		...
		<td colspan="5">
			<table class="GeneralPage" style="width:100%; border-spacing : 0; background-color:#d9d9d9;">
				<tr>
					...
					if($LangueAffichage=="FR"){echo "Offre mobilité interne";}else{echo "Internal mobility offer";}
					?>
					</td>
				</tr>
			</table>
		...
		<tr>
			<td width="10%" class="Libelle">
				...
				<select id="etat" style="width:120px;" name="etat" onchange="submit();">
					...
					<option value="4" <?php if($etat==4){echo "selected";} ?>><?php if($_SESSION["Langue"]=="FR"){echo "Demande clôturée";}else{echo "Request closed";} ?></option>
				</select>
			</td>
			<td width="10%" class="Libelle">
