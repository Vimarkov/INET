		...
		<td align="left">
			...
			<?php
				$req="SELECT new_competences_prestation.Id, 
					...
					(SELECT Libelle FROM talentboost_domaine WHERE Id=Id_DomaineRecrutement) AS Domaine
					FROM new_competences_prestation
					LEFT JOIN new_competences_plateforme 
					ON new_competences_plateforme.Id=new_competences_prestation.Id_Plateforme
					WHERE new_competences_prestation.Id_Plateforme IN (1,3,4,5,9,10,13,17,19,23,24,27,28,29)
