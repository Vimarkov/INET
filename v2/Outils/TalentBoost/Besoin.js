function selectall(){
	...
	if(document.getElementById('Langue').value=="FR"){
		...
		if(document.getElementById('metier').value==""){alert("Veuillez sélectionner un métier.");return false;}
		...
		if(document.getElementById('Diplome').value==""){alert("Veuillez renseigner les diplômes.");return false;}
		...
		if(document.getElementById('personneAContacter').value=="0"){alert("Veuillez renseigner la personne à contacter.");return false;}
	}
	else{
