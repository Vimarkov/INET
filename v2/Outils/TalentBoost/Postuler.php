...
if($_POST){
	if(isset($_POST['btnEnregistrer'])){
		$requete="INSERT INTO talentboost_candidature (Id_Annonce,Id_Personne,Id_Plateforme,Id_Prestation,DateCreation,HeureCreation,Tel,Mail,MailPro,Responsable,Motivation,PosteOccupe)
	...
	if($IdCree>0){
		...
		else
		{
			...
			$requeteUpt="UPDATE talentboost_candidature SET";
...
<?php
		if($_SESSION["Langue"]=="FR"){
			echo "Nous accusons réception de votre candidature, elle va être transférée au service RH et elle sera analysée attentivement.<br>Si vous n’avez pas de réponses sous 3 semaines, votre candidature sera considérée comme non retenue.<br>";
		}
		else{
			echo "We acknowledge receipt of your application, it will be transferred to the HR department and it will be carefully analyzed.<br>If you do not have an answer within 3 weeks, your application will be considered unsuccessful.";
		}
	}
?>
		</td>
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr><td>
					<table class="TableCompetences" width="100%" cellpadding="0" cellspacing="0">
						...
						<tr><td height="4"></td></tr>
						<tr>
							<td width="10%" class="Libelle" bgcolor="#2e5496" valign="center" style="color:#ffffff;">&nbsp;<?php if($_SESSION["Langue"]=="FR"){echo "Commentaires salariés (vos motivations…)";}else{echo "Employee comments (your motivations…)";} ?></td>
						...
						<tr><td height="4"></td></tr>
						<tr>
							<td width="10%" class="Libelle" bgcolor="#2e5496" valign="center" style="color:#ffffff;"><?php if($LangueAffichage=="FR"){echo "Merci de bien vouloir joindre votre CV";}else{echo "Please attach your CV";}?></td>
							<?php if($_GET['Mode']=="M" || $_GET['Mode']=="Mo"){ ?>
