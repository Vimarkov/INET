			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr><td>
					<table class="TableCompetences" width="100%" cellpadding="0" cellspacing="0">
						...
						<tr height="10">
							<td width="15%" bgcolor="#2e5496" style="color:#ffffff;border:1px solid black;" class="Libelle" rowspan="2">&nbsp;<?php if($_SESSION["Langue"]=="FR"){echo "Poste recherché";}else{echo "Job sought";} ?></td>
						...
						<tr height="10">
							<td class="Libelle" bgcolor="#cad8ee" style="color:#2c538b;border:1px solid black;">&nbsp;<?php if($LangueAffichage=="FR"){echo "Date début de poste souhaitée";}else{echo "Desired start date";}?> : </td>
						...
						<tr height="30">
							...
							<td class="Libelle" colspan="8" style="border:1px solid black;" align="center">
								...
								<?php 
									...
									else{echo "Ce poste a été clôturé sur TalentBoost";}
								}
								else{
									if($row['EtatPoste']<>0){
						...
						<tr height="50">
							<td class="Libelle" valign="align" bgcolor="#2e5496" style="color:#ffffff;border:1px solid black;">&nbsp;<?php if($_SESSION["Langue"]=="FR"){echo "Prérequis :";}else{echo "Prerequisites";} ?></td>
							<td colspan="8" class="Libelle" style="border:1px solid black;">
								<table width="100%">
									<?php
						...
						<tr height="30">
							...
							<td class="Libelle" bgcolor="#cad8ee" style="color:#2c538b;border:1px solid black;">&nbsp;<?php if($LangueAffichage=="FR"){echo "Personne à contacter ";}else{echo "Contact person ";}?></td>
