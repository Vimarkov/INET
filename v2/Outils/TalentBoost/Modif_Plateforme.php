...
<head>
	...
	<script type="text/javascript">	
		...
		{
			window.opener.location="Liste_Plateforme.php";
			window.close();
		}
...
if($_SERVER['SERVER_NAME']=="127.0.0.1" || $_SERVER['SERVER_NAME']=="localhost" || $_SERVER['SERVER_NAME']=="192.168.20.3")
{
...
if($_POST)
{
	...
	else
	{
		...
		else
		{
			...
			$requeteUpt="UPDATE new_competences_plateforme SET";
...
elseif($_GET)
{
	...
	{
		$Modif=True;
		$result=mysqli_query($bdd,"SELECT Id, Libelle,Document FROM new_competences_plateforme WHERE Id=".$_GET['Id']." ");
		$row=mysqli_fetch_array($result);
	}
?>
		<form id="formulaire" enctype="multipart/form-data" method="POST" action="Modif_Plateforme.php">
