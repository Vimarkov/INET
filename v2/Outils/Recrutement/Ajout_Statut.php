...
if($_POST)
{
	if($_POST['Mode']=="Ajout")
	{
		$requeteInsertUpdate="INSERT INTO recrut_categorieprofessionnelle (Libelle)";
	...
	{		
		$requeteInsertUpdate="UPDATE recrut_categorieprofessionnelle SET";
...
elseif($_GET)
{
	...
	if($_GET['Mode']=="Ajout" || $_GET['Mode']=="Modif")
	{
		...
		{
			$Modif=True;
			$result=mysqli_query($bdd,"SELECT Id, Libelle FROM recrut_categorieprofessionnelle WHERE Id=".$_GET['Id']." AND Suppr=0");
...
<?php
	...
	//Mode suppression
	{
		$result=mysqli_query($bdd,"UPDATE recrut_categorieprofessionnelle SET Suppr=1 WHERE Id=".$_GET['Id']);
