...
function creerMail($Type,$LangueAffichage,$Id_Annonce)
{
	...
	$destinataire="";
	if($Type=="RECRUTEMENT"){
		if($LangueAffichage=="FR"){$Objet="Nouveau besoin à valider - ".$row['Ref'];}
	...
	elseif($Type=="MAJ RECRUTEMENT"){
		if($LangueAffichage=="FR"){$Objet="Mise à jour - ".$row['Ref'];}
	...
	elseif($Type=="BESOIN POURVU"){
		if($LangueAffichage=="FR"){$Objet="Besoin pourvu/ ODM à faire - ".$row['Ref'];}
											...
											<table width='100%' cellpadding='0' cellspacing='0'>
												...
												<tr height='10'>
													<td colspan='2' align='center' style='border:1px solid black;font-weight:bold;'>&nbsp;&nbsp;";
														if($row['PosteDefinitif']==1){
															$Message.= "Mesures d’accompagnement prévues par AAA pour l’aide au déménagement";
														}
														elseif($row['PosteDefinitif']==0){
															$Message.= "Conditions de déplacement :  calendaires selon conditions en vigueur chez AAA";
														}
												$Message.= "<td>
												</tr>
												<tr height='30'>
													...
													$Message.="</td>
													<td bgcolor='#cad8ee' style='color:#2c538b;border:1px solid black;font-weight:bold;'>&nbsp;";
													if($LangueAffichage=="FR"){$Message.= "Création du poste";}else{$Message.= "Job creation";}
													$Message.="</td>
													...
													$Message.="</td>
													<td bgcolor='#cad8ee' style='color:#2c538b;border:1px solid black;font-weight:bold;'>&nbsp;";
													if($LangueAffichage=="FR"){$Message.= "Catégorie d’emploi, à titre indicatif";}else{$Message.= "Job category, for information only";}
													$Message.="</td>
												...
												<tr height='50'>
													<td valign='align' bgcolor='#2e5496' style='color:#ffffff;border:1px solid black;font-weight:bold;'>&nbsp;";
													if($LangueAffichage=="FR"){$Message.="Savoir faire,prérequis :<br><br>Qualités professionnelles<br><br>Polyvalence métier<br><br>Compétences techniques<br><br>Compétences managériales";}else{$Message.=  "Know-how, prerequisites:<br><br>Professional skills<br><br>-Experience<br><br>Business versatility<br><br>Technical skills<br><br>Managerial skills";}
													$Message.="</td>
										...
										<tr><td>
											<table  width='100%' cellpadding='0' cellspacing='0'>
												...
												<tr>
													...
													if($LangueAffichage=="FR"){$Message.= "Commentaires éventuels salarié";}else{$Message.= "Possible employee comments";}
													$Message.="</td>
...
function creerMailCandidat($Type,$LangueAffichage,$Id_Annonce,$Id_Candidature)
{
	...
	$Message="	<html>
					...
					<body>
						Bonjour,<br>
						Votre candidature va être transférée au PIC, elle sera analysée attentivement, en cas de pluralité de candidatures, les critères d’ordre conformes au PSE s’appliqueront.
					</body>
				</html>";
