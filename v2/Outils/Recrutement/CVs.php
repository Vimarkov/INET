							...
							<td colspan="2" align="center">
								<table class="TableCompetences" align="center" width="40%">
									...
									if($_SESSION['FiltreRecrutAnnonce_Metier']<>""){
										$req.=" AND recrut_annonce.Metier LIKE \"%".$_SESSION['FiltreRecrutAnnonce_Metier']."%\" ";
									}
									if($_SESSION['FiltreRecrutAnnonce_Domaine']<>0){
										$req.=" AND recrut_annonce.Id_Domaine = ".$_SESSION['FiltreRecrutAnnonce_Domaine']." ";
									}
									if($_SESSION['FiltreRecrutAnnonce_Programme']<>"0"){
										$req.=" AND recrut_annonce.Programme LIKE \"".$_SESSION['FiltreRecrutAnnonce_Programme']."\" ";
									}
									if($_SESSION['FiltreRecrutAnnonce_Etat']<>-2){
										$req.=" AND recrut_annonce.EtatPoste=".$_SESSION['FiltreRecrutAnnonce_Etat']." ";
									}
									if($_SESSION['FiltreRecrutAnnonce_DateDemarrage']>"0001-01-01" && $_SESSION['FiltreRecrutAnnonce_DateDemarrage']<>""){
										$req.=" AND recrut_annonce.DateBesoin".$_SESSION['FiltreRecrutAnnonce_SigneDateDemarrage']." '".$_SESSION['FiltreRecrutAnnonce_DateDemarrage']."' ";
									}
