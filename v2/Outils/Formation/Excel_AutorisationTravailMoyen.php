...
if($LangueAffichage=="FR"){
	...
	$sheet->setCellValue('C1',utf8_encode("Moyens"));
	$sheet->setCellValue('D1',utf8_encode("Catégories"));
	$sheet->setCellValue('E1',utf8_encode("Fin de validité"));
	...
	$sheet->setCellValue('C1',utf8_encode("Means"));
	$sheet->setCellValue('D1',utf8_encode("Categories"));
	$sheet->setCellValue('E1',utf8_encode("End of validity"));
	if(DroitsFormationPlateforme($TableauIdPostesAF_RF_RH)){
	...
	if($nbAT>0){
		while($rowAT=mysqli_fetch_array($resultAT)){
			...
			if($btrouve==1){
				...
				$sheet->setCellValue('C'.$ligne,utf8_encode(stripslashes($rowAT['Moyen'])));
				$sheet->setCellValue('D'.$ligne,utf8_encode(stripslashes($rowAT['Categorie'])));
				$sheet->setCellValue('E'.$ligne,utf8_encode($dateFin));
				if(DroitsFormationPlateforme($TableauIdPostesAF_RF_RH)){
					$sheet->setCellValue('F'.$ligne,utf8_encode($etat));
				}
