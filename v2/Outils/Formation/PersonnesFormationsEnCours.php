			...
			<tr>
				<td class="Libelle" width="8%" colspan="2">&nbsp;<?php if($LangueAffichage=="FR"){echo "Formation ";}else{echo "Training ";}?>&nbsp;
					...
					<?php
						...
						$_SESSION['FiltrePersFormEC_Prestations']=$Id_Presta;
						$_SESSION['FiltrePersFormEC_Plateforme']=$_POST['Id_Plateforme'];
						$_SESSION['FiltrePersFormEC_Formation']=$formation;
						$_SESSION['FiltrePersFormEC_RespProjet']=$Id_RespProjet;
					...
					?>
						<tr >
							...
							<td class="EnTeteTableauCompetences" width="47%"><?php if($LangueAffichage=="FR"){echo "Qualification";}else{echo "Qualification";}?></td>
							<td class="EnTeteTableauCompetences" width="3%">
							&nbsp;<a style="text-decoration:none;" href="javascript:Excel_PersonnesFormationEnCours();">
					...
					?>
						<tr bgcolor="<?php echo $couleur; ?>">
							...
							?>
							<td colspan="2"><?php echo $lesqualifs ; ?></td>
						</tr>
					<?php 
