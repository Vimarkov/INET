...
if($_POST){
	...
	$_SESSION['FiltreFormDesinscription_Plateforme']=$_POST['Id_Plateforme'];
	$_SESSION['FiltreFormDesinscription_DateDebut']=$_POST['DateDebut'];
	$_SESSION['FiltreFormDesinscription_DateFin']=$_POST['DateFin'];
	$_SESSION['FiltreFormDesinscription_Type']=$Id_Type;
} 
?>
...
<tr>
	<td align="center" valign="top" width="85%">
		<table class="GeneralInfo">
			<?php if($_POST){ 
				...
				?>
					<tr >
						<td class="EnTeteTableauCompetences" width="10%"><?php if($LangueAffichage=="FR"){echo "Personne";}else{echo "Person";}?></td>
						...
						<td class="EnTeteTableauCompetences" width="10%"><?php if($LangueAffichage=="FR"){echo "Date désinscription";}else{echo "Unsubscribe date";}?></td>
						<td class="EnTeteTableauCompetences" width="10%"><?php if($LangueAffichage=="FR"){echo "Coût";}else{echo "Cost";}?></td>
						<td class="EnTeteTableauCompetences" width="10%"><?php if($LangueAffichage=="FR"){echo "A comptabiliser";}else{echo "To be counted";}?></td>
						<td class="EnTeteTableauCompetences" width="3%">
						&nbsp;<a style="text-decoration:none;" href="javascript:Excel_ListeDesinscription();">
				...
				?>
					<tr bgcolor="<?php echo $couleur; ?>">
						...
						<td><?php echo AfficheDateJJ_MM_AAAA($row['Date_Desinscription']) ; ?></td>
						<td ><?php echo $row['COUT'] ; ?></td>
						<td colspan="2"><?php if($row['AComptabiliser']==1){echo "X";} ?></td>
					</tr>
				<?php 
	...
	<td align="right" valign="top" width="25%">
		<table class="GeneralInfo" style="border-spacing:0; width:70%; align:center;box-shadow: 0 8px 10px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);">
			...
			<tr>
				<td class="Libelle" width="10%"><input type="date" style="text-align:center;"id="DateDebut" name="DateDebut" size="10" value="<?php echo AfficheDateFR($_SESSION['FiltreFormDesinscription_DateDebut']); ?>"></td>
			</tr>
			<tr>
				<td class="Libelle" width="10%"><?php if($LangueAffichage=="FR"){echo "Date fin";}else{echo "End date";}?> : </td>
			</tr>
			<tr>
				<td class="Libelle" width="10%"><input type="date" style="text-align:center;"id="DateFin" name="DateFin" size="10" value="<?php echo AfficheDateFR($_SESSION['FiltreFormDesinscription_DateFin']); ?>"></td>
			</tr>
			<tr>
