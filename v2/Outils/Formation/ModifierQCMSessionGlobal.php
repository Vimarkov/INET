...
if($_POST){    
	if(isset($_POST['generer'])){
		if(isset($_POST['Id_Session']) && isset($_POST['Id_Qualification'])){
			$req="SELECT DISTINCT form_session_personne_qualification.Id 
				...
				AND form_session_personne_qualification.Id_Qualification=".$_POST['Id_Qualification']."
			...
			if($NbSessionPersQualifOuvert>0){
				while($rowSessionQualif=mysqli_fetch_array($resultSessionPersQualifOuver)){
					...
					maj_QCM_SessionPersonneQualification($rowSessionQualif['Id'],$qcm_mere,$qcm_fille,$langue_qcm_mere,$langue_qcm_fille);
				}
			}							
		}
...
if($_GET){
	...
	$Id_Qualification=$_GET['Id_Qualification'];
}
else{
	$Id_Session=$_POST['Id_Session'];
	$Id_Qualification=$_POST['Id_Qualification'];
}
...
?>
<form id="formulaire" method="POST" action="ModifierQCMSessionGlobal.php">
	<input type="hidden" name="Id_Session" value="<?php echo $Id_Session; ?>" />
	<input type="hidden" name="Id_Qualification" value="<?php echo $Id_Qualification; ?>" />
