...
$Id_Presta=$_SESSION['FiltrePersSansForm_Prestations'];
$Id_Plateforme=$_SESSION['FiltrePersSansForm_Plateforme'];
$formation=$_SESSION['FiltrePersSansForm_Formation'];
$Id_RespProjet=$_SESSION['FiltrePersSansForm_RespProjet'];
