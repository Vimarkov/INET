				...
				if($_POST['DateDebut']<>"" && $_POST['DateFin']<>""){
					...
					if($dateFin>=$dateDebut){
						...
						if($_SESSION['Langue']=="EN"){
							...
							$arrayLegendeNbPersonnesPresentAbsent=array(utf8_encode("Présent"),utf8_encode("Absent"));
						}
				...
				?>
					<tr>
						<td height="350px;">
							<table class="TableCompetences" width="99%" height="100%" cellpadding="0" cellspacing="0">
								<tr>
									<td class="Libelle" height="5%" style="font-size:15px;"><?php if($_SESSION['Langue']=="FR"){echo "NOMBRE DE PERSONNES PRÉSENTES EN FORMATION";}else{echo "NUMBER OF PEOPLE PRESENT IN TRAINING";} ?></td>
					...
					<tr>
						<td height="700px;">
							<table class="TableCompetences" width="99%" height="100%" cellpadding="0" cellspacing="0">
								<tr>
									<td class="Libelle" height="5%" style="font-size:15px;"><?php if($_SESSION['Langue']=="FR"){echo "NOMBRE DE PERSONNES PRÉSENTES EN FORMATION / CATEGORIE";}else{echo "NUMBER OF PEOPLE PRESENT IN TRAINING / CATEGORY";} ?></td>
									<td style="cursor:pointer;" align="right"></td>
								</tr>
								<tr><td style="border-bottom:2px solid #0b6acb;" colspan="2" height="4"></td></tr>
								<tr><td height="4"></td></tr>
		...
		<table class="GeneralInfo" style="border-spacing:0; width:70%; align:center;box-shadow: 0 8px 10px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);">
			...
			<tr>
				<td>
					...
					$selected="";
					if($_SESSION['FiltreNbPersonnePresenteAbs_ModeAffichage']=='Année'){$selected="selected";}
