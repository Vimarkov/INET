...
SELECT
	...
	(SELECT Libelle FROM new_competences_plateforme WHERE new_competences_plateforme.Id=(SELECT Id_Plateforme FROM new_competences_prestation WHERE Id=form_besoin.Id_Prestation)) AS Plateforme,
