...
if($_POST)
{
	...
	$ReqSupprRelation="UPDATE new_competences_relation 
			...
			AND Id_Besoin=".$_POST['Id'];
	$ResultSupprRelation=mysqli_query($bdd,$ReqSupprRelation);

	echo "<script>FermerEtRecharger();</script>";
}
?>
<form id="formulaire" method="POST" action="Supprimer_Besoin_Raison.php" onSubmit="return VerifChamps('<?php echo $LangueAffichage ?>');">
	<table class="TableCompetences" style="width:95%; height:95%; align:center;">
		<tr>
			<td><input type="hidden" id="Id" name="Id" value="<?php echo $_GET['Id']; ?>" /></td>
		</tr>
		<tr>
