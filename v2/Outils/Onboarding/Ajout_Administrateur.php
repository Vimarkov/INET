...
?>
		...
		<table width="95%" align="center" class="TableCompetences">
			...
			<tr class="TitreColsUsers">
				<td><?php if($_SESSION['Langue']=="EN"){echo "Theme";}else{echo "Thème";} ?></td>
				<td>
					<select id="rubrique" name="rubrique">
						<option value="Achats">Achats</option>
						<option value="Bienvenue chez AAA">Bienvenue chez AAA</option>
						<option value="Excellence opérationnelle">Excellence opérationnelle</option>
						<option value="Formation interne">Formation interne</option>
						<option value="Informatique">Informatique</option>
						<option value="Innovation">Innovation</option>
						<option value="Qualité">Qualité</option>
						<option value="Ressources humaines">Ressources humaines</option>
						<option value="Sécurité et environnement">Sécurité et environnement</option>
