...
<table style="width:100%; border-spacing:0;background-color:#ffffff;">
	<tr>
		<td align="right">
			<a style='text-decoration:none;cursor: pointer;' onclick="OuvreFenetreAjout('Feedback.php')">
			<img width='100px' src='DonnezAvis.PNG' border='0' />
			</a>
		</td>
	</tr>
	<tr>
		<td class="Libelle" align="right">
			<a style='text-decoration:none;cursor: pointer;' onclick="OuvreFenetreAjout('Feedback.php')">
