...
<script type="text/javascript">
	function OuvreFenetreModif(Mode,Id)
		{window.open("Ajout_Formation.php?Mode="+Mode+"&Id="+Id,"PageFichier","status=no,menubar=no,width=375,height=50");}
</script>

<?php
$Droits="Aucun";
if(DroitsFormation1Plateforme(17,array($IdPosteAdministrateur,$IdPosteResponsableQualite))
|| DroitsFormationPlateformes(array(12,16,18,20,22,26),array($IdPosteResponsableQualite))	
)
{
		...
		<td>
			<table class="GeneralPage" style="width:100%; border-spacing:0;">
				<tr>
					...
					echo "</a>";
					echo "&nbsp;&nbsp;&nbsp;";
					if($LangueAffichage=="FR"){echo "Gestion des compétences # Gestion des formations";}else{echo "Competencies management # Trainings management";}?></td>
					<?php
