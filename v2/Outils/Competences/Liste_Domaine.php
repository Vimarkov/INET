...
<script type="text/javascript">
	function OuvreFenetreModif(Mode,Id)
		{window.open("Ajout_Domaine.php?Mode="+Mode+"&Id="+Id,"PageModifDomaine","status=no,menubar=no,width=300,height=10,resizable=yes,scrollbars=yes");}
</script>
<?php
$Droits="Aucun";
		...
		<td>
			<table class="GeneralPage" style="width:100%; border-spacing:0;">
				<tr>
					...
					echo "</a>";
					echo "&nbsp;&nbsp;&nbsp;";
					if($LangueAffichage=="FR"){echo "Gestion des compétences # Getion des domaines";}else{echo "Competencies management # Domain Management";}?></td>
					<?php
					...
					<td>
						...
						<?php
                            ...
                            $req="
                                ...
                                FROM
                                    rh_domaine
                                    LEFT JOIN new_competences_plateforme ON rh_domaine.Id_Plateforme=new_competences_plateforme.Id
                                WHERE
                                    rh_domaine.Id_Plateforme IN (".$Plateformes.")
                                ORDER BY
                                    new_competences_plateforme.Libelle ASC,
                                    rh_domaine.Libelle ASC";
