...
<script type="text/javascript">
	function OuvreFenetreModif(Mode,Id)
		{window.open("Ajout_Categorie_Diplome.php?Mode="+Mode+"&Id="+Id,"PageFichier","status=no,menubar=no,width=375,height=50");}
</script>
<?php
$Droits="Aucun";
		...
		<td>
			<table class="GeneralPage" style="width:100%; border-spacing:0;">
				<tr>
					...
					echo "</a>";
					echo "&nbsp;&nbsp;&nbsp;";
					if($LangueAffichage=="FR"){echo "Gestion des compétences # Gestion des catégories de diplômes";}else{echo "Competencies management # Group diplomas management";}?></td>
					<?php
					...
					<td width="10">
						<a class="Modif" href="javascript:OuvreFenetreModif('Ajout','0');">
							<img src="../../Images/Ajout.gif" border="0" alt="Ajouter une catégorie de diplôme">
						</a>
					</td>
					<?php
						}
