...
<html>
<head>
	<title>Compétences - Recherche métier</title><meta name="robots" content="noindex">
	...
	<script>
		function FermerEtRecharger()
		{
			...
			opener.location="Recherche.php?Metiers="+VariableTexte;
			window.close();
		}
	</script>
</head>
...
<form id="formulaire" method="POST" action="javascript:FermerEtRecharger();">
	<table style="width:100%; height:95%;">
		<tr>
			<td class="TitrePage"><?php if($LangueAffichage=="FR"){echo "Recherche métier";}else{echo "Job search";}?></td>
		</tr>
		<?php
		...
		<tr>
			<td>
				<table class="TableCompetences" style="width:100%;">
					<tr>
						<td colspan="2" class="TitreSousPageCompetencesPetit"><?php if($LangueAffichage=="FR"){echo "METIERS";}else{echo "JOBS";}?></td>
					</tr>
					<?php
					$Couleur="#EEEEEE";
					...
					<tr bgcolor="<?php echo $Couleur;?>">
						...
						<td><input type="checkbox" name="Metier[]" value="<?php echo $row['Id'];?>"></td>
					</tr>
					<?php
					}
					?>
