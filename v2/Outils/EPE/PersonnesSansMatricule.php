	...
	<td align="center" valign="top" width="75%">
		<table class="GeneralInfo">
			<?php 
				...
				WHERE 
				new_rh_etatcivil.Id NOT IN (1726,1739)
			...
			?>
				<tr >
					...
					<td class="EnTeteTableauCompetences" width="10%"><?php if($_SESSION["Langue"]=="FR"){echo "Métier paie";}else{echo "Payroll profession";} ?></td>
					<td class="EnTeteTableauCompetences" width="10%"><?php if($_SESSION["Langue"]=="FR"){echo "Contrat";}else{echo "Contract";} ?></td>
					<td class="EnTeteTableauCompetences" width="10%"><?php if($_SESSION["Langue"]=="FR"){echo "Cadre";}else{echo "Executive";} ?></td>
					...
					&nbsp;<a style="text-decoration:none;" href="javascript:Excel_PersonnesSansMatricule();">
			...
			<?php
				if($nbenreg>0){
					...
					while($row=mysqli_fetch_array($result)){
						$cadre="";
						if($row['Cadre']==0){$cadre="Non cadre";}
						elseif($row['Cadre']==1){$cadre="Cadre";}
			?>
