...
<script type="text/javascript">
	function OuvreFenetreModif(Mode,Id)
		{window.open("Ajout_Mobilite.php?Mode="+Mode+"&Id="+Id,"PageMobilite","status=no,menubar=no,width=675,height=150");}
</script>
		...
		<td>
			<table class="GeneralPage" style="width:100%; border-spacing : 0; background-color:#f5f74b;">
				<tr>
					...
					if($LangueAffichage=="FR"){echo "Mobilité";}else{echo "Mobility";}
					?>
					</td>
					<?php
