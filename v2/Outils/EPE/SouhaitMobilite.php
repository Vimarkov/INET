			...
			<tr>
				<td height="200px;">
					<table class="TableCompetences" width="99%" height="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td class="Libelle" height="5%" style="font-size:15px;"><?php if($_SESSION['Langue']=="FR"){echo "Souhait de mobilité géographique";}else{echo "Desire for geographic mobility";} ?></td>
								...
								<?php 
									...
									?>
										<table align="center" cellpadding="0" cellspacing="0" width="60%" >
											<tr><td style="border:solid black 1px;" align="center" bgcolor="#d2d6da" >Souhait exprimé</td><td style="border:solid black 1px;" align="center" bgcolor="#d2d6da" >Nombre de salarié</td></tr>
									<?php
										while($row=mysqli_fetch_array($result))
										{
									?>
		...
		<table class="GeneralInfo" width="100%">
			<tr>
				<tr>
					...
					<td class="EnTeteTableauCompetences" width="6%"><?php if($_SESSION["Langue"]=="FR"){echo "Mobilité";}else{echo "Mobility";} ?></td>
