				...
				<tr><td>
					<table width='100%' align='center' cellpadding='0' cellspacing='0'>
						...
						<tr>
							...
							<td width='30%' style='border:1px #000000 solid;font-size:8px;' align='center'>".$rowEPERempli['Nom']." ".$rowEPERempli['Prenom']." ".$signature."</td>
							<td bgcolor='d8d8d4' width='20%' style='border:1px #000000 solid;font-size:8px;'>Visa de l'évaluateur</td>
							<td width='30%' style='border:1px #000000 solid;font-size:8px;' align='center'>".$Manager." <br>'signature électronique' </td>
						</tr>
					</table>
				</td></tr>
			</table>
