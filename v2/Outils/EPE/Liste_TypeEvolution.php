...
<script type="text/javascript">
	function OuvreFenetreModif(Mode,Id)
		{window.open("Ajout_TypeEvolution.php?Mode="+Mode+"&Id="+Id,"PageTypeEvolution","status=no,menubar=no,width=675,height=150");}
</script>
		...
		<td>
			<table class="GeneralPage" style="width:100%; border-spacing : 0; background-color:#f5f74b;">
				<tr>
					...
					if($LangueAffichage=="FR"){echo "Type d'évolution";}else{echo "Evolution type";}
					?>
					</td>
					<?php
