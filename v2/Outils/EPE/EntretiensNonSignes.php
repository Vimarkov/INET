			...
			<?php if($_POST){ 
				if($_POST['annee']<>""){
					...
					AND IF((SELECT COUNT(Id)
						...
						FROM epe_personne 
						WHERE Suppr=0 AND epe_personne.Type=epe_personne_datebutoir.TypeEntretien AND epe_personne.Id_Personne=new_rh_etatcivil.Id AND YEAR(epe_personne.DateButoir) = ".$_SESSION['FiltreEPEIndicateurs_Annee']." LIMIT 1),
						'A faire') IN ('Signature salarié','Signature manager')
					";
				...
				?>
					<tr >
						...
						<td class="EnTeteTableauCompetences" width="12%"><?php if($_SESSION["Langue"]=="FR"){echo "Etat";}else{echo "State";} ?></td>
						<td class="EnTeteTableauCompetences" width="3%">
						&nbsp;<a style="text-decoration:none;" href="javascript:Excel_EntretiensNonSignes();">
				...
				<?php
					...
					?>
						<tr bgcolor="<?php echo $couleur; ?>">
							...
							<td><?php echo AfficheDateJJ_MM_AAAA($row['DateEntretien']);?></td>
							<td colspan="2"><?php echo stripslashes($row['Etat']);?></td>
