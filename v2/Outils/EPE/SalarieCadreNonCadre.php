		...
		<table class="GeneralInfo">
			...
			?>
				<tr >
					...
					<td class="EnTeteTableauCompetences" width="20%"><?php if($_SESSION["Langue"]=="FR"){echo "Métier paie";}else{echo "Payroll profession";} ?></td>
					<td class="EnTeteTableauCompetences" width="10%"><?php if($_SESSION["Langue"]=="FR"){echo "Contrat";}else{echo "Contract";} ?></td>
					<td class="EnTeteTableauCompetences" width="10%"><?php if($_SESSION["Langue"]=="FR"){echo "Cadre / Non cadre";}else{echo "Executive / Non-executive";} ?></td>
					...
					&nbsp;<a style="text-decoration:none;" href="javascript:Excel_SalarieCadreNonCadre();">
