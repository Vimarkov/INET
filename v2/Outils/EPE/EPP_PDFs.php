...
function ExporterEPPPDFs($tabEPE){
	global $bdd;
	global $file_to_save;
	...
	foreach ($tabEPE as $epe){
						...
						<tr><td>
							<table width='100%' align='center' cellpadding='0' cellspacing='0'>
								...
								<tr>
									...
									<td width='30%' style='border:1px #000000 solid;font-size:8px;' align='center'>";
									if($rowEPERempli['EPPRefuseSalarie']==0 && $rowEPERempli['DateSalarie']>'0001-01-01'){
		...
		$matricule=$rowPersonne['MatriculeDaher'];
		 ...
		 //Save PDF in server.
		 file_put_contents($file_to_save.$matricule."_".$personne."_EPP_".$annee.".pdf", $dompdf->output()); 
		 
		 echo "<script type='text/javascript'>";
		 echo "window.open('".$file_to_save.$matricule."_".$personne."_EPP_".$annee.".pdf');" ;
		 echo "</script>";
	}
}
