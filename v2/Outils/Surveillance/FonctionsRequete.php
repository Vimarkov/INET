...
function reqNbSurveillanceThematique($prestations,$annee,$generiques,$specifiques){
	...
	$req .= "WHERE ";
	$req .= "YEAR(IF(new_surveillances_surveillance.DateReplanif >'0001-01-01', new_surveillances_surveillance.DateReplanif, new_surveillances_surveillance.DatePlanif)) =".$annee." AND (";
...
function reqNbSurveillanceMois($prestations,$annee,$generiques,$specifiques){
	...
	$req .="CONCAT( ";
    $req .="YEAR(IF(new_surveillances_surveillance.DateReplanif >'0001-01-01', new_surveillances_surveillance.DateReplanif, new_surveillances_surveillance.DatePlanif)), ";
    $req .="'_', ";
    $req .="IF(MONTH(IF(new_surveillances_surveillance.DateReplanif >'0001-01-01', new_surveillances_surveillance.DateReplanif, new_surveillances_surveillance.DatePlanif))>=10, ";
    $req .="   MONTH(IF(new_surveillances_surveillance.DateReplanif >'0001-01-01', new_surveillances_surveillance.DateReplanif, new_surveillances_surveillance.DatePlanif)), ";
    $req .="   CONCAT('0',MONTH(IF(new_surveillances_surveillance.DateReplanif >'0001-01-01', new_surveillances_surveillance.DateReplanif, new_surveillances_surveillance.DatePlanif))) ";
    $req .="   ) ";
    $req .=") AS leMois ";
...
function reqDELTADatePlaReaMois($prestations,$annee,$generiques,$specifiques){
	...
	$req .="IF(new_surveillances_surveillance.DateReplanif >'0001-01-01', new_surveillances_surveillance.DateReplanif, new_surveillances_surveillance.DatePlanif) AS Date_Fin ";
	$req .="FROM new_surveillances_surveillance ";
...
function reqDELTADateReaCloMois($prestations,$annee,$generiques,$specifiques)
{
	...
	$req .=") ";
	$req .=") AS MoisAnnee, ";
	$req .="IF(new_surveillances_surveillance.DateReplanif >'0001-01-01', new_surveillances_surveillance.DateReplanif, new_surveillances_surveillance.DatePlanif) AS Date_Debut, ";
