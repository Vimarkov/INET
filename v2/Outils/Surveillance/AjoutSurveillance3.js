...
function Recharge_Liste_Prestation_Personne()
{
	...
	{
		if (Liste_Plateforme_Personne[i][1]==document.getElementById('Id_Plateforme').value || Liste_Plateforme_Personne[i][0]==document.getElementById('Id_Surveillant_Initial').value || (Liste_Plateforme_Personne[i][0]==8033 && Liste_Plateforme_Personne[i][1]==17) || (Liste_Plateforme_Personne[i][0]==1762 && Liste_Plateforme_Personne[i][1]==17) || (Liste_Plateforme_Personne[i][0]==2526 && Liste_Plateforme_Personne[i][1]==17) || (Liste_Plateforme_Personne[i][0]==12529 && Liste_Plateforme_Personne[i][1]==17) || (Liste_Plateforme_Personne[i][0]==5618 && Liste_Plateforme_Personne[i][1]==17))
		{
