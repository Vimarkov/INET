...
<head>
	...
	<script language="javascript">
		function OuvreFenetreAjout_Critere(){
			var w=window.open("Ajout_CritereTDB_Production.php?Type=A","PageCritere","status=no,menubar=no,scrollbars=yes,width=600,height=250");
			w.focus();
		}
		function OuvreFenetreAjout_CritereProductivite(){
			var w=window.open("Ajout_CritereProductivite.php?Type=A","PageCritere","status=no,menubar=no,scrollbars=yes,width=600,height=250");
			w.focus();
		}
		function Suppr_Critere(critere,valeur){
			var w=window.open("Ajout_CritereTDB_Production.php?Type=S&critere="+critere+"&valeur="+valeur,"PageCritere","status=no,menubar=no,scrollbars=yes,width=600,height=200");
			w.focus();
		}
		function Suppr_CritereProductivite(critere,valeur){
			var w=window.open("Ajout_CritereProductivite.php?Type=S&critere="+critere+"&valeur="+valeur,"PageCritere","status=no,menubar=no,scrollbars=yes,width=600,height=200");
			w.focus();
		}
		function Excel(){
			var w=window.open("Extract_TDB_Production.php","PageExtract","status=no,menubar=no,scrollbars=yes,width=60,height=40");
			w.focus();
		}
		function Excel_Productivite(){
			var w=window.open("Extract_Productivite.php","PageExtract","status=no,menubar=no,scrollbars=yes,width=60,height=40");
			w.focus();
		}
	</script>
...
if($_POST){
	...
	elseif(isset($_POST['Recherche_RAZ_PRODUCTIVITE'])){
...
<form class="test" method="POST" action="TDB_Production.php">
	<tr>
		<td>
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="4"></td>
					<td class="TitrePage"><?php if($_SESSION['Langue']=="EN"){echo "DASHBOARD PRODUCTION / PRODUCTIVITY";}else{echo "TABLEAU DE BORD PRODUCTION/PRODUCTIVITE";} ?></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<table width="100%" cellpadding="0" cellspacing="0" align="center" class="GeneralInfo">
		<tr>
			...
			<td align="right">
			<a style="text-decoration:none;" href="javascript:OuvreFenetreAjout_CritereProductivite()">&nbsp;<img src="../../Images/Plus2.png" border="0" alt="<?php if($_SESSION['Langue']=="EN"){echo "Add criteria";}else{echo "Ajouter critères";}?>" title="<?php if($_SESSION['Langue']=="EN"){echo "Add criteria";}else{echo "Ajouter critères";}?>">&nbsp;&nbsp;</a>
			</td>
		</tr>
		<?php
			if($_SESSION['PRODUCTIVITE_Mois']<>""){
				echo "<tr>";
				if($_SESSION['Langue']=="EN"){
					echo "<td>&nbsp; Month / year : ".$_SESSION['PRODUCTIVITE_Mois']."</td>";
				}
				else{
					echo "<td>&nbsp; Mois / Année : ".$_SESSION['PRODUCTIVITE_Mois']."</td>";
				}
				echo "</tr>";
			}
			if($_SESSION['PRODUCTIVITE_Par']<>""){
				echo "<tr>";
				if($_SESSION['Langue']=="EN"){
					echo "<td>&nbsp; By : ".$_SESSION['PRODUCTIVITE_Par']."</td>";
				}
				else{
					echo "<td>&nbsp; Par : ".$_SESSION['PRODUCTIVITE_Par']."</td>";
				}
				echo "</tr>";
			}
			if($_SESSION['PRODUCTIVITE_WP']<>""){
				echo "<tr>";
				if($_SESSION['Langue']=="EN"){
					echo "<td>&nbsp; Workpackage : ".$_SESSION['PRODUCTIVITE_WP']."</td>";
				}
				else{
					echo "<td>&nbsp; Workpackage : ".$_SESSION['PRODUCTIVITE_WP']."</td>";
				}
			...
			if($_SESSION['PRODUCTIVITE_Tache']<>""){
				echo "<tr>";
				if($_SESSION['Langue']=="EN"){
					echo "<td>&nbsp; Task : ".$_SESSION['PRODUCTIVITE_Tache']."</td>";
				}
				else{
					echo "<td>&nbsp; Tâche : ".$_SESSION['PRODUCTIVITE_Tache']."</td>";
				}
				echo "</tr>";
			}
			if($_SESSION['PRODUCTIVITE_UO']<>""){
				echo "<tr>";
				if($_SESSION['Langue']=="EN"){
					echo "<td>&nbsp; Work unit : ".$_SESSION['PRODUCTIVITE_UO']."</td>";
				}
				else{
					echo "<td>&nbsp; Unité d'oeuvre : ".$_SESSION['PRODUCTIVITE_UO']."</td>";
				}
				echo "</tr>";
			}
			if($_SESSION['PRODUCTIVITE_Collaborateur']<>""){
				echo "<tr>";
				if($_SESSION['Langue']=="EN"){
					echo "<td>&nbsp; Collaborater : ".$_SESSION['PRODUCTIVITE_Collaborateur']."</td>";
				}
				else{
					echo "<td>&nbsp; Collaborateur : ".$_SESSION['PRODUCTIVITE_Collaborateur']."</td>";
				}
				echo "</tr>";
			}
		...
		<tr>
			<td align="center">
			<input class="Bouton" name="Recherche_RAZ_PRODUCTIVITE" type="submit" value="<?php if($_SESSION['Langue']=="EN"){echo "Clear search criteria";}else{echo "Vider les critères de recherche";}?>"> &nbsp;&nbsp;&nbsp;&nbsp;
			</td>
		</tr>
	</table>
	</td></tr>
	...
	<tr><td>
		<table cellpadding="0" cellspacing="0" align="center" class="GeneralInfo" style="width:98%;">
			<tr>
				<td><a style="text-decoration:none;" href="javascript:Excel_Productivite()">&nbsp;&nbsp;&nbsp;&#x2794;&nbsp;&nbsp;<?php if($_SESSION['Langue']=="EN"){echo "Productivity indicators";}else{echo "Indicateurs de productivité";}?>&nbsp;</a></td>
			</tr>
		</table>
		</td>
	</tr>
			...
			<?php
				...
				if($_SESSION['TDB_ModeFiltre']=="oui"){
					if ($nbResulta>0){
						...
						$req2="SELECT trame_travaileffectue.Id_WP, 
							SUM(trame_travaileffectue_uo.TempsAlloue) AS TempsAlloue 
							FROM trame_travaileffectue_uo 
							LEFT JOIN trame_travaileffectue 
							ON trame_travaileffectue_uo.Id_TravailEffectue=trame_travaileffectue.Id 
							WHERE trame_travaileffectue_uo.TravailFait=1 
							AND trame_travaileffectue.Statut='VALIDE' 
						...
						$req2="SELECT trame_travaileffectue.Id_WP,SUM(trame_travaileffectue_uo.TempsAlloue) AS TempsAlloue 
							FROM trame_travaileffectue_uo 
							LEFT JOIN trame_travaileffectue ON trame_travaileffectue_uo.Id_TravailEffectue=trame_travaileffectue.Id 
							WHERE trame_travaileffectue_uo.TravailFait=1 
							AND trame_travaileffectue.Statut='A VALIDER' 
							AND trame_travaileffectue.Id_Prestation=".$_SESSION['Id_PrestationTR']." ";
						if($_SESSION['TDB_Preparateur2']<>""){
							$tab = explode(";",$_SESSION['TDB_Preparateur2']);
							$req2.="AND (";
						...
						$req2="SELECT trame_travaileffectue.Id_WP,
							...
							ON trame_travaileffectue_uo.Id_TravailEffectue=trame_travaileffectue.Id 
							WHERE trame_travaileffectue_uo.TravailFait=1 
							AND (trame_travaileffectue.Statut='EN COURS' OR trame_travaileffectue.Statut='BLOQUE' OR trame_travaileffectue.Statut='AC' OR trame_travaileffectue.Statut='REC' OR trame_travaileffectue.Statut='CONTROLE') 
							AND trame_travaileffectue.Id_Prestation=".$_SESSION['Id_PrestationTR']." ";
						if($_SESSION['TDB_Preparateur2']<>""){
							$tab = explode(";",$_SESSION['TDB_Preparateur2']);
							$req2.="AND (";
						...
						$req2="SELECT trame_travaileffectue.Id_WP,
							...
							ON trame_travaileffectue_uo.Id_TravailEffectue=trame_travaileffectue.Id 
							WHERE trame_travaileffectue_uo.TravailFait=1 
							AND trame_travaileffectue.Statut='REFUSE' 
							AND trame_travaileffectue.Id_Prestation=".$_SESSION['Id_PrestationTR']." ";
						if($_SESSION['TDB_Preparateur2']<>""){
							$tab = explode(";",$_SESSION['TDB_Preparateur2']);
							$req2.="AND (";
						...
						if($nbResultaPlanning>0){
							...
							$req2.="WHERE trame_planning.Id_WP<>0 AND ";
							if($_SESSION['TDB_Preparateur2']<>""){
								$tab = explode(";",$_SESSION['TDB_Preparateur2']);
								$req2.=" (";
								foreach($tab as $valeur){
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" align="left" class="GeneralInfo" style="width:100%;">
			...
			<?php
				...
				$couleur="#ffffff";
				if($_SESSION['TDB_ModeFiltre']=="oui"){
					$req2="SELECT trame_travaileffectue.Id_Preparateur,SUM(trame_travaileffectue_uo.TempsAlloue) AS TempsAlloue 
					FROM trame_travaileffectue_uo 
					LEFT JOIN trame_travaileffectue ON trame_travaileffectue_uo.Id_TravailEffectue=trame_travaileffectue.Id 
					WHERE trame_travaileffectue.Id_Prestation=".$_SESSION['Id_PrestationTR']." 
					AND trame_travaileffectue_uo.TravailFait=1 
					AND trame_travaileffectue.Statut='VALIDE' 
					AND trame_travaileffectue.Id_Prestation=".$_SESSION['Id_PrestationTR']." ";
					if($_SESSION['TDB_WP2']<>""){
						$tab = explode(";",$_SESSION['TDB_WP2']);
					...
					$req2="SELECT trame_travaileffectue.Id_Preparateur, SUM(trame_travaileffectue_uo.TempsAlloue) AS TempsAlloue FROM trame_travaileffectue_uo ";
					$req2.="LEFT JOIN trame_travaileffectue ON trame_travaileffectue_uo.Id_TravailEffectue=trame_travaileffectue.Id 
					WHERE trame_travaileffectue.Id_Prestation=".$_SESSION['Id_PrestationTR']." AND trame_travaileffectue_uo.TravailFait=1 AND trame_travaileffectue.Statut='REFUSE' ";
					if($_SESSION['TDB_WP2']<>""){
						$tab = explode(";",$_SESSION['TDB_WP2']);
						$req2.="AND (";
						foreach($tab as $valeur){
