...
if($_SESSION['Langue']=="EN"){
	...
	$sheet->setCellValue('E1',utf8_encode("Préparateur"));
	$sheet->setCellValue('F1',utf8_encode("Valideur"));
	$sheet->setCellValue('G1',utf8_encode("Contrôleur"));
	$sheet->setCellValue('H1',utf8_encode("Date de production"));
	$sheet->setCellValue('I1',utf8_encode("Date de validation"));
	$sheet->setCellValue('J1',utf8_encode("Date de contrôle"));
	$sheet->setCellValue('K1',utf8_encode("Informations complémentaires"));
	$sheet->setCellValue('L1',utf8_encode("Statut délais"));
	$sheet->setCellValue('M1',utf8_encode("Responsable délais"));
	$sheet->setCellValue('N1',utf8_encode("Cause délais"));
	...
	$sheet->setCellValue('R1',utf8_encode("Temps alloué"));
	if($nbResultaPlanning>0){
		$sheet->setCellValue('S1',utf8_encode("Temps passé"));
	}
}
if($nbResultaPlanning>0){
