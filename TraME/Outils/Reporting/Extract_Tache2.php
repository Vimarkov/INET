...
if($_SESSION['Langue']=="EN"){
	...
	$sheet->setCellValue('I1',utf8_encode("Statut délais"));
	$sheet->setCellValue('J1',utf8_encode("Responsable délais"));
	$sheet->setCellValue('K1',utf8_encode("Cause délais"));
	...
	$sheet->setCellValue('O1',utf8_encode("Temps alloué"));
	
	$sheet->setCellValue('P1',utf8_encode("Id"));
	$sheet->setCellValue('Q1',utf8_encode("Année production"));
