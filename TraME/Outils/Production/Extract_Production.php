...
if($_SESSION['Langue']=="EN"){
	...
	if($nbResultaPlanning>0){
		$sheet->setCellValue('F1',utf8_encode("Temps passé"));
		$sheet->setCellValue('G1',utf8_encode("Préparateur"));
		$sheet->setCellValue('H1',utf8_encode("Informations complémentaires"));	
	}
	else{
		$sheet->setCellValue('F1',utf8_encode("Préparateur"));
		$sheet->setCellValue('G1',utf8_encode("Informations complémentaires"));
	}
}
if($nbResultaPlanning>0){
