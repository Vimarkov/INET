...
$tabIntituleEN = array("Reference","Date of work","Workpackage","Task family","Task","Status","Allotted time","Time spent","Manufacturing Engineer","Controller","Further information","Responsible","Reason for return","Delay","Comment delay","Comment");
 ...
 if($_POST){
	foreach($tabChamps as $value){
		$_SESSION['ChampsPROD_'.$value]=$value."_".$_POST['taille_'.$value]."_".$_POST['visible_'.$value];
...
<form class="test" method="POST" action="Modif_AffichagePROD.php">
	<tr>
		<td>
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="4"></td>
					<td class="TitrePage"><?php if($_SESSION['Langue']=="EN"){echo "PRODUCTION - COLUMNS";}else{echo "PRODUCTION - COLONNES";} ?></td>
				</tr>
			</table>
		</td>
	</tr>
