...
<?php Ecrire_Code_JS_Init_Date(); ?>
	...
	<table style="width:100%; align:center;">
		...
		<?php 
			$checkedcb="";
				if ($LigneSurveillance['Etat2'] <> "Planifié" && $LigneSurveillance['Etat2'] <> "Replanifié"){$checkedcb="checked";}
		?>
					...
					if($nbQuestion > 0)
					{
						while($rowQuestion=mysqli_fetch_array($resultQuestion))
						{
							...
							echo "<tr id='tr1_".$rowQuestion['ID']."'>";
								...
								{
									$laQuestion = "";
									if($LigneSurveillance['Etat'] == "Planifié" || $LigneSurveillance['Etat'] == "Replanifié"){
										if($_SESSION['Langue']=="FR"){
