...
if($_POST)
{
	if(isset($_POST['btnEnregistrer']) || isset($_POST['btnBrouillon']))
	{
		...
		if(isset($_POST['btnEnregistrer'])){
			echo "<script>window.location='ConsulterSurveillances.php';</script>";
		}
	}
	...
	<tr>
		<td>
			<table style="width:100%; align:center;" class="TableCompetences">
				...
				?>
				<tr>
					<td class="LibelleMobile" align="right" colspan="4"><?php if($LangueAffichage=="FR"){echo "Annexe";}else{echo "Appendix";}?> : 
					<?php
						if($LangueAffichage=="FR"){
							echo "<a class=\"Info\" href=\"DocumentQCM/".$rowQuestionnaire['Annexe']."\"><img src='../../v2/Images/dossier.jpg' style='border:0;width:25px;' title='Annexe'></a>";
						}
						else{
							echo "<a class=\"Info\" href=\"DocumentQCM/".$rowQuestionnaire['Annexe']."\"><img src='../../v2/Images/dossier.jpg' style='border:0;width:25px;' title='Appendix'>></a>";
						}
					?>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="LibelleMobile" width="10%"><?php if($LangueAffichage=="FR"){echo "Date surveillance";}else{echo "Monitoring date";}?> : </td>
					<td class="LibelleMobile" width="10%">
						<?php 
						if($rowQuestionnaire['Etat']=="En cours - papier" || $rowQuestionnaire['Etat']=="Brouillon"){
						?>
							<input style="font-size:2em;width:300px;" type="date" name="dateSurveillance" id="dateSurveillance" value="<?php echo AfficheDateFR($rowQuestionnaire['DateSurveillance']);?>" />
						<?php
						}
						else{
						?>
				...
				<tr>
					<td class="LibelleMobile"><?php echo $rowQuestionnaire['Plateforme'];?></td>
					<td class="LibelleMobile"><?php if($rowQuestionnaire['Id_Plateforme']>0){echo "N/A";}else{echo $rowQuestionnaire['Prestation'];}?></td>
					<td class="LibelleMobile">
					<?php 
						if($rowQuestionnaire['Etat']=="En cours - papier" || $rowQuestionnaire['Etat']=="Brouillon"){
							?>
							<select id="Id_Surveille" name="Id_Surveille" style="font-size:1.5em;width:350px;" onchange="submit()">
								<?php
								$Id_Surveille=0;
					...
					<td class="LibelleMobile">
						...
						if($rowQuestionnaire['Etat']=="En cours - papier" || $rowQuestionnaire['Etat']=="Brouillon"){
						?>
							<select id="Id_Metier" name="Id_Metier" style="font-size:1.5em;width:400px;">
								<?php
								$Id_Metier=0;
	...
	?>
		...
		?>
			<td>
				<table class="TableCompetences" style="width:100%; align:center;background-color:#bac8ff;">
					<tr>
						<td width="5%" class="LibelleMobile">N° <?php echo $rowQuestionnaire['Id'];?></td>
						<td width="10%" class="LibelleMobile"><?php if($_SESSION['Langue']=="FR"){echo "Thème : ";}else{echo "Theme : ";}?></td>
		...
		<tr>
			<td align="right" style="font-size:2em;color:#00567c;">
				<input type="checkbox" class="Checkbox" id="CB_NC" name="CB_NC" onchange="javascript:AfficherMasquerlesNC()" <?php if($rowQuestionnaire['Etat']=="Clôturé"){echo "checked";}?> />
				<?php if($_SESSION['Langue']=="FR"){echo "Récapitulatif des Non-Conformités";}else{echo "Summary of Non-Conformities";}?>
			</td>
		</tr>
		<?php 
			echo "<tr class='Questionnaire_".$rowQuestionnaire['Id_Questionnaire']."'>";
						...
						while($rowQuestion=mysqli_fetch_array($resultQuestion))
						{
								...
								echo "<td >
										<table width='100%'>";
											...
											?>
											<tr id="tr4_<?php echo $rowQuestion['Id']; ?>">
											...
											$action = "";
											$typeNA = "";
											$display2NC = "display:none";
											$display2NA = "display:none";
											
											if($rowQuestion['Etat']=='C'){$checkC = "checked";}
											elseif($rowQuestion['Etat']=='NC'){$checkNC = "checked";$action = stripslashes($rowQuestion['Action']);$displayNC = "";$display2NC = "";}
											elseif($rowQuestion['Etat']=='NA'){$checkNA = "checked";$typeNA =$rowQuestion['TypeNA'];$displayNA = "";$display2NA = "";}
											...
											echo "<tr>
												<td id='tr3_".$rowQuestion['Id']."' class='LibelleMobile'>
											";
											...
											if($_SESSION['Langue']=="FR"){
											echo "
													<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."');AfficherTout();\" class='radioNote Checkbox' type='radio' name='radio_".$rowQuestion['Id']."' value='C' ".$checkC.">Conforme&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."');AfficherTout();\" class='radioNote Checkbox' type='radio' name='radio_".$rowQuestion['Id']."' value='NC' ".$checkNC.">Non conforme&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."');AfficherTout();\" class='radioNote Checkbox' type='radio' name='radio_".$rowQuestion['Id']."' value='NA' ".$checkNA.">Non applicable
												";
											}
											else{
											echo "
													<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."');AfficherTout();\" class='radioNote Checkbox' type='radio' name='radio_".$rowQuestion['Id']."' value='C' ".$checkC.">Compliant&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."');AfficherTout();\" class='radioNote Checkbox' type='radio' name='radio_".$rowQuestion['Id']."' value='NC' ".$checkNC.">Improper&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."');AfficherTout();\" class='radioNote Checkbox' type='radio' name='radio_".$rowQuestion['Id']."' value='NA' ".$checkNA.">Not applicable
												";	
											}
											echo "</td>
												</tr>
										...
										<tr id="tr_<?php echo $rowQuestion['Id']; ?>">
											<td>
												...
												<br>
												<label style="font-size:2em;<?php echo $display2NC; ?>" id="labelAction_<?php echo $rowQuestion['Id'];?>">Action</label><br>
												<select style="font-size:2em;width:600px;<?php echo $display2NC; ?>" class="actions_<?php echo $rowQuestionnaire['Id_Questionnaire'];?>" id="<?php echo "action_".$rowQuestion['Id'];?>" name="<?php echo "action_".$rowQuestion['Id'];?>">
												<?php 
													if($_SESSION['Langue']=="FR"){
												...
												<label style="font-size:2em;<?php echo $display2NA; ?>" id="labelNA_<?php echo $rowQuestion['Id'];?>"><?php if($_SESSION['Langue']=="FR"){echo "Type de non applicabilité";}else{echo "Type of non-applicability";}?></label><br>
												<select style="font-size:2em;width:600px;<?php echo $display2NA; ?>" class="typeNA_<?php echo $rowQuestionnaire['Id_Questionnaire'];?>" id="<?php echo "typeNA_".$rowQuestion['Id'];?>" name="<?php echo "typeNA_".$rowQuestion['Id'];?>">
													...
													<option value="2" <?php if($typeNA=="2"){echo "selected";}?>><?php if($_SESSION['Langue']=="FR"){echo "Liée à la prestation (permanente)";}else{echo "Linked to site (permanent)";}?></option>
												</select>
											</td>
										</tr>
											<?php
											...
											if($k==0){
												...
												echo "<td width='90%' >
														<table width='100%'>";
															...
															<tr>";
																echo "<td class='LibelleMobile'>";
																echo "<b>Q</b> <input type='text' style='font-size:1.4em;width:900px;' id='QuestionAQ_".$rowQuestionnaire['Id_Questionnaire']."_".$k."' name='QuestionAQ_".$rowQuestionnaire['Id_Questionnaire']."_".$k."' onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."')\" value='".$question."' />";
																echo "</td>
															</tr>
															<tr>";
																echo "<td class='LibelleMobile'>";
																echo "<b>R</b> <input type='text'style='font-size:1.4em;width:900px;' id='QuestionAR_".$rowQuestionnaire['Id_Questionnaire']."_".$k."' name='QuestionAR_".$rowQuestionnaire['Id_Questionnaire']."_".$k."' value='".$reponse."' />";
																echo "</td>
															</tr>
															";
															...
															if($_SESSION['Langue']=="FR"){
															echo "
																	<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."');AfficherTout();\" class='radioNoteQA Checkbox' type='radio' name='radio_".$rowQuestionnaire['Id_Questionnaire']."_".$k."' value='C' ".$checkC.">Conforme&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																	<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."');AfficherTout();\" class='radioNoteQA Checkbox' type='radio' name='radio_".$rowQuestionnaire['Id_Questionnaire']."_".$k."' value='NC' ".$checkNC.">Non conforme&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																";
															}
															else{
															echo "
																	<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."');AfficherTout();\" class='radioNoteQA Checkbox' type='radio' name='radio_".$rowQuestionnaire['Id_Questionnaire']."_".$k."' value='C' ".$checkC.">Compliant&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																	<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."');AfficherTout();\" class='radioNoteQA Checkbox' type='radio' name='radio_".$rowQuestionnaire['Id_Questionnaire']."_".$k."' value='NC' ".$checkNC.">Improper&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																";	
															}
															echo "</td>
																</tr>
														...
														<tr id="tr_<?php echo $rowQuestionnaire['Id_Questionnaire']."_".$k; ?>">
															<td>
																...
																<br>
																<label style="font-size:2em;<?php echo $display2NC; ?>" id="labelAction_<?php echo $rowQuestionnaire['Id_Questionnaire']."_".$k;?>">Action</label><br>
																<select style="font-size:2em;width:600px;<?php echo $display2NC; ?>" class="actions_<?php echo $rowQuestionnaire['Id_Questionnaire'];?>" id="<?php echo "action_".$rowQuestionnaire['Id_Questionnaire']."_".$k;?>" name="<?php echo "action_".$rowQuestionnaire['Id_Questionnaire']."_".$k;?>">
																<?php 
																	if($_SESSION['Langue']=="FR"){
																		if($action==""){echo "<option value='' selected></option>";}
																		else{
																...
																<label style="font-size:2em;<?php echo $display2NA; ?>" id="labelNA_<?php echo $rowQuestionnaire['Id_Questionnaire']."_".$k;?>"><?php if($_SESSION['Langue']=="FR"){echo "Type de non applicabilité";}else{echo "Type of non-applicability";}?></label><br>
																<select style="font-size:2em;width:600px;<?php echo $display2NA; ?>" class="typeNA_<?php echo $rowQuestionnaire['Id_Questionnaire'];?>" id="<?php echo "typeNA_".$rowQuestionnaire['Id_Questionnaire']."_".$k;?>" name="<?php echo "typeNA_".$rowQuestionnaire['Id_Questionnaire']."_".$k;?>">
																	<option value="0" selected></option>
																	...
																	<option value="2"><?php if($_SESSION['Langue']=="FR"){echo "Liée à la prestation (permanente)";}else{echo "Linked to site (permanent)";}?></option>
																</select>
															</td>
														</tr>
															<?php
								...
								<table style="width:100%; align:center;" class="TableCompetences">
									...
									while($rowQuestion=mysqli_fetch_array($resultQuestion))
									{
										...
										echo "<td width='90%' >
												<table width='100%'>";
													echo "
													<tr id='tr1_".$rowQuestion['Id']."'>";
														echo "<td class='LibelleMobile'>";
														echo "<b>Q</b> <input type='text' style='font-size:1.4em;width:900px;' id='QuestionAQ_".$rowQuestion['Id']."' name='QuestionAQ_".$rowQuestion['Id']."' onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."')\" value='".stripslashes($rowQuestion['QuestionAdditionnelle'])."' /><br>";
														
														echo "<b>R</b> <input type='text' style='font-size:1.4em;width:900px;' id='QuestionAR_".$rowQuestion['Id']."' name='QuestionAR_".$rowQuestion['Id']."' value='".stripslashes($rowQuestion['ReponseAdditionnelle'])."' />";
														echo "</td>
													</tr>
													";
													...
													if($rowQuestion['Etat']=='C'){$checkC = "checked";}
													elseif($rowQuestion['Etat']=='NC'){$checkNC = "checked";$action = stripslashes($rowQuestion['Action']);$displayNC = "";$display2N = "";}
													
													$observation =stripslashes($rowQuestion['Commentaire']);

													echo "<tr id='tr3_".$rowQuestion['Id']."'>
														<td class='LibelleMobile'>
													";
													...
													if($_SESSION['Langue']=="FR"){
													echo "
															<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."');AfficherTout();\" class='radioNoteQA Checkbox' type='radio' name='radio_".$rowQuestion['Id']."' value='C' ".$checkC.">Conforme&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."');AfficherTout();\" class='radioNoteQA Checkbox' type='radio' name='radio_".$rowQuestion['Id']."' value='NC' ".$checkNC.">Non conforme&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														";
													}
													else{
													echo "
															<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."');AfficherTout();\" class='radioNoteQA Checkbox' type='radio' name='radio_".$rowQuestion['Id']."' value='C' ".$checkC.">Compliant&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."');AfficherTout();\" class='radioNoteQA Checkbox' type='radio' name='radio_".$rowQuestion['Id']."' value='NC' ".$checkNC.">Improper&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														";	
													}
													echo "</td>
														</tr>
												...
												<tr id="tr_<?php echo $rowQuestion['Id']; ?>" >
													<td>
														<label style="font-size:2em;" id="label_<?php echo $rowQuestion['Id'];?>"></label><br>
														<input style="font-size:2em;width:600px;" type="text" id="<?php echo "observation_".$rowQuestion['Id'];?>" name="<?php echo "observation_".$rowQuestion['Id'];?>" value="<?php echo stripslashes($observation);?>">
														<br>
														<label style="font-size:2em;<?php echo $display2NC; ?>" id="labelAction_<?php echo $rowQuestion['Id'];?>">Action</label><br>
														<select style="font-size:2em;width:600px;<?php echo $display2NC; ?>" class="actions_<?php echo $rowQuestionnaire['Id_Questionnaire'];?>" id="<?php echo "action_".$rowQuestion['Id'];?>" name="<?php echo "action_".$rowQuestion['Id'];?>">
														<?php 
												...
												<tr id="tr4_<?php echo $rowQuestion['Id']; ?>">
													<td class="LibelleMobile" align="right">
													</td>
												</tr>
													<?php
										echo "
				...
				<table style="width:100%; align:center;" class="TableCompetences">
					...
					<tr>
						<td colspan="3" style="color:#00567c;" valign="top" align="left" class="LibelleMobile">
							...
							<textarea name="commentaire_<?php echo $rowQuestionnaire['Id_Questionnaire'];?>" id="commentaire_<?php echo $rowQuestionnaire['Id_Questionnaire'];?>" cols="100" rows="5"  style="font-size:14px;resize:none;"><?php echo $rowQuestionnaire['Commentaire'];?></textarea>
						</td>
					</tr>
					<tr><td height="10"></td></tr>
					<tr>
						<td colspan="3" style=""class="LibelleMobile">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="height: 20px; width: 20px;" type="checkbox" checked class="signatures" name="signatureSurveillant" value="signatureSurveillant" >
					...
					<tr>
						<td colspan="3" style=""class="LibelleMobile">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="height: 20px; width: 20px;" type="checkbox" checked class="signatures" name="signatureSurveille" value="signatureSurveille" >
					...
					<tr>
						<td colspan="7" align="center">
							<input style="" class="Bouton BoutonMobile" type="submit" name="btnEnregistrer" onClick="return VerifChamps2();" value="<?php if($_SESSION['Langue']=="FR"){echo "Clôturer";}else{echo "Enclose";}?>">
					...
					<?php 
							...
							if($rowQuestionnaire['Etat']=="Clôturé" && ($rowQuestionnaire['Id_Surveillant']==$_SESSION['Id_Personne'] || DroitsFormationPlateforme(array($IdPosteResponsableQualite,$IdPosteChargeMissionOperation)) || DroitsFormationPrestation(array($IdPosteReferentQualiteProduit,$IdPosteReferentQualiteSysteme,8)))){
					?>
					<tr><td height="5"></td></tr>
					<tr>
						<td colspan="7" align="center">
							<input style="" class="Bouton BoutonMobile" type="submit" name="btnModifFiche" value="<?php if($_SESSION['Langue']=="FR"){echo "Modifier n° Fiche AT";}else{echo "Modify AT sheet number";}?>">
					...
					<tr <?php if($rowQuestionnaire['Etat']=="Clôturé" &&  $rowQuestionnaire['EnFormation']==1){echo "style='display:;'";}else{echo "style='display:none;'";} ?>>
						<td colspan="3" style="" class="LibelleMobile">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="height: 20px; width: 20px;" type="checkbox"  <?php if($rowQuestionnaire['AttestationSurveillance']==1){echo "checked";}?> class="signatures" name="attestationSurveillance" value="attestationSurveillance" >
					...
					<?php
						...
						<tr>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input style="" class="Bouton BoutonMobile" type="submit" name="btnAttestation" onClick="return VerifAttestation();" value="<?php if($_SESSION['Langue']=="FR"){echo "J'atteste";}else{echo "I hereby certify";}?>">
							</td>
						</tr>
						<?php
						}
