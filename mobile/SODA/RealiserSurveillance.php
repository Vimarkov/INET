							...
							echo "<td width='90%' >
									...
									<tr id="tr_<?php echo $rowQuestionnaire['Id_Questionnaire']."_".$k; ?>">
										<td>
											...
											<label style="font-size:2em;<?php echo $displayNA; ?>" id="labelNA_<?php echo $rowQuestionnaire['Id_Questionnaire']."_".$k;?>"><?php if($_SESSION['Langue']=="FR"){echo "Type de non applicabilité";}else{echo "Type of non-applicability";}?></label><br>
