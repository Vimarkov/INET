...
?>
<form class="test" id="formulaire" action="SurveillanceNonPlanifiee.php" method="post">
...
<table class="TableCompetences" style="width:100%; align:center;">
	...
	<tr>
		...
		<td width="20%">
			<select id="Id_Prestation" name="Id_Prestation" class="Mobile" onchange="submit();">
				<?php
					$Id_Prestation=0;
					if($_POST){
	...
	<tr><td height="4"></td></tr>
	<tr>
		<td colspan="10" align="center" style="display:<?php echo $visible;?>;">
