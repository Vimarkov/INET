...
if($_POST)
{
	if(isset($_POST['btnEnregistrer']) || isset($_POST['btnBrouillon']))
	{
		...
		WHERE (Id_SurveillanceMere=".$_POST['Id']." OR Id=".$_POST['Id'].")
		AND Suppr=0
		...
		if(isset($_POST['btnEnregistrer'])){
			echo "<script>window.location='SurveillanceNonPlanifiee.php';</script>";
		}
	}
}
...
$req = "SELECT Id, 
		...
		(SELECT AutoriserQuestionsAdditionnelles FROM soda_questionnaire WHERE Id=Id_Questionnaire) AS AutoriserQuestionsAdditionnelles
		FROM soda_surveillance 
		WHERE Id_PlannifManuelle=0
		AND (Id_SurveillanceMere=".$Id_SurveillanceMere." OR Id=".$Id_SurveillanceMere.")
		AND Suppr=0
		AND Etat IN ('Planifié','Brouillon')
		";	
$result=mysqli_query($bdd,$req);
...
?>
<form class="test" id="formulaire" action="RealiserSurveillance2.php" method="post">
				...
				<table class="TableCompetences" style="width:100%; align:center;background-color:#bac8ff;">
					...
					<tr>
						<td class="Libelle" align="center" colspan="5">
							<?php if($nbQ>1){ ?>
								<img style="cursor:pointer;" width='30px' src='../../v2/Images/Gauche.png' onclick="Afficher('G','<?php echo $rowQuestionnaire['Id_Questionnaire'];?>','<?php echo $IdQuestionnairePrecedent;?>')" border='0' alt='Précédent' title='Précédent'>
							<?php	} ?>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								echo "<td >
										...
										<tr id="tr_<?php echo $rowQuestion['Id']; ?>">
											<td>
												...
												<select class="actions_<?php echo $rowQuestionnaire['Id_Questionnaire'];?>" style="font-size:2em;width:600px;<?php echo $displayNC; ?>" id="<?php echo "action_".$rowQuestion['Id'];?>" name="<?php echo "action_".$rowQuestion['Id'];?>">
												<?php 
													if($_SESSION['Langue']=="FR"){
												...
												<label style="font-size:2em;<?php echo $displayNA; ?>" id="labelNA_<?php echo $rowQuestion['Id'];?>"><?php if($_SESSION['Langue']=="FR"){echo "Type de non applicabilité";}else{echo "Type of non-applicability";}?></label><br>
												<select class="typeNA_<?php echo $rowQuestionnaire['Id_Questionnaire'];?>" style="font-size:2em;width:600px;<?php echo $displayNA; ?>" id="<?php echo "typeNA_".$rowQuestion['Id'];?>" name="<?php echo "typeNA_".$rowQuestion['Id'];?>">
						...
						if($k==0){
							...
							echo "<td width='90%' >
									<table width='100%'>";
										...
										if($_SESSION['Langue']=="FR"){
										echo "
												<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."')\" class='radioNote Checkbox' type='radio' name='radio_".$rowQuestionnaire['Id_Questionnaire']."_".$k."' value='C' ".$checkC.">Conforme&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."')\" class='radioNote Checkbox' type='radio' name='radio_".$rowQuestionnaire['Id_Questionnaire']."_".$k."' value='NC' ".$checkNC.">Non conforme&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											";
										}
										else{
										echo "
												<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."')\" class='radioNote Checkbox' type='radio' name='radio_".$rowQuestionnaire['Id_Questionnaire']."_".$k."' value='C' ".$checkC.">Compliant&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input onchange=\"Change_Note('".$rowQuestionnaire['Id_Questionnaire']."','".$_SESSION['Langue']."')\" class='radioNote Checkbox' type='radio' name='radio_".$rowQuestionnaire['Id_Questionnaire']."_".$k."' value='NC' ".$checkNC.">Improper&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											";	
										}
										echo "</td>
											</tr>
									...
									<tr id="tr_<?php echo $rowQuestionnaire['Id_Questionnaire']."_".$k; ?>">
										<td>
											...
											<select class="actions_<?php echo $rowQuestionnaire['Id_Questionnaire'];?>" style="font-size:2em;width:600px;<?php echo $displayNC; ?>" id="<?php echo "action_".$rowQuestionnaire['Id_Questionnaire']."_".$k;?>" name="<?php echo "action_".$rowQuestionnaire['Id_Questionnaire']."_".$k;?>">
											<?php 
												if($_SESSION['Langue']=="FR"){
													if($action==""){echo "<option value='' selected></option>";}
													else{
											...
											<label style="font-size:2em;<?php echo $display2; ?>" id="labelNA_<?php echo $rowQuestionnaire['Id_Questionnaire']."_".$k;?>"><?php if($_SESSION['Langue']=="FR"){echo "Type de non applicabilité";}else{echo "Type of non-applicability";}?></label><br>
											<select class="typeNA_<?php echo $rowQuestionnaire['Id_Questionnaire'];?>" style="font-size:2em;width:600px;<?php echo $display2; ?>" id="<?php echo "typeNA_".$rowQuestionnaire['Id_Questionnaire']."_".$k;?>" name="<?php echo "typeNA_".$rowQuestionnaire['Id_Questionnaire']."_".$k;?>">
												<option value="0" selected></option>
				...
				<table style="width:100%; align:center;" class="TableCompetences">
					...
					<tr>
						<td style="color:#00567c;" colspan="3" align="left" class="LibelleMobile">
							...
							<?php
								$note = "100";
							?>
							<input style="font-size:1.6em;width:150px;" class="Mobile" readonly id="note_<?php echo $rowQuestionnaire['Id_Questionnaire'];?>" type="text" value="<?php echo $note."%" ?>" size="5"/>
					...
					<tr>
						<td colspan="3" style="color:#00567c;" align="left" class="LibelleMobile">
							...
							<input class="AT Mobile" name="numActionTraker_<?php echo $rowQuestionnaire['Id_Questionnaire'];?>" id="numActionTraker_<?php echo $rowQuestionnaire['Id_Questionnaire'];?>" type="text" value="<?php echo $rowQuestionnaire['NumActionTracker'];?>" size="10"/>
						</td>
					</tr>
					<tr><td height="5"></td></tr>
					<tr>
				...
				<table style="width:100%; align:center;" class="TableCompetences">
					<tr>
						<td class="LibelleMobile" align="center">
							<img style="cursor:pointer;" width='30px' src='../../v2/Images/Gauche.png' onclick="Afficher('resultat',0,<?php echo $IdQuestionnairePrecedent;?>)" border='0' alt='Précédent' title='Précédent'>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</td>
					...
					<tr>
						<td colspan="7" align="center">
							<input style="" class="Bouton BoutonMobile" type="submit" name="btnEnregistrer" onclick="return VerifChamps();" value="<?php if($_SESSION['Langue']=="FR"){echo "Clôturer";}else{echo "Enclose";}?>">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input style="" class="Bouton BoutonMobile" type="submit" name="btnBrouillon" value="<?php if($_SESSION['Langue']=="FR"){echo "Brouillon";}else{echo "Draft";}?>">
