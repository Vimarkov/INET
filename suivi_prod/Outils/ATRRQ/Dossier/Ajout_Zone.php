...
if($_POST){
	if($_POST['Mode']=="A"){
		$droit="";
		$requete="INSERT INTO sp_olwzonedetravail (Libelle,Intitule,Id_CritereZone,Id_Prestation) VALUES ('".addslashes($_POST['libelle'])."','".addslashes($_POST['description'])."',".addslashes($_POST['critere']).",576)";
