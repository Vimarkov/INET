...
if($nbResulta2>0){
	...
	while($row2=mysqli_fetch_array($result2)){
		...
		$reqSum="SELECT DateInterventionQ AS DateTERC FROM sp_olwficheintervention WHERE DateInterventionQ>'0001-01-01' AND Id_StatutQUALITE='TERC' AND sp_olwficheintervention.Id_Dossier=".$row2['Id_Dossier']." ORDER BY DateInterventionQ DESC";
		$resultSum=mysqli_query($bdd,$reqSum);
		$nbSum=mysqli_num_rows($resultSum);
		if ($nbSum>0){
			$rowSum=mysqli_fetch_array($resultSum);
