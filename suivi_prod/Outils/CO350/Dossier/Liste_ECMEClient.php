...
<form class="test" method="POST" action="Liste_ECMEClient.php">
	...
	<tr><td>
		<table cellpadding="0" cellspacing="0" align="left" class="GeneralInfo" style="width:30%;">
			...
			<?php
				$req="SELECT Id,Libelle,(SELECT Libelle FROM sp_olwtypeecmeclient WHERE sp_olwtypeecmeclient.Id=sp_olwecmeclient.Id_Type) AS Type FROM sp_olwecmeclient WHERE Id_Prestation=1792 AND Supprime=false ORDER BY Libelle;";
