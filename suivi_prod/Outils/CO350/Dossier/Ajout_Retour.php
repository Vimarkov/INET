...
if($_POST){
	if($_POST['Mode']=="A"){
		$droit="";
		$requete="INSERT INTO sp_olwretour (Libelle,Id_Statut,Id_Prestation) VALUES ('".addslashes($_POST['libelle'])."','".addslashes($_POST['statut'])."',1792)";
			...
			<tr class="TitreColsUsers">
				...
				<td>
					<select name="statut" id="statut">
						...
						<option value="Retour Qualité" <?php if($_GET['Mode']=="M"){if($Ligne['Id_Statut']=="Retour Qualité"){echo "selected";}}?>>Retour Qualité</option>
