...
$sheet->setCellValue('J4',utf8_encode("PLATEFORME/SITE : TLS / AHDO"));
...
if ($nbResulta>0){
	...
	while($row=mysqli_fetch_array($result)){
		$sheet->setCellValue('A'.$ligne,utf8_encode('AHDO'));
...
header('Content-Disposition: attachment;filename="DQ813-047.xlsx"'); 
header('Cache-Control: max-age=0'); 

$writer = PHPExcel_IOFactory::createWriter($Excel, 'Excel2007');

$chemin = '../../../tmp/DQ813-047.xlsx';
$writer->save($chemin);
readfile($chemin);
?>