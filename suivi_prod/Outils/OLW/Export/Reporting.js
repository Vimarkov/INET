...
function ExtractTERC(){
	if (document.getElementById('duTERC').value!=""){
		var w=window.open("Extract_TERC.php?du="+document.getElementById('duTERC').value+"&au="+document.getElementById('auTERC').value,"PageExtract","status=no,menubar=no,scrollbars=yes,width=60,height=40");
		w.focus();
	}
