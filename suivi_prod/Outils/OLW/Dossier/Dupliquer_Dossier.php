...
if($_GET){
	...
	$req.="sp_olwdossier.Id_Client,sp_olwdossier.Oxygene,sp_olwdossier.Elec,sp_olwdossier.Hydraulique,sp_olwdossier.NumSN,sp_olwdossier.TypeACP,sp_olwdossier.Id_LigneContrat, ";
						...
						<tr>
							...
							<td width="20%" bgcolor="#dbeef9">
								<select id="statutProd" name="statutProd" onchange="Recharge_StatutProd();" <?php echo $disabledCE;?>>
									<option name="" value=""></option>
									<?php
									$req="SELECT Id FROM sp_olwstatut WHERE TypeStatut='P' AND Id<>'REWORK' AND Id_Prestation=688 ORDER BY Id;";
									$result=mysqli_query($bdd,$req);
									$nbResulta=mysqli_num_rows($result);
									if ($nbResulta>0){
