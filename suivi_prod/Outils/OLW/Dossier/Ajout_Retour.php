...
if($_POST){
	if($_POST['Mode']=="A"){
		$droit="";
		$requete="INSERT INTO sp_olwretour (Libelle,Id_Statut,EstRetour,Id_Prestation) VALUES ('".addslashes($_POST['libelle'])."','".addslashes($_POST['statut'])."',".$_POST['estRetour'].",688)";
