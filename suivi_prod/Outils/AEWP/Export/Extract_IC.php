...
$sheet->setCellValue('F1',utf8_encode("Contrôleur"));
...
$req.="WHERE sp_olwdossier.Id_Prestation=237 AND sp_olwdossier.Id_Statut='TERC' AND sp_olwficheintervention.NumFI<>'' ";
