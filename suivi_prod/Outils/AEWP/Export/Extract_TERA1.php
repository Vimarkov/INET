...
$req.="WHERE sp_olwdossier.Id_Prestation=237 AND sp_olwficheintervention.Id_StatutPROD='TERA' ";
...
if ($nbResulta>0){	
	while($row=mysqli_fetch_array($result)){
		...
		$req.=" AND sp_olwficheintervention.Id_StatutPROD IN ('A RELANCER','RETOUR PREPA','RETOUR PROD','TFS') ";
