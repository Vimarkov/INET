	...
	<script language="javascript">
		function ExtractIC(){
			if (document.getElementById('du').value!=""){
				var w=window.open("Extract_IC.php?du="+document.getElementById('du').value+"&au="+document.getElementById('au').value,"PageExtract","status=no,menubar=no,scrollbars=yes,width=60,height=40");
				w.focus();
			}
			else{alert("Veuillez compléter les critères");}
		}
		function ExtractTERC(){
			if (document.getElementById('du').value!=""){
				var w=window.open("Extract_TERC.php?du="+document.getElementById('du').value+"&au="+document.getElementById('au').value,"PageExtract","status=no,menubar=no,scrollbars=yes,width=60,height=40");
				w.focus();
			}
			else{alert("Veuillez compléter les critères");}
		}
		function ExtractRETQ(){
			if (document.getElementById('du').value!=""){
				var w=window.open("Extract_RETQ.php?du="+document.getElementById('du').value+"&au="+document.getElementById('au').value,"PageExtract","status=no,menubar=no,scrollbars=yes,width=60,height=40");
				w.focus();
			}
			else{alert("Veuillez compléter les critères");}
		}
		function ExtractPlanifPROD(){
			if (document.getElementById('du').value!=""){
				var w=window.open("Extract_PlanifPROD.php?du="+document.getElementById('du').value+"&au="+document.getElementById('au').value,"PageExtract","status=no,menubar=no,scrollbars=yes,width=60,height=40");
				w.focus();
			}
			else{alert("Veuillez compléter les critères");}
		}
		function ExtractCompteRendu(){
			if (document.getElementById('du').value!=""){
				var w=window.open("Extract_CompteRendu.php?du="+document.getElementById('du').value+"&au="+document.getElementById('au').value,"PageExtract","status=no,menubar=no,scrollbars=yes,width=60,height=40");
				w.focus();
			}
			else{alert("Veuillez compléter les critères");}
		}
		function ExtractTERA1(){
			if (document.getElementById('du').value!=""){
				var w=window.open("Extract_TERA1.php?du="+document.getElementById('du').value+"&au="+document.getElementById('au').value,"PageExtract","status=no,menubar=no,scrollbars=yes,width=60,height=40");
				w.focus();
			}
			else{alert("Veuillez compléter les critères");}
		}
		function ExtractTERA2(){
			if (document.getElementById('du').value!=""){
				var w=window.open("Extract_TERA2.php?du="+document.getElementById('du').value+"&au="+document.getElementById('au').value,"PageExtract","status=no,menubar=no,scrollbars=yes,width=60,height=40");
				w.focus();
			}
			else{alert("Veuillez compléter les critères");}
		}
...
<table width="100%" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
		<td width="50%" valign="top">
			<table width="100%">
				<tr>
					<td class="MoyenTitre">DOSSIERS</td>
				</tr>
				<tr><td>
					<table width="100%" cellpadding="0" cellspacing="0" align="center" class="GeneralInfo">
						...
						<tr>
							...
							<td width="10%"><input type="date" name="du" id="du" value=""/></td>
							<td width="4%" align="left">&nbsp; au </td>
							<td width="60%"><input type="date" name="au" id="au" value=""/></td>
						</tr>
					</td></tr>
					<tr><td height="4"></td></tr>
					<tr>
					...
					<tr>
						<td align="left" colspan=4>
							<a style="text-decoration:none;" href="#" onClick="javascript:ExtractIC()" >&nbsp; &bull; Liste des IC des dossiers TERC &nbsp;&nbsp;</a>
						</td>
					</tr>
					<tr>
						<td align="left" colspan=4>
							<a style="text-decoration:none;" href="#" onClick="javascript:ExtractTERC()" >&nbsp; &bull; Liste des dossiers TERC &nbsp;&nbsp;</a>
						</td>
					</tr>
					<tr>
						<td align="left" colspan=4>
							<a style="text-decoration:none;" href="#" onClick="javascript:ExtractRETQ()" >&nbsp; &bull; Liste des retours qualité des dossiers TERC &nbsp;&nbsp;</a>
						</td>
					</tr>
					<tr>
						<td align="left" colspan=4>
							<a style="text-decoration:none;" href="#" onClick="javascript:ExtractPlanifPROD()" >&nbsp; &bull; Liste des dossiers planifiés en production &nbsp;&nbsp;</a>
						</td>
					</tr>
					<tr>
						<td align="left" colspan=4>
							<a style="text-decoration:none;" href="#" onClick="javascript:ExtractTERA1()" >&nbsp; &bull; Liste des TERA du premier coup &nbsp;&nbsp;</a>
						</td>
					</tr>
					<tr>
						<td align="left" colspan=4>
							<a style="text-decoration:none;" href="#" onClick="javascript:ExtractCompteRendu()" >&nbsp; &bull; Compte rendu journalier &nbsp;&nbsp;</a>
						</td>
					</tr>
					</table>
				</td></tr>
				...
				<tr><td>
					<table cellpadding="0" cellspacing="0" align="center" class="GeneralInfo" style="width:100%;">
							...
							if($_POST){
								if(isset($_POST['ecme'])){
									if($_POST['ecme']<>""){
										...
										$du=$_POST['duEMCE'];
										$au=$_POST['auECME'];
										$duEnvoi=TrsfDate_($_POST['duEMCE']);
										$auEnvoi=TrsfDate_($_POST['auECME']);
						...
						<tr>
							...
							<td width="10%"><input type="date" name="duEMCE" id="duEMCE" value="<?php echo $du; ?>"/></td>
							<td width="10%" align="left">&nbsp; au </td>
							<td width="60%"><input type="date" name="auECME" id="auECME" value="<?php echo $au; ?>"/></td>
						</tr>
						<tr><td height="4"></td></tr>
						<tr>
							<td colspan=4><b>&nbsp; Extracts : </b></td>
