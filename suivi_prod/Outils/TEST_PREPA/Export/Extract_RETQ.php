...
$req.="WHERE sp_olwdossier.Id_Prestation=-15 AND sp_olwdossier.Id_Statut='TERC' AND (sp_olwficheintervention.Id_StatutQUALITE='RETQ PREPA' OR sp_olwficheintervention.Id_StatutQUALITE='RETQ PROD') ";
