...
<form id="formulaire" class="test" method="POST" action="Liste_KPI.php">
				...
				<tr><td>
					<table width="100%" cellpadding="0" cellspacing="0" align="center" class="GeneralInfo">
						...
						<tr>
							...
							<td width="10%"><input type="date" name="duTERC" id="duTERC" value=""/></td>
							<td width="4%" align="left">&nbsp; au </td>
							<td width="60%"><input type="date" name="auTERC" id="auTERC" value=""/></td>
						</tr>
					</td></tr>
					<tr><td height="4"></td></tr>
					<tr>
