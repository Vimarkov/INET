...
if($_POST){
	if($_POST['Mode']=="A"){
		$droit="";
		$requete="INSERT INTO sp_olwretour (Libelle,Id_Statut,EstRetour,Id_Prestation) VALUES ('".addslashes($_POST['libelle'])."','".addslashes($_POST['statut'])."',".$_POST['estRetour'].",1539)";
			...
			<tr class="TitreColsUsers">
				...
				<td>
					<select name="statut" id="statut">
						...
						<option value="TERC" <?php if($_GET['Mode']=="M"){if($Ligne['Id_Statut']=="TERC"){echo "selected";}}?>>TERC</option>
