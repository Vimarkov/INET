...
$req.="WHERE sp_olwdossier.Id_Prestation=1047 AND sp_olwdossier.Id_Statut='TERC' AND (sp_olwficheintervention.Id_StatutQUALITE='TVS' or sp_olwficheintervention.Id_StatutQUALITE='Retour Qualité') ";
