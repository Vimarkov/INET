...
<head>
	...
	<script language="javascript">
		function OuvreFenetreAjout(){
			var w=window.open("Ajout_ECMEClient.php?Mode=A&Id=0","PageUtilisateur","status=no,menubar=no,scrollbars=yes,width=600,height=300");
			w.focus();
			}
		function OuvreFenetreModif(Id){
			var w=window.open("Ajout_ECMEClient.php?Mode=M&Id="+Id,"PageUtilisateur","status=no,menubar=no,scrollbars=yes,width=600,height=300");
			w.focus();
			}
		function OuvreFenetreSuppr(Id){
			if(window.confirm('Etes-vous sûr de vouloir supprimer ?')){
			var w=window.open("Ajout_ECMEClient.php?Mode=S&Id="+Id,"PageUtilisateur","status=no,menubar=no,scrollbars=yes,,width=60,height=40");
			w.focus();
			}
		}
	</script>
...
<form class="test" method="POST" action="Liste_ECMEClient.php">
	<tr>
		<td>
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="4"></td>
					<td class="TitrePage">Liste des ECME Client</td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td align="left">
			<table align="left" style="width:30%;">
				<tr>
				<td align="center">
				<a style='text-decoration:none;' class='Bouton' href='javascript:OuvreFenetreAjout()'>&nbsp;Ajouter un ECME Client&nbsp;</a>
				</td>
				</tr>
			</table>
		</td>
	...
	<tr><td>
		<table cellpadding="0" cellspacing="0" align="left" class="GeneralInfo" style="width:30%;">
			<tr>
				...
				<td class="EnTeteTableauCompetences" width="12%" >&nbsp;Type ECME</td>
				<td class="EnTeteTableauCompetences" width="2%"></td>
				<td class="EnTeteTableauCompetences" width="2%"></td>
			</tr>
			<?php
				$req="SELECT Id,Libelle,(SELECT Libelle FROM sp_olwtypeecmeclient WHERE sp_olwtypeecmeclient.Id=sp_olwecmeclient.Id_Type) AS Type FROM sp_olwecmeclient WHERE Id_Prestation=1047 AND Supprime=false ORDER BY Libelle;";
