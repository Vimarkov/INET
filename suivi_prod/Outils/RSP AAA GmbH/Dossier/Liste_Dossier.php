	...
	<tr>
		<?php
			...
			$req2="SELECT sp_olwficheintervention.Id,
				...
				WHERE sp_olwdossier.Id_Prestation=1047 AND ";
		...
		<td>
			<table width="100%" cellpadding="0" cellspacing="0" align="center" class="GeneralInfo">
				<tr bgcolor="#00325F">
					...
					<td class="EnTeteTableauCompetences" width="5%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=Vacation">Vacation<?php if($_SESSION['TriVacation']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriVacation']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="5%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=TypeDossier">Type dossier<?php if($_SESSION['TriTypeDossier']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriTypeDossier']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="10%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=Reference">N° dossier<?php if($_SESSION['TriReference']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriReference']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="8%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=Localisation">Localisation<?php if($_SESSION['TriLocalisation']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriLocalisation']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="12%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=Titre">Titre<?php if($_SESSION['TriTitre']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriTitre']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="5%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=NumFI">N° IC<?php if($_SESSION['TriNumFI']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriNumFI']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="5%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=StatutPREPA">Statut PREPA<?php if($_SESSION['TriStatutPREPA']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriStatutPREPA']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="8%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=Poste">Poste<?php if($_SESSION['TriPoste']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriPoste']=="ASC"){echo "&darr;";}?></a></td>
					...
					<td class="EnTeteTableauCompetences" width="8%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=StatutPROD">Statut PROD<?php if($_SESSION['TriStatutPROD']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriStatutPROD']=="ASC"){echo "&darr;";}?></a></td>
					...
					<td class="EnTeteTableauCompetences" width="8%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=RetourPROD">Retour PROD<?php if($_SESSION['TriRetourPROD']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriRetourPROD']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="8%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=StatutQUALITE">Statut QUALITE<?php if($_SESSION['TriStatutQUALITE']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriStatutQUALITE']=="ASC"){echo "&darr;";}?></a></td>
							...
							while($row=mysqli_fetch_array($result)){		
								...
								?>
									<tr bgcolor="<?php echo $couleur;?>">
										...
										<td style="text-align:center;border-left:1px solid #0077aa;"><?php echo $row['TypeDossier'];?></td>
										<td style="text-align:center;border-left:1px solid #0077aa;"><?php echo $row['Reference'];?></td>
										<td style="text-align:center;border-left:1px solid #0077aa;"><?php echo $row['Localisation'];?></td>
										<td style="text-align:center;border-left:1px solid #0077aa;"><?php echo str_replace("\\","",stripslashes($row['Titre']));?></td>
										<td style="text-align:center;border-left:1px solid #0077aa;"><?php echo $row['NumFI'];?></td>
										<td style="text-align:center;border-left:1px solid #0077aa;"><?php echo stripslashes($row['Id_StatutPREPA']);?></td>
										...
										<td width="2%" align="center">
											<?php
												...
												if($nbResultaFI>0){
													$rowFI=mysqli_fetch_array($resultFI);
													if($rowFI['Id']==$row['Id']){
														if(($row['StatutPROD']<>"" && $row['StatutPROD']<>"TERA") || ($row['StatutPROD']=="TERA" && $row['StatutQUALITE']<>"" && $row['StatutQUALITE']<>"TERC")){
											?>
