...
<form class="test" method="POST" action="Liste_Zone.php">
	...
	<tr><td>
		<table cellpadding="0" cellspacing="0" align="left" class="GeneralInfo" style="width:30%;">
			...
			<?php
				$req="SELECT Id,Libelle,Intitule,(SELECT sp_criterezone.Libelle FROM sp_criterezone WHERE sp_criterezone.Id= sp_olwzonedetravail.Id_CritereZone) AS Critere FROM sp_olwzonedetravail WHERE Id_Prestation=-16 AND Supprime=false ORDER BY Libelle;";
