...
<form class="test" method="POST" action="Liste_ECME.php">
	...
	<tr><td>
		<table cellpadding="0" cellspacing="0" align="left" class="GeneralInfo" style="width:30%;">
			...
			<?php
				$req="SELECT Id,Libelle,(SELECT Libelle FROM sp_olwtypeecme WHERE sp_olwtypeecme.Id=sp_olwecme.Id_Type) AS Type FROM sp_olwecme WHERE Id_Prestation=1242 AND Supprime=false ORDER BY Libelle;";
