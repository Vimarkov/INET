...
if($_POST){
	if($_POST['Mode']=="A"){
		$droit="";
		$requete="INSERT INTO sp_olwecmeclient (Libelle,Id_Type,Id_Prestation) VALUES ('".addslashes($_POST['libelle'])."',".$_POST['type'].",1242) ";
...
elseif($_GET)
{
	...
	if($_GET['Mode']=="A" || $_GET['Mode']=="M"){
		...
		$req="SELECT Id,Libelle FROM sp_olwecmeclient WHERE Id_Prestation=1242 AND Supprime=0 ";
			...
			<tr>
				...
				<td>
					<select name='type' id='type'>
						...
						<?php
							$req="SELECT Id, Libelle, Supprime FROM sp_olwtypeecmeclient WHERE Id_Prestation=1242 ORDER BY Libelle ";
