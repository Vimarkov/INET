	...
	<tr><td>
		<table cellpadding="0" cellspacing="0" align="center" class="GeneralInfo" style="width:80%;">
			<tr>
				...
				<td class="EnTeteTableauCompetences" width="10%" style="text-align:center;">Préparateur</td>
			...
			<?php
				...
				if ($nbResulta>0){
					...
					while($row=mysqli_fetch_array($result)){
						...
						$result2=mysqli_query($bdd,"SELECT Id, Droit FROM sp_acces WHERE Id_Prestation=1242 AND Id_Personne=".$row['Id']);
