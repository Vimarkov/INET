		...
		<td width="50%" valign="top">
			<table width="100%">
				...
				<tr><td>
					...
					<tr>
						<td align="left" colspan=4>
							<a style="text-decoration:none;" href="#" onClick="javascript:ExtractRETQ()" >&nbsp; &bull; Liste des RETQ des dossiers TERC &nbsp;&nbsp;</a>
						</td>
					</tr>
					<tr>
						<td align="left" colspan=4>
					...
					<tr>
						<td align="left" colspan=4>
							<a style="text-decoration:none;" href="#" onClick="javascript:ExtractTERA2()" >&nbsp; &bull; Liste des TERA ayant été RETQ / RETOUR PREPA / RELANCE / TFS &nbsp;&nbsp;</a>
						</td>
					</tr>
					</table>
				</td></tr>
				...
				<tr><td>
					<table cellpadding="0" cellspacing="0" align="center" class="GeneralInfo" style="width:100%;">
							...
							if($_POST){
								if(isset($_POST['ecme'])){
									if($_POST['ecme']<>""){
										...
										$du=$_POST['duECME'];
										$au=$_POST['auECME'];
										$duEnvoi=TrsfDate_($_POST['duECME']);
						...
						<tr>
							...
							<td width="10%"><input type="date" name="duECME" id="duECME" value="<?php echo $du; ?>"/></td>
