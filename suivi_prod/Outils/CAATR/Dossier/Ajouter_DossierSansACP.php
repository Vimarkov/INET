...
if($_POST){
	if(isset($_POST['btnEnregistrer2'])){
		...
		$dateTERC="0001-01-01";
		//Ajout du dossier
		$req="INSERT INTO sp_olwdossier (Id_Prestation,Id_Personne,MSN,Imputation,Id_Client,";
		...
		$req.=" VALUES (79,".$_SESSION['Id_PersonneSP'].",".$_POST['msn'].",'".$_POST['imputation']."',".$_POST['client'].",";
		...
		if($IdCree<>0){
			...
			$req.="Id_Dossier,Id_Createur,DateCreation,PosteAvionACP,DeroNecessaire,TravailRealise,Commentaire,OutillageSpecifique,StatutPrepa,DatePrepa,PasDePS,PasDeECMEPROD,PasDeECMEQUALITE,PasDeIngredient,ValidationPSCE,ValidationPSIQ";
	...
	<table width="100%" cellpadding="0" cellspacing="0" align="center" class="GeneralInfo">
		...
		<tr>
			...
			<td width='15%'>
				<select id="typeDossier" name="typeDossier">
					...
					<option value="Point OSW">Point OSW</option>
				</select>
			</td>
		</tr>
		<tr><td height="4"></td></tr>
		...
		<tr>
			...
			<td width='15%'>
				<select id="client" name="client">
					...
					<?php
						$req="SELECT Id,Libelle FROM sp_client WHERE Id_Prestation=79 AND Supprime=false ORDER BY Libelle";
		...
		?>
			...
			<td width='15%'>
				<select id="section" name="section">
					<option value=""></option>
					<?php
						$req="SELECT Id,Libelle FROM sp_olwsection WHERE Id_Prestation=79 AND Supprime=false ORDER BY Libelle;";
						$result=mysqli_query($bdd,$req);
						$nbResulta=mysqli_num_rows($result);
						if ($nbResulta>0){
		...
		echo "<tr>";
			...
			echo"<select id='zone' name='zone' ".$disabled.">";
				...
				$req="SELECT Id,Libelle FROM sp_olwzonedetravail  WHERE Id_Prestation=79 AND Supprime=false ORDER BY Libelle;";
				$result=mysqli_query($bdd,$req);
				$nbResulta=mysqli_num_rows($result);
				if ($nbResulta>0){
