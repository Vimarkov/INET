...
<head>
	...
	<script language="javascript">
		...
		function OuvreFenetreModif(Id,Id_Personne,Id_Dossier){
			var w=window.open("Modif_Dossier.php?Mode=M&Id="+Id+"&Id_Personne="+Id_Personne+"&Id_Dossier="+Id_Dossier,"PageDossier","status=no,menubar=no,scrollbars=yes,width=1500,height=700");
			w.focus();
		}
		function OuvreFenetreDupliquer(Id,Id_Personne){
			var w=window.open("Dupliquer_Dossier.php?Id="+Id+"&Id_Personne="+Id_Personne,"PageDupliquer","status=no,menubar=no,scrollbars=yes,width=1500,height=700");
			w.focus();
		}
		...
		<tr>
			...
			<td>
				<select id="programme" name="programme">
					...
					<option value="ATR" <?php if($_POST){if($_POST['programme']=="ATR"){echo "selected";}} ?>>ATR</option>
				</select>
			</td>
			<td>
				&nbsp; Vacation PROD :
		...
		<?php
			...
			if($_SESSION['ModeFiltre']=="oui"){
				...
				$req2.="(SELECT sp_client.Libelle FROM sp_client WHERE sp_client.Id=sp_olwdossier.Id_Client) AS Client,sp_olwdossier.Imputation,sp_olwficheintervention.DateIntervention,sp_olwficheintervention.Vacation,
						...
						CONCAT(IF(Composite=1,'Composite<br>',''),IF(Metal=1,'Metal<br>',''),IF(Structure=1,'Structure',''),IF(Systeme=1,'Systeme','')) AS TypeTravail,";
				...
				$req.="WHERE sp_olwdossier.Id_Prestation=79 AND ";
		...
		<td>
			<table width="100%" cellpadding="0" cellspacing="0" align="center" class="GeneralInfo">
				<tr bgcolor="#00325F">
					...
					<td class="EnTeteTableauCompetences" width="4%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=Programme">Programme<?php if($_SESSION['TriProgramme']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriProgramme']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="6%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=Vacation">Vacation<?php if($_SESSION['TriVacation']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriVacation']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="6%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=TypeTravail">Type de travail<?php if($_SESSION['TriTypeTravail']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriTypeTravail']=="ASC"){echo "&darr;";}?></a></td>
					
					<td class="EnTeteTableauCompetences" width="6%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=OF">SOG/GAMME/PARA<?php if($_SESSION['TriOF']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriOF']=="ASC"){echo "&darr;";}?></a></td>
					...
					<td class="EnTeteTableauCompetences" width="12%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=Zone">Localisation<?php if($_SESSION['TriZone']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriZone']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="15%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=TravailRealise">Sujet Travail à réaliser<?php if($_SESSION['TriTravailRealise']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriTravailRealise']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="6%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=Poste">Poste d'intervention<?php if($_SESSION['TriPoste']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriPoste']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="6%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=DateIntervention">Date intervention<?php if($_SESSION['TriDateIntervention']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriDateIntervention']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="6%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=StatutPROD">Statut PROD<?php if($_SESSION['TriStatutProd']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriStatutProd']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="10%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=RetourPROD">Retour PROD<?php if($_SESSION['TriRetourPROD']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriRetourPROD']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="6%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=StatutQUALITE">Statut QUALITE<?php if($_SESSION['TriStatutQualite']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriStatutQualite']=="ASC"){echo "&darr;";}?></a></td>
					<td class="EnTeteTableauCompetences" width="10%" style="text-align:center;"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_Dossier.php?Tri=RetourQUALITE">Retour QUALITE<?php if($_SESSION['TriRetourQUALITE']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriRetourQUALITE']=="ASC"){echo "&darr;";}?></a></td>
						...
						if($_SESSION['ModeFiltre']=="oui"){
							if ($nbResulta>0){
								...
								while($row=mysqli_fetch_array($result)){		
									...
									$couleur="#ffffff";
									if($row['Id_StatutQUALITE']=="TERC"){$couleur="#407c09";}
									elseif($row['Id_StatutPROD']=="TERA"){$couleur="#b0f472";}
									elseif($row['Id_StatutPROD']=="RETOUR PROD"){$couleur="#e10bea";}
									elseif($row['Id_StatutPROD']=="REWORK"){$couleur="#f8fe68";}
									elseif($row['Id_StatutPROD']=="TFS"){
										if($row['RetourPROD']=="REPOSE"){
											$couleur="#153c8a";
										}
										elseif($row['RetourPROD']=="RESTE DES OP / FINITIONS"){
											$couleur="#53b9e1";
										}
										else{
											$couleur="#fa9696";
