...
if($_GET){
	...
	$req.="sp_olwdossier.Id_Client,sp_olwdossier.Oxygene,sp_olwdossier.Elec,sp_olwdossier.Hydraulique, ";
	$req.="sp_olwdossier.Priorite,sp_olwdossier.CaecACP AS Caec,sp_olwdossier.Fuel,sp_olwdossier.Metal,sp_olwdossier.Structure,sp_olwdossier.Systeme,";
