...
$req="SELECT Id, MSN,SectionACP AS MCA,Priorite,Reference,NumOrigine,Titre,DateCreation,TAI_RestantACP AS TAI_Restant,Mastic,Systeme,Structure,Peinture,";
$req.="Metal,Id_Personne,Id_ZoneDeTravail,Origine,CaecACP AS Caec,CommentaireZICIA,DateCreationACP, ";
