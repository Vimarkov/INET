		...
		<tr>
			...
			<td >
				<select name="section">
					...
					<?php
					$req="SELECT DISTINCT SectionACP FROM sp_olwdossier WHERE Id_Prestation=379 ORDER BY SectionACP;";
					$result=mysqli_query($bdd,$req);
					$nbResulta=mysqli_num_rows($result);
					if ($nbResulta>0){
			...
			<td >
				<select name="zone">
					...
					$req.="WHERE sp_olwzonedetravail.Id=sp_olwdossier.Id_ZoneDeTravail) AS Libelle FROM sp_olwdossier WHERE Id_Prestation=379 ORDER BY Libelle;";
					$result=mysqli_query($bdd,$req);
					$nbResulta=mysqli_num_rows($result);
					if ($nbResulta>0){
						while($row=mysqli_fetch_array($result)){
		...
		<tr>
			...
			<td >
				<select name="createurDossier">
					...
					$req.="FROM sp_olwdossier INNER JOIN new_rh_etatcivil ON sp_olwdossier.Id_Personne=new_rh_etatcivil.Id WHERE Id_Prestation=379 ORDER BY new_rh_etatcivil.Nom, new_rh_etatcivil.Prenom;";
					$result=mysqli_query($bdd,$req);
					$nbResulta=mysqli_num_rows($result);
					if ($nbResulta>0){
						while($row=mysqli_fetch_array($result)){
		...
		<tr>
			...
			<td >
				<select name="client">
					<option name="" value=""></option>
					<?php
					$req="SELECT DISTINCT sp_olwdossier.Id_Client,(SELECT Libelle FROM sp_client WHERE sp_client.Id=sp_olwdossier.Id_Client) AS Client FROM sp_olwdossier WHERE Id_Prestation=379 AND Id_Client<>0 ORDER BY Client;";
					$result=mysqli_query($bdd,$req);
					$nbResulta=mysqli_num_rows($result);
					if ($nbResulta>0){
						while($row=mysqli_fetch_array($result)){
		...
		<tr>
			...
			<td >
				<select name="CE">
					...
					$req.="FROM sp_olwficheintervention WHERE (SELECT sp_olwdossier.Id_Prestation FROM sp_olwdossier WHERE sp_olwdossier.Id=sp_olwficheintervention.Id_Dossier)=379 ORDER BY NomPrenom;";
					$result=mysqli_query($bdd,$req);
					$nbResulta=mysqli_num_rows($result);
					if ($nbResulta>0){
						while($row=mysqli_fetch_array($result)){
		...
		<tr>
			...
			<td >
				<select name="stamp">
					...
					$req.="WHERE Num_Stamp<>'' AND (SELECT sp_olwdossier.Id_Prestation FROM sp_olwdossier WHERE sp_olwdossier.Id=sp_olwficheintervention.Id_Dossier)=379 ORDER BY Num_Stamp;";
					$result=mysqli_query($bdd,$req);
					$nbResulta=mysqli_num_rows($result);
					if ($nbResulta>0){
						while($row=mysqli_fetch_array($result)){
		...
		<tr>
			...
			<td >
				<select name="poste">
					<option name="" value=""></option>
					<?php
					$req="SELECT DISTINCT PosteAvionACP FROM sp_olwficheintervention WHERE (SELECT sp_olwdossier.Id_Prestation FROM sp_olwdossier WHERE sp_olwdossier.Id=sp_olwficheintervention.Id_Dossier)=379 ORDER BY PosteAvionACP;";
					$result=mysqli_query($bdd,$req);
					$nbResulta=mysqli_num_rows($result);
					if ($nbResulta>0){
						while($row=mysqli_fetch_array($result)){
		...
		<tr>
			...
			<td >
				<select name="createurIC">
					...
					<?php
					$req="SELECT DISTINCT new_rh_etatcivil.Id, new_rh_etatcivil.Nom, new_rh_etatcivil.Prenom ";
					$req.="FROM sp_olwficheintervention INNER JOIN new_rh_etatcivil ON sp_olwficheintervention.Id_Createur=new_rh_etatcivil.Id  WHERE (SELECT sp_olwdossier.Id_Prestation FROM sp_olwdossier WHERE sp_olwdossier.Id=sp_olwficheintervention.Id_Dossier)=379 ORDER BY new_rh_etatcivil.Nom, new_rh_etatcivil.Prenom;";
					$result=mysqli_query($bdd,$req);
					$nbResulta=mysqli_num_rows($result);
					if ($nbResulta>0){
						while($row=mysqli_fetch_array($result)){
