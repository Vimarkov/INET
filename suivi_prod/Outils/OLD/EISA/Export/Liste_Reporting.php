...
<table width="100%" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
		<td width="50%" valign="top">
			<table width="100%">
				...
				<tr><td>
					...
					<?php
						echo "<tr><td>&nbsp; Mois : ".$_SESSION['EXTRACT_Mois']."</td></tr>";
					?>
					<tr><td height="4"></td></tr>
						<tr><td height="4"></td></tr>
						<tr>
							<td colspan="2"><a style="text-decoration:none;" href="javascript:Excel_OQD()">&nbsp;&nbsp;&nbsp;&#x2794;&nbsp;&nbsp;OQD&nbsp;</a></td>
						</tr>
					</table>
				</td></tr>
				<tr>
		...
		<td width="50%" valign="top">
			<table width="100%">
				<tr>
					<td class="MoyenTitre">PROD & QUALITE</td>
				</tr>
				<tr><td>
					<table cellpadding="0" cellspacing="0" align="center" class="GeneralInfo" style="width:100%;">
						<?php
							$msn="";
							$dateReporting=AfficheDateFR($DateJour);
							if($_POST){
								$dateReporting=$_POST['dateReporting'];
								if(isset($_POST['btnRA'])){
									if(isset($_POST['dateReporting'])){
										echo "<script>ReportingEmail('".$dateReporting."');</script>";
									}
								}
							}
						?>
						...
						<tr>
							<td width="10%">&nbsp; Date <img src="../../../Images/etoile.png" width="8" height="8" border="0"></td>
							<td width="40%"><input type="date" name="dateReporting" id="dateReporting" size="10" value="<?php echo $dateReporting; ?>"/></td>
					...
					<tr><td>
						<table cellpadding="0" cellspacing="0" align="center" class="GeneralInfo" style="width:100%;">
							...
							<tr>
								<td width="10%">&nbsp; Du <img src="../../../Images/etoile.png" width="8" height="8" border="0"></td>
								<td width="15%"><input type="date" name="duKPI" id="duKPI" size="10" value=""/></td>
								<td width="10%">&nbsp; au <img src="../../../Images/etoile.png" width="8" height="8" border="0"></td>
								<td width="65%"><input type="date" name="auKPI" id="auKPI" size="10" value=""/></td>
							</tr>
							<tr><td height="10"></td></tr>
							<tr>
								<td colspan="4"><a style="text-decoration:none;" href="javascript:Excel_KPI()">&nbsp;&nbsp;&nbsp;&#x2794;&nbsp;&nbsp;KPI&nbsp;</a></td>
							</tr>
						</table>
					</td></tr>
					<tr>
