	...
	<tr><td>
		<table cellpadding="0" cellspacing="0" align="left" class="GeneralInfo" style="width:40%;">
			<tr>
				...
				<td class="EnTeteTableauCompetences" width="5%" >&nbsp;Type moteur</td>
				<td class="EnTeteTableauCompetences" width="5%" >&nbsp;Moteur / Sharklet</td>
				<td class="EnTeteTableauCompetences" width="2%"></td>
				<td class="EnTeteTableauCompetences" width="2%"></td>
			</tr>
			<?php
				$req="SELECT Id,Article, TypeMoteur, MoteurSharklet FROM sp_atrarticle WHERE Id_Prestation=463 ORDER BY Article;";
					...
					while($row=mysqli_fetch_array($result)){
						?>
							<tr bgcolor="<?php echo $couleur;?>">
								...
								<td width="10%">&nbsp;<?php echo $row['TypeMoteur'];?></td>
								<td width="10%">&nbsp;<?php echo $row['MoteurSharklet'];?></td>
