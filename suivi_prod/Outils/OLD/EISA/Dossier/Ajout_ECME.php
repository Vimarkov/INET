...
if($_POST){
	if($_POST['Mode']=="A"){
		$droit="";
		$requete="INSERT INTO sp_atrecme (Libelle,Id_Type,Id_Prestation) VALUES ('".addslashes($_POST['libelle'])."',".$_POST['type'].",463) ";
...
elseif($_GET)
{
	...
	if($_GET['Mode']=="A" || $_GET['Mode']=="M"){
		...
		$req="SELECT Id,Libelle FROM sp_atrecme WHERE Id_Prestation=463 AND Supprime=0 ";
			...
			<tr>
				...
				<td>
					<select name='type' id='type'>
						...
						<?php
							$req="SELECT Id, Libelle, Supprime FROM sp_atrtypeecme WHERE Id_Prestation=463 ORDER BY Libelle ";
