...
<form id="formulaire" class="test" method="POST" action="Liste_Reporting.php">
	...
	<table cellpadding="0" cellspacing="0" align="center" class="GeneralInfo" style="width:35%;">
		...
		<tr>
			<td></td>
			<td align="left">
				&nbsp;<input class="Bouton" type="submit" name="btnRA" value="Valider">
			</td>
		</tr>
	</table>
	</td></tr>
	...
	<table cellpadding="0" cellspacing="0" align="center" class="GeneralInfo" style="width:35%;">
		...
		<tr>
			<td width="4%"></td>
			<td align="left">
				&nbsp;<input class="Bouton" type="submit" name="btnPROD" value="Valider">
			</td>
		</tr>
	</table>
	</td></tr>
	...
	<table cellpadding="0" cellspacing="0" align="center" class="GeneralInfo" style="width:35%;">
		...
		<tr>
			<td width="4%"></td>
			<td align="left">
				&nbsp;<input class="Bouton" type="submit" name="btnQualite" value="Valider">
			</td>
		</tr>
	</table>
	</td></tr>
