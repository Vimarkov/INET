...
if($_POST){
	if($_POST['Mode']=="A"){
		$droit="";
		$requete="INSERT INTO sp_olwzonedetravail (Libelle,Intitule,Id_CritereZone,Id_Prestation) VALUES ('".addslashes($_POST['libelle'])."','".addslashes($_POST['description'])."',".addslashes($_POST['critere']).",842)";
...
?>
		...
		<table width="95%" height="95%" align="center" class="TableCompetences">
			<tr class="TitreColsUsers">
				<td>Libellé </td>
				<td>
					<input type="texte" name="libelle" id="libelle" size="30" value="<?php if($_GET['Mode']=="M"){echo stripslashes($Ligne['Libelle']);}?>">
				</td>
			</tr>
			<tr class="TitreColsUsers">
				<td>Description </td>
				<td>
					<input type="texte" name="description" id="description" size="60" value="<?php if($_GET['Mode']=="M"){echo stripslashes($Ligne['Intitule']);}?>">
				</td>
			</tr>
			<tr class="TitreColsUsers">
				<td>Critère </td>
