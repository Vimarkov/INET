...
<table width="100%" cellpadding="0" cellspacing="0" align="center">
	...
	<tr><td>
		<table cellpadding="0" cellspacing="0" align="left" class="GeneralInfo" style="width:50%;">
			...
			<?php
				$req="SELECT Id,Libelle,Id_Statut,EstRetour FROM sp_olwretour WHERE Id_Prestation=815 AND Supprime=false ORDER BY Libelle;";
					...
					while($row=mysqli_fetch_array($result)){
						?>
							<tr bgcolor="<?php echo $couleur;?>">
								<td width="20%">&nbsp;<?php echo stripslashes($row['Libelle']);?></td>
