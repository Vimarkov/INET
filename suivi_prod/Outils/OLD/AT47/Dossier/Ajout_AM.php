...
if($_POST){
	if($_POST['Mode']=="A"){
		$requete="INSERT INTO sp_atram (DateCreation,Id_Createur,Id_Prestation,MSN,ImputationAAA,NCMajeure,OMAssocie,Id_Type,Recurrence,NumAMNC) ";
		$requete.="VALUES ('".$DateJour."',".$_SESSION['Id_PersonneSP'].",262,".$_POST['msn'].",".$_POST['imputationAAA'].",".$_POST['ncMajeure'].",";
		$requete.="'".$_POST['omAssocie']."',".$_POST['type'].",".$_POST['recurrence'].",'".$_POST['numAMNC']."') ";
...
elseif($_GET)
{
	...
	if($_GET['Mode']=="A" || $_GET['Mode']=="M"){
		...
		if($_GET['Id']!='0'){
			$result=mysqli_query($bdd,"SELECT Id, MSN,ImputationAAA,NCMajeure,OMAssocie,NumAMNC,Id_Type,Recurrence FROM sp_atram WHERE Id=".$_GET['Id']);
