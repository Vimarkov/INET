...
<form class="test" method="POST" action="Liste_ECME.php">
	...
	<tr><td>
		<table cellpadding="0" cellspacing="0" align="left" class="GeneralInfo" style="width:30%;">
			...
			<?php
				$req="SELECT Id,Libelle,(SELECT Libelle FROM sp_atrtypeecme WHERE sp_atrtypeecme.Id=sp_atrecme.Id_Type) AS Type FROM sp_atrecme WHERE Id_Prestation=262 AND Supprime=false ORDER BY Libelle;";
