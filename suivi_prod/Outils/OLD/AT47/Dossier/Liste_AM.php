...
<head>
	...
	<script language="javascript">
		...
		function OuvreFenetreAjout(){
			var w=window.open("Ajout_AM.php?Mode=A&Id=0","PageUtilisateur","status=no,menubar=no,scrollbars=yes,width=500,height=250");
			w.focus();
			}
		function OuvreFenetreModif(Id){
			var w=window.open("Ajout_AM.php?Mode=M&Id="+Id,"PageUtilisateur","status=no,menubar=no,scrollbars=yes,width=500,height=250");
			w.focus();
			}
