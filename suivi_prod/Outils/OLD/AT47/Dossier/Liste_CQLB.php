...
<head>
	...
	<script language="javascript">
		function OuvreFenetreAjout_Critere(){
			var w=window.open("Ajout_CritereCQLB.php?Type=A","PageCritere","status=no,menubar=no,scrollbars=yes,width=800,height=300");
			w.focus();
		}
		function Suppr_Critere(critere,valeur){
			var w=window.open("Ajout_CritereCQLB.php?Type=S&critere="+critere+"&valeur="+valeur,"PageCritere","status=no,menubar=no,scrollbars=yes,width=600,height=300");
			w.focus();
		}
		function OuvreFenetreAjout(){
			var w=window.open("Ajout_CQLB.php?Mode=A&Id=0","PageUtilisateur","status=no,menubar=no,scrollbars=yes,width=600,height=300");
			w.focus();
			}
		function OuvreFenetreModif(Id){
			var w=window.open("Ajout_CQLB.php?Mode=M&Id="+Id,"PageUtilisateur","status=no,menubar=no,scrollbars=yes,width=600,height=300");
			w.focus();
			}
		function OuvreFenetreSuppr(Id){
			if(window.confirm('Etes-vous sûr de vouloir supprimer ?')){
			var w=window.open("Ajout_CQLB.php?Mode=S&Id="+Id,"PageUtilisateur","status=no,menubar=no,scrollbars=yes,,width=60,height=40");
			w.focus();
			}
		}
		function Excel(){
			var w=window.open("ExtractCQLB.php","PageExtract","status=no,menubar=no,scrollbars=yes,width=60,height=40");
			w.focus();
		}
	</script>
...
<form class="test" method="POST" action="Liste_CQLB.php">
	<tr>
		<td>
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="4"></td>
					<td class="TitrePage">Liste des CQLB</td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td align="left">
			<table align="left" style="width:100%;">
				<tr>
				<td align="center">
				<a style='text-decoration:none;' class='Bouton' href='javascript:OuvreFenetreAjout()'>&nbsp;Ajouter un CQLB&nbsp;</a>
				</td>
				</tr>
			</table>
		</td>
	...
	<tr><td>
		<?php
			...
			if($_SESSION['CQLBModeFiltre']=="oui"){
				...
				$req="FROM sp_atrcqlb WHERE Id_Prestation=262 AND ";
	...
	<tr>
		<td align="center" style="font-size:14px;">
			<?php
				if($_SESSION['CQLBModeFiltre']=="oui"){
					$nbPage=0;
					if($_SESSION['CQLBPage']>1){echo "<b> <a style='color:#00599f;' href='Liste_CQLB.php?Page=0'><<</a> </b>";}
					$valeurDepart=1;
					...
					for($i=$valeurDepart; $i<=($valeurDepart+9); $i++){
						if($i<=$nombreDePages){
							if($i==($_SESSION['CQLBPage']+1)){
								...
								echo "<b> <a style='color:#00599f;' href='Liste_CQLB.php?Page=".($i-1)."'>".$i."</a> </b>";
							}
						}
					}
					if($_SESSION['CQLBPage']<($nombreDePages-1)){echo "<b> <a style='color:#00599f;' href='Liste_CQLB.php?Page=".($nombreDePages-1)."'>>></a> </b>";}
				}
			?>
		</td>
	</tr>
		<table cellpadding="0" cellspacing="0" align="left" class="GeneralInfo" style="width:100%;">
			<tr bgcolor="#00325F">
				<td class="EnTeteTableauCompetences" width="6%"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_CQLB.php?Tri=CQLBMSN">MSN<?php if($_SESSION['TriCQLBMSN']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriCQLBMSN']=="ASC"){echo "&darr;";}?></a></td>
				<td class="EnTeteTableauCompetences" width="8%"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_CQLB.php?Tri=CQLBNumCQLB">N° CQLB<?php if($_SESSION['TriCQLBNumCQLB']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriCQLBNumCQLB']=="ASC"){echo "&darr;";}?></a></td>
				<td class="EnTeteTableauCompetences" width="8%"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_CQLB.php?Tri=CQLBNumCV">N° CV<?php if($_SESSION['TriCQLBNumCV']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriCQLBNumCV']=="ASC"){echo "&darr;";}?></a></td>
				<td class="EnTeteTableauCompetences" width="10%"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_CQLB.php?Tri=CQLBLocalisation">Localisation<?php if($_SESSION['TriCQLBLocalisation']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriCQLBLocalisation']=="ASC"){echo "&darr;";}?></a></td>
				<td class="EnTeteTableauCompetences" width="10%"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_CQLB.php?Tri=CQLBImputationAAA">Imputation AAA<?php if($_SESSION['TriCQLBImputationAAA']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriCQLBImputationAAA']=="ASC"){echo "&darr;";}?></a></td>
				<td class="EnTeteTableauCompetences" width="10%"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_CQLB.php?Tri=CQLBOMAssocie">Ordre de montage associé<?php if($_SESSION['TriCQLBOMAssocie']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriCQLBOMAssocie']=="ASC"){echo "&darr;";}?></a></td>
				<td class="EnTeteTableauCompetences" width="20%"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_CQLB.php?Tri=CQLBDesignation">Désignation<?php if($_SESSION['TriCQLBDesignation']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriCQLBDesignation']=="ASC"){echo "&darr;";}?></a></td>
				<td class="EnTeteTableauCompetences" width="10%"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_CQLB.php?Tri=CQLBAMAssociee">AM associée<?php if($_SESSION['TriCQLBAMAssocie']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriCQLBAMAssocie']=="ASC"){echo "&darr;";}?></a></td>
				<td class="EnTeteTableauCompetences" width="12%"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_CQLB.php?Tri=CQLBType">Type<?php if($_SESSION['TriCQLBType']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriCQLBType']=="ASC"){echo "&darr;";}?></a></td>
				<td class="EnTeteTableauCompetences" width="10%"><a style="text-decoration:none;color:#ffffff;font-weight:bold;" id="tri" href="Liste_CQLB.php?Tri=CQLBRecurrence">Récurrence<?php if($_SESSION['TriCQLBRecurrence']=="DESC"){echo "&uarr;";} elseif($_SESSION['TriCQLBRecurrence']=="ASC"){echo "&darr;";}?></a></td>
