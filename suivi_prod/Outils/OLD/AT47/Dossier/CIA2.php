			...
			if($MSN<>"" && $OM<>"" && $NumLigne>0){
				...
				if($nbResulta==0){
					if($NumLigne>1){
						...
						$req="INSERT INTO sp_atrot (MSN,DateCreation,Id_Prestation,OrdreMontage,Designation,Article,PasDeECMEPROD,PasDeECMEQUALITE) VALUES ";
						$req.="(".$MSN.",'".$DateJour."',262,'".$OM."','".addslashes(htmlentities($Gamme))."','".$Article."',1,1);";
						$result=mysqli_query($bdd,$req);
					}
					$NumLigne++;
				}
