...
<table width="100%" cellpadding="0" cellspacing="0" align="center">
	...
	<tr><td>
		<table width="100%" cellpadding="0" cellspacing="0" align="center" class="GeneralInfo">
			...
			//Vérification si l'AM n'existe pas déjà dans sp_olwdossier
			$req="SELECT Id,ReferencePF FROM sp_olwdossier WHERE Id_Prestation=418 AND Id<>".$row['Id_Dossier']."";
			$resultBDD=mysqli_query($bdd,$req);
			$nbBDD=mysqli_num_rows($resultBDD);
			if($nbBDD>0){
				$i=0;
				while($rowRef=mysqli_fetch_array($resultBDD)){
					echo "<script>Liste_ReferencePF[".$i."] = new Array('".$rowRef['Id']."','".$rowRef['ReferencePF']."');</script>\n";
					$i+=1;
				}
			}*/
