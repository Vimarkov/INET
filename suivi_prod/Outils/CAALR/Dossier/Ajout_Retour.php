...
if($_POST){
	if($_POST['Mode']=="A"){
		$droit="";
		$requete="INSERT INTO sp_olwretour (Libelle,Id_Statut,EstRetour,Id_Prestation) VALUES ('".addslashes($_POST['libelle'])."','".addslashes($_POST['statut'])."',".$_POST['estRetour'].",418)";
			...
			<tr class="TitreColsUsers">
				...
				<td>
					<select name="statut" id="statut">
						...
						<option value="RETOUR PREPA" <?php if($_GET['Mode']=="M"){if($Ligne['Id_Statut']=="RETOUR PREPA"){echo "selected";}}?>>RETOUR PREPA</option>
						<option value="RETOUR PROD" <?php if($_GET['Mode']=="M"){if($Ligne['Id_Statut']=="RETOUR PROD"){echo "selected";}}?>>RETOUR PROD</option>
