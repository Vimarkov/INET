...
if($_POST){
	if(isset($_POST['btnEnregistrer2'])){
		...
		//Mise à jour de la fiche d'intervention
		
		$reqSelect = "SELECT Id_StatutPROD,Id_StatutQUALITE,EtatICCIA FROM sp_ficheintervention WHERE Id=".$_POST['idFI'];
		$resultSelect=mysqli_query($bdd,$reqSelect);
		$rowSelect = mysqli_fetch_array($resultSelect);
		if($_POST['typeSaisie']=="PROD"){
			$posteIntervention="";
			/*if(substr($_POST['poste'],0,2)=="L7" || substr($_POST['poste'],0,1)=="A"){$posteIntervention="V70WST";}
			elseif(substr($_POST['poste'],0,2)=="L3"){$posteIntervention="V70WPG";}
			else{$posteIntervention="V10".$_POST['poste'].$_POST['typeIC'];}*/
			...
			$req.="SaisieQualite=0,";
			$req.="ResponsableZone='".addslashes($_POST['responsableZone'])."',";
			...
			if($_POST['numFI']<>""){
				$req.=",EtatICCIA='VALIDEE'";
				$req.=",StatutICCIA=6";
				$req.=",NumFI='".$_POST['numFI']."' ";
			}
			...
			if(substr($_SESSION['DroitSP'],0,1)=='1' || substr($_SESSION['DroitSP'],1,1)=='1'){
				$req.=",CommentaireMICIA='".addslashes($_POST['commentaireMI'])."',";
				$req.="CommentairePOCIA='".addslashes($_POST['commentairePO'])."',";
				$req.="RaisonInterventionCIA='".addslashes($_POST['raisonIntervention'])."',";
				$req.="ESN=".$_POST['esn'].",";
				$req.="TypeCIA='".addslashes($_POST['typeIC'])."',";
				$req.="Id_ActiviteCIA=".$_POST['activite'].",";
				$req.="Id_TypeTravailCIA=".$_POST['typeTravail'].",";
				$req.="RefAInstallerCIA='".addslashes($_POST['refAInstaller'])."',";
				$req.="Id_ImpactElementCIA=".$_POST['impactElement'].",";
				$req.="RefCableCIA='".addslashes($_POST['refCables'])."',";
				$req.="DescriptionTypeTravailCIA='".addslashes($_POST['descriptionTT'])."',";
				$req.="PosteInterventionCIA='".addslashes($posteIntervention)."',";
				$req.="PowerOffPartielCIA=".$_POST['poweroff'].",";
				$req.="InfoSuppPOCIA='".addslashes($_POST['infoAddionnelle'])."',";
				if($_POST['vacation']<>"" && $_POST['dateIntervention']<>"" && ($_POST['etatIC']=="A CREER" || $_POST['etatIC']=="A VALIDER PAR CE")){
					$req.="EtatICCIA='A TRAITER',";
				}
				...
				$req.="DateIntervention='".$dateDebut."',";
				$req.="Vacation='".$vacation."',";
				
				$temps=0;
				if($_POST['tempsObjectif']<>""){$temps=$_POST['tempsObjectif'];}
				$req.="TempsObjectif=".$temps.",";
				$req.="DateFinCIA='".$dateFin."',";
				$req.="HeureDebutCIA='".$heureD."',";
				$req.="HeureFinCIA='".$heureF."' ";
			}
			$modeAnnulee="";
			if(substr($_SESSION['DroitSP'],1,1)=='1'){
				...
				if($_POST['idFIIndicage']>0){
						$req.="RaisonIndicage='".addslashes($_POST['raisonIndicage'])."',";
				}
			...
			if(substr($_SESSION['DroitSP'],4,1)=='1'){
				...
				$req.=",DateInterventionQ='".$dateDebut."',";
				$req.="VacationQ='".$vacation."'";
			...
			if($modeAnnulee=="Oui"){
				$reqAnnule="UPDATE sp_ficheintervention SET EtatICCIA='ANNULEE' WHERE Id<>".$_POST['idFI']." AND Id_Dossier=".$_POST['idDossier']." AND (EtatICCIA='' OR EtatICCIA='A TRAITER' OR EtatICCIA='A VALIDER PAR CE')";
		...
		if(substr($_SESSION['DroitSP'],1,1)=='1' || substr($_SESSION['DroitSP'],4,1)=='1'){
			if(substr($_SESSION['DroitSP'],1,1)=='1'){
				if($_POST['typeSaisie']=="PROD"){
					...
					$req="DELETE FROM sp_fi_travaileffectue WHERE Id_FI=".$_POST['idFI'];
					$resultDelete=mysqli_query($bdd,$req);
					...
					foreach($tabCompagnon as $valeur){
						 if($valeur<>""){
							...
							$req="INSERT INTO sp_fi_travaileffectue (Id_FI,Id_Personne,TempsPasse) VALUES (".$_POST['idFI'].",".$tab2[0].",".$tab2[1].")";
							$resultAjour=mysqli_query($bdd,$req);
						 }
					}

					//Suppression des anciens moyens industriel
					$req="DELETE FROM sp_fi_moyenindustriel WHERE Id_FI=".$_POST['idFI'];
					$resultDelete=mysqli_query($bdd,$req);
					
					//Ajout des moyens industriel
					if(isset($_POST['EclairageNeon'])){
						$req="INSERT INTO sp_fi_moyenindustriel (Id_FI,NumCIA,Libelle) VALUES (".$_POST['idFI'].",'1 Eclairages Néon','Eclairages néons')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['Echelle'])){
						$req="INSERT INTO sp_fi_moyenindustriel (Id_FI,NumCIA,Libelle) VALUES (".$_POST['idFI'].",'2 Echelle','Echelle')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['PlateformeExterieur'])){
						$req="INSERT INTO sp_fi_moyenindustriel (Id_FI,NumCIA,Libelle) VALUES (".$_POST['idFI'].",'3 Plateforme Extérieur','Plateforme extérieur')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['PlateformeMobile'])){
						$req="INSERT INTO sp_fi_moyenindustriel (Id_FI,NumCIA,Libelle) VALUES (".$_POST['idFI'].",'4 Plateforme Mobile','Plateforme mobile')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['ScotchSecurite'])){
						$req="INSERT INTO sp_fi_moyenindustriel (Id_FI,NumCIA,Libelle) VALUES (".$_POST['idFI'].",'5 Scotch De sécurité','Scotch de sécurité')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['MaterielSignaletique'])){
						$req="INSERT INTO sp_fi_moyenindustriel (Id_FI,NumCIA,Libelle) VALUES (".$_POST['idFI'].",'6 Matériel De Signalétique','Matériel de signalétique')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['Autres'])){
						$req="INSERT INTO sp_fi_moyenindustriel (Id_FI,NumCIA,Libelle) VALUES (".$_POST['idFI'].",'7 Autres','Autres')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					
					//Suppression des anciennes mesures de sécurité
					$req="DELETE FROM sp_fi_mesuresecurite WHERE Id_FI=".$_POST['idFI'];
					$resultDelete=mysqli_query($bdd,$req);
					
					//Ajout des mesures de sécurité
					if(isset($_POST['pasDeMesure'])){
						$req="UPDATE sp_ficheintervention SET PasDeMesure=1 WHERE Id=".$_POST['idFI']."";
						$resultAjour=mysqli_query($bdd,$req);
					}
					else{
						$req="UPDATE sp_ficheintervention SET PasDeMesure=0 WHERE Id=".$_POST['idFI']."";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['alimElec'])){
						...
						$req="INSERT INTO sp_fi_mesuresecurite (Id_FI,MesureSecurite,Type,NumCIA) VALUES (".$_POST['idFI'].",'Alimentation électrique','".$_POST['alimElec']."','".$num." Alimentation électrique')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['systemeHVert'])){
						...
						$req="INSERT INTO sp_fi_mesuresecurite (Id_FI,MesureSecurite,Type,NumCIA) VALUES (".$_POST['idFI'].",'Système hydraulique vert','".$_POST['systemeHVert']."','".$num." Système hydraulique vert')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['systemeHJaune'])){
						...
						$req="INSERT INTO sp_fi_mesuresecurite (Id_FI,MesureSecurite,Type,NumCIA) VALUES (".$_POST['idFI'].",'Système hydraulique jaune','".$_POST['systemeHJaune']."','".$num." Système hydraulique jaune')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['systemeHBleu'])){
						...
						$req="INSERT INTO sp_fi_mesuresecurite (Id_FI,MesureSecurite,Type,NumCIA) VALUES (".$_POST['idFI'].",'Système hydraulique bleu','".$_POST['systemeHBleu']."','".$num." Système hydraulique bleu')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['commandeVol'])){
						...
						$req="INSERT INTO sp_fi_mesuresecurite (Id_FI,MesureSecurite,Type,NumCIA) VALUES (".$_POST['idFI'].",'Commandes de vol','".$_POST['commandeVol']."','".$num." Commandes de vol')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['trainAtterissage'])){
						...
						$req="INSERT INTO sp_fi_mesuresecurite (Id_FI,MesureSecurite,Type,NumCIA) VALUES (".$_POST['idFI'].",'Trains d\'atterissage','".$_POST['trainAtterissage']."','".$num." Trains d\'atterissage')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['zeroStress'])){
						...
						$req="INSERT INTO sp_fi_mesuresecurite (Id_FI,MesureSecurite,Type,NumCIA) VALUES (".$_POST['idFI'].",'Condition zéro stress','".$_POST['zeroStress']."','".$num." Condition zéro stress')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['moteurPneu'])){
						...
						$req="UPDATE sp_ficheintervention SET Pneumatique='".$Ref."' WHERE Id=".$_POST['idFI']."";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['pneumatique'])){
						...
						$req="INSERT INTO sp_fi_mesuresecurite (Id_FI,MesureSecurite,Type,NumCIA) VALUES (".$_POST['idFI'].",'Pneumatique','".$_POST['pneumatique']."','".$num." Pneumatique')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['kerozene'])){
						...
						$req="INSERT INTO sp_fi_mesuresecurite (Id_FI,MesureSecurite,Type,NumCIA) VALUES (".$_POST['idFI'].",'Kérozène','".$_POST['kerozene']."','".$num." Kérozène')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['systemeRefroidissementSupp'])){
						...
						$req="INSERT INTO sp_fi_mesuresecurite (Id_FI,MesureSecurite,Type,NumCIA) VALUES (".$_POST['idFI'].",'Système de refroidissement supplémentaire','".$_POST['systemeRefroidissementSupp']."','".$num." Système de refroidissement supplémentaire')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['eauPotable'])){
						...
						$req="INSERT INTO sp_fi_mesuresecurite (Id_FI,MesureSecurite,Type,NumCIA) VALUES (".$_POST['idFI'].",'Eau potable','".$_POST['eauPotable']."','".$num." Eau potable')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					
					//Suppression des risques 
					$req="DELETE FROM sp_fi_risque WHERE Id_FI=".$_POST['idFI'];
					$resultDelete=mysqli_query($bdd,$req);
					
					//Ajout des risques
					if(isset($_POST['TravailHauteur'])){
						$req="INSERT INTO sp_fi_risque (Id_FI,NumCIA,Libelle) VALUES (".$_POST['idFI'].",'1 Travail en hauteur','Travail en hauteur')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['ConduiteEngins'])){
						$req="INSERT INTO sp_fi_risque (Id_FI,NumCIA,Libelle) VALUES (".$_POST['idFI'].",'2 Conduite d\'engins','Conduite d\'engins')";
						$resultAjour=mysqli_query($bdd,$req);
					}
					if(isset($_POST['TravailZoneConfinee'])){
						$req="INSERT INTO sp_fi_risque (Id_FI,NumCIA,Libelle) VALUES (".$_POST['idFI'].",'3 Travail en zone confinée','Travail en zone confinée')";
						$resultAjour=mysqli_query($bdd,$req);
					}
				}
			}
		...
		foreach($tabECME as $valeur){
			 if($valeur<>""){
				...
				if($InfosECME<>""){
					...
					$ECME=$tabECME2[0];
					$req="SELECT Id FROM sp_fi_ecme WHERE ECME='".addslashes($ECME)."' AND Id_FI=".$_POST['idFI'];
		...
		$req="DELETE FROM sp_fi_ecme WHERE ProdQualite=0 AND Id_FI=".$_POST['idFI'];
		$resultDelete=mysqli_query($bdd,$req);
		...
		$req="DELETE FROM sp_fi_ecme WHERE ProdQualite=1 AND Id_FI=".$_POST['idFI'];
		$resultDelete=mysqli_query($bdd,$req);
		...
		$req="DELETE FROM sp_fi_ecmeclient WHERE Id_FI=".$_POST['idFI'];
		$resultDelete=mysqli_query($bdd,$req);
		...
		foreach($tabProduit as $valeur){
			 if($valeur<>""){
				...
				if($InfosProduit<>""){
					...
					$req="SELECT Id FROM sp_fi_ingredient WHERE Ingredient='".addslashes($Produit)."' AND Id_FI=".$_POST['idFI'];
					$resultSelect=mysqli_query($bdd,$req);
		...
		$req="DELETE FROM sp_fi_ingredient WHERE Id_FI=".$_POST['idFI'];
		$resultDelete=mysqli_query($bdd,$req);
		...
		foreach($tabAIPI as $valeur){
			 if($valeur<>""){
				...
				$Qualif=$tabPS[1];
				if($Qualif<>""){
					$req="SELECT Id FROM sp_fi_aipi WHERE Qualification='".addslashes($Qualif)."' AND Id_FI=".$_POST['idFI'];
					$resultSelect=mysqli_query($bdd,$req);
		...
		//Suppression des PS
		$req="DELETE FROM sp_fi_aipi WHERE Id_FI=".$_POST['idFI'];
		$resultDelete=mysqli_query($bdd,$req);
		...
		foreach($tabAIPI as $valeur){
			 if($valeur<>""){
				...
				$Qualif=$tabPS[1];
				$req="INSERT INTO sp_fi_aipi (Id_FI,Id_Qualification,Qualification) VALUES (".$_POST['idFI'].",".$Id_Qualif.",'".addslashes($Qualif)."')";
				$resultAjour=mysqli_query($bdd,$req);
			 }
		}
...
if($_GET){
	...
	if($_GET['Mode']=="M"){
		...
		$req="SELECT sp_ficheintervention.Id,sp_ficheintervention.Id_Dossier,sp_dossier.MSN,sp_dossier.Reference,sp_dossier.SectionACP AS MCA,sp_ficheintervention.DateInterventionQ,sp_ficheintervention.VacationQ,";
		$req.="(SELECT sp_zonedetravail.Libelle FROM sp_zonedetravail WHERE sp_zonedetravail.Id=sp_dossier.Id_ZoneDeTravail) AS Zone,sp_dossier.PNE,ResponsableZone, ";
		...
		$req.="sp_dossier.Priorite,sp_dossier.Titre,sp_ficheintervention.NumFI, sp_ficheintervention.Vacation,sp_dossier.Id_Urgence,sp_ficheintervention.DeposeRepose, ";
		...
		$req.="sp_dossier.Fuel,sp_dossier.Metal,sp_dossier.CommentaireZICIA,sp_ficheintervention.PosteAvionACP,sp_ficheintervention.Id_Pole,sp_ficheintervention.PieceAuPoste,sp_ficheintervention.Id_FIIndicage,sp_ficheintervention.RaisonIndicage,";
		...
		$req.="sp_ficheintervention.DateIntervention,sp_ficheintervention.TravailRealise,sp_ficheintervention.Id_StatutPROD,sp_ficheintervention.Id_StatutQUALITE,sp_ficheintervention.EtatICCIA,sp_ficheintervention.TempsObjectif,sp_ficheintervention.Pneumatique,
			sp_ficheintervention.PasDePS,sp_ficheintervention.ValidationPSCE,sp_ficheintervention.ValidationPSIQ,
			sp_ficheintervention.PasDeECMEPROD,sp_ficheintervention.PasDeECMEQUALITE,sp_ficheintervention.PasDeIngredient ";
	...
	elseif($_GET['Mode']=="S"){
		$req="DELETE FROM sp_ficheintervention WHERE Id=".$FI;
		$resultSuppr=mysqli_query($bdd,$req);
		echo "<script>FermerEtRecharger();</script>";
	}
?>
<form id="formulaire" class="test" method="POST" action="Modif_Dossier.php" onSubmit="return VerifChampsModif();">
<table width="100%" cellpadding="0" cellspacing="0" align="center">
	...
	<table width="100%" cellpadding="0" cellspacing="0" align="center" class="GeneralInfo">
		...
		<tr>
			...
			<td width="20%">
				<input id='numDossier' name='numDossier' value='<?php echo $row['Reference'];?>'></td>
			</td>
			<?php
			/*
				//Vérification si le dossier n'existe pas déjà dans sp_dossier
				$req="SELECT Reference FROM sp_dossier WHERE Id<>".$row['Id_Dossier'];
				$resultBDD=mysqli_query($bdd,$req);
				$nbBDD=mysqli_num_rows($resultBDD);
				if($nbBDD>0){
					$i=0;
					while($rowRef=mysqli_fetch_array($resultBDD)){
						echo "<script>Liste_Reference[".$i."] = new Array('".$rowRef['Reference']."');</script>\n";
						$i+=1;
					}
				}
			*/
		...
		echo "<tr style='display:none;'><td><input id='idFIIndicage' name='idFIIndicage' value='".$row['Id_FIIndicage']."'  readonly='readonly'></td></tr>";
		...
		echo "<tr id='LigneQualite3'>";
			...
			<tr><td height="4"></td></tr>
				...
				<table width="100%" cellpadding="3" cellspacing="0" align="center" class="GeneralInfo">
					...
					<?php
						...
						$reqHistorique .= "WHERE sp_ficheintervention.Id_Dossier=".$row['Id_Dossier']." ORDER BY sp_ficheintervention.DateIntervention";
			...
			<table width="100%" cellpadding="3" cellspacing="0" align="center" class="GeneralInfo">
				...
				<tr>
					<td colspan="2" width="25%" valign="top">
						<table width="100%" cellpadding="0" cellspacing="0" align="center">
							...
							<tr>
								<td width="13%" class="Libelle">&nbsp; Responsable <br> zone : </td>
								<td width="20%">
									<select id="responsableZone" name="responsableZone" <?php echo $disabled;?>>
										<option value=""></option>
										<option value="Cabine" <?php if($row['ResponsableZone']=='Cabine'){echo "selected";} ?>>Cabine</option>
										<option value="Green" <?php if($row['ResponsableZone']=='Green'){echo "selected";} ?>>Green</option>
									</select>
								</td>
							</tr>
							<tr><td height="4" colspan="2"></td></tr>
							...
							<tr>
								...
								<td width="20%">
									<input type="text" name="numFI" value="<?php echo $row['NumFI'];?>" <?php echo $read;?>>
								</td>
							</tr>
							<tr><td height="4" colspan="2"></td></tr>
							<tr>
								<td width="25%" class="Libelle">&nbsp; Créateur : </td>
								<td width="20%">
									<?php echo $row['CreateurFI'];?>
								</td>
							</tr>
							<tr><td height="4" colspan="2"></td></tr>
							<tr>
								<td width="25%" class="Libelle">&nbsp; Date de création : </td>
								<td width="20%">
									<?php echo $row['DateCreationFI'];?>
								</td>
								<td width="13%" class="Libelle"></td>
								<td width="20%">
								</td>
							</tr>
							<tr><td height="4" colspan="2"></td></tr>
							<tr>
								<td colspan="2" width="13%" class="Libelle" id="LibelleTravailRealise" valign="top">&nbsp; Travail à réaliser :  <?php echo $etoile;?></td>
							</tr>
							<tr><td height="4" colspan="2"></td></tr>
							<tr>
							...
							<tr>
								<td colspan="2" width="20%">
									<textarea id="commentaire" name="commentaire" rows="5" cols="40" style="resize:none;" <?php echo $read;?>><?php echo stripslashes($row['Commentaire']);?></textarea>
								</td>
							</tr>
							<tr><td height="4" colspan="2"></td></tr>
						</table>
					...
					<td colspan="2" width="33%" valign="top">
						<table width="100%" id="tableProd" cellpadding="0" cellspacing="0" align="center">
							...
							<?php
								if($row['Id_FIIndicage']>0){
							?>
							<tr>
								<td width="13%" class="Libelle" bgcolor="#dbeef9" valign="top">&nbsp; Raison d'indiçage : </td>
								<td width="20%" bgcolor="#dbeef9">
									<textarea id="raisonIndicage" name="raisonIndicage" rows="5" cols="40" style="resize:none;" <?php echo $readCE;?>><?php echo stripslashes($row['RaisonIndicage']);?></textarea>
								</td>
							</tr>
							<?php
								}
							...
							<tr>
								...
								<td bgcolor="#dbeef9" width="20%">
									<input <?php if(substr($_SESSION['DroitSP'],0,1)=='0' && substr($_SESSION['DroitSP'],1,1)=='0'){echo "type='texte'";}else{echo "type='date'";}?> style="text-align:center;" id="dateIntervention" name="dateIntervention" size="15" <?php echo  $readSTCE;?> value="<?php echo AfficheDateFR($row['DateIntervention']);?>">
								</td>
							</tr>
							...
							<tr>
								<td bgcolor="#dbeef9" width='13%' class="Libelle" valign="top">
									<table cellpadding='0' cellspacing='0' style="-moz-box-shadow: 4px 4px 10px #888;-webkit-box-shadow: 4px 4px 10px #888;box-shadow:4px 4px 6px #888;">
										...
										<tr>
											<td bgcolor='#e4e7f0'>&nbsp; 
											<select id="compagnon" id="compagnon" name="compagnon" onkeypress="if(event.keyCode == 13)AjouterTE()" style="width:130px;">
												<?php
												echo"<option name='0' value='0'></option>";
								...
								<td bgcolor="#dbeef9" width='20%' valign='top'>
									<table id="tab_TravailEffectue" width='100%' cellpadding='0' cellspacing='0'>
										...
										<?php
											...
											$req.="FROM sp_fi_travaileffectue WHERE Id_FI=".$FI." ORDER BY NomPrenom;";
											$result=mysqli_query($bdd,$req);
											$nbResulta=mysqli_num_rows($result);
											if ($nbResulta>0){
							...
							<tr>
								...
								<td width="20%" bgcolor="#dbeef9">
									<select id="statutProd" name="statutProd" onchange="Recharge_StatutProd();" <?php echo $disabledCE;?>>
										<option name="" value=""></option>
										<?php
										//echo "<script>Recharge_StatutProd()</script>";
							...
							<tr>
								...
								<td width="20%" bgcolor="#dbeef9">
									...
									<select id="retourProd" name="retourProd" <?php echo $disabledCE;?>>
										<option name="0" value="0"></option>
										<?php
										$req="SELECT Id, Libelle, Id_Statut,Supprime FROM sp_retour ORDER BY Libelle;";
										$result=mysqli_query($bdd,$req);
										$nbResulta=mysqli_num_rows($result);
										if ($nbResulta>0){
											$i=0;
										...
										<select id="statutQualite" name="statutQualite" onchange="Recharge_StatutQualite();" <?php echo $disabledIQ;?>>
											...
											if ($nbResulta>0){
												...
												while($rowStatut=mysqli_fetch_array($result)){
													...
													if($row['Id_StatutPROD']=="QARJ" || $row['Id_StatutPROD']=="REWORK" || $row['SaisieQualite']==1){
														$selected = "";
							...
							<td bgcolor="#dbeef9" width='65%' valign='top'>
								<table id="tab_ECMEPROD" width='100%' cellpadding='0' cellspacing='0'>
									...
									<?php
										$listeECMEPROD="";
										$req="SELECT Id_ECME,
										IF(Id_ECME>0,sp_ecme.Libelle,sp_fi_ecme.ECME) AS Libelle,
										IF(Id_ECME>0,sp_ecme.Id_Type,sp_fi_ecme.Id_TypeECME) AS Id_Type,
										IF(Id_ECME>0,(SELECT Libelle FROM sp_typeecme WHERE sp_typeecme.Id=sp_ecme.Id_Type),
										(SELECT Libelle FROM sp_typeecme WHERE sp_typeecme.Id=sp_fi_ecme.Id_TypeECME)) AS Type
										FROM sp_fi_ecme 
										LEFT JOIN sp_ecme 
										ON sp_fi_ecme.Id_ECME=sp_ecme.Id 
										WHERE sp_fi_ecme.ProdQualite=0 
							...
							<td bgcolor="#dbeef9" width='65%' valign='top'>
								<table id="tab_ECMEQUALITE" width='100%' cellpadding='0' cellspacing='0'>
									...
									<?php
										...
										LEFT JOIN sp_ecme 
										ON sp_fi_ecme.Id_ECME=sp_ecme.Id 
										WHERE sp_fi_ecme.ProdQualite=1 
										AND Id_FI=".$FI." ORDER BY Libelle;";
										$result=mysqli_query($bdd,$req);
										$nbResulta=mysqli_num_rows($result);
										if ($nbResulta>0){
							...
							<td bgcolor="#dbeef9" width='65%' valign='top'>
								<table id="tab_ECMECLIENT" width='100%' cellpadding='0' cellspacing='0'>
									...
									<?php
										...
										IF(Id_ECME>0,sp_ecmeclient.Libelle,sp_fi_ecmeclient.NumClient) AS Libelle,
										IF(Id_ECME>0,sp_ecmeclient.Id_Type,sp_fi_ecmeclient.Id_TypeECME) AS Id_Type,
										IF(Id_ECME>0,(SELECT Libelle FROM sp_typeecme WHERE sp_typeecme.Id=sp_ecmeclient.Id_Type),
										(SELECT Libelle FROM sp_typeecme WHERE sp_typeecme.Id=sp_fi_ecmeclient.Id_TypeECME)) AS Type
										FROM sp_fi_ecmeclient 
										LEFT JOIN sp_ecmeclient 
										ON sp_fi_ecmeclient.Id_ECME=sp_ecmeclient.Id 
							...
							<td bgcolor="#dbeef9" width='20%' valign='top'>
								<table id="tab_Produit" width='100%' cellpadding='0' cellspacing='0'>
									...
									<?php
										...
										$req.="IF(Id_Ingredient>0,(SELECT sp_ingredient.Libelle FROM sp_ingredient WHERE sp_ingredient.Id=sp_fi_ingredient.Id_Ingredient),sp_fi_ingredient.Ingredient) AS Produit ";
										$req.="FROM sp_fi_ingredient WHERE Id_FI=".$FI." ORDER BY Produit;";
										$result=mysqli_query($bdd,$req);
										$nbResulta=mysqli_num_rows($result);
										if ($nbResulta>0){
											while($rowIngredient=mysqli_fetch_array($result)){
				...
				<?php
				if(substr($_SESSION['DroitSP'],0,1)=='0' && substr($_SESSION['DroitSP'],1,1)=='0' || $row['EtatICCIA']=="VALIDEE" || $row['EtatICCIA']=="REFUSEE" || $row['EtatICCIA']=="A TRAITER"){
				?>
					<tr id="ligneSAP2"><td style="border-top:1px #0077AA dotted;" colspan="6" align="right"><a style="text-decoration:none;" href="javascript:AfficherInfos()"><img id="imageAffichage" src="../../../Images/Moins.gif" border="0" alt="-" title="-"></a>&nbsp;&nbsp;</td></tr>
					<tr style="display:none;"><td><input id='affichage' name='affichage' value='moins'  readonly='readonly'></td></tr>
				<?php
				}
				else{
				?>
					<tr id="ligneSAP2"><td style="border-top:1px #0077AA dotted;" colspan="6" align="right"><a style="text-decoration:none;" href="javascript:AfficherInfos()"><img id="imageAffichage" src="../../../Images/Plus.gif" border="0" alt="+" title="+"></a>&nbsp;&nbsp;</td></tr>
				...
				<tr id="ligneSAP3">
					<td colspan="6" width="33%" valign="top">
						<table width="100%" cellpadding="0" cellspacing="0" align="center">
							<tr class="infoIC" style="display:none;">
								<td width="13%" class="Libelle" valign="top">&nbsp; Etat [IC] : <?php echo $etoileSTCE;?></td>
								<td width="20%" valign="top">
									<select id="etatIC" name="etatIC">
									<?php
										if($row['EtatICCIA']=="A VALIDER PAR CE"){
											if(substr($_SESSION['DroitSP'],1,1)=='1'){
												echo "<option name='ANNULEE' value='ANNULEE'>ANNULEE</option>";
												echo "<option name='A TRAITER' value='A TRAITER' >A TRAITER</option>";
												echo "<option name='A VALIDER PAR CE' value='A VALIDER PAR CE' Selected>A VALIDER PAR CE</option>";
											}
											elseif(substr($_SESSION['DroitSP'],0,1)=='1'){
												echo "<option name='ANNULEE' value='ANNULEE'>ANNULEE</option>";
												echo "<option name='A VALIDER PAR CE' value='A VALIDER PAR CE' Selected>A VALIDER PAR CE</option>";
											}
											else{
										...
										elseif($row['EtatICCIA']=="A TRAITER"){
											if(substr($_SESSION['DroitSP'],1,1)=='1'){
												echo "<option name='ANNULEE' value='ANNULEE'>ANNULEE</option>";
												echo "<option name='A TRAITER' value='A TRAITER' Selected>A TRAITER</option>";
												echo "<option name='A VALIDER PAR CE' value='A VALIDER PAR CE'>A VALIDER PAR CE</option>";
											}
											else{
												echo "<option name='A TRAITER' value='A TRAITER' Selected>A TRAITER</option>";
											}
										}
										elseif($row['EtatICCIA']=="VALIDEE"){
											echo "<option name='VALIDEE' value='VALIDEE' Selected>VALIDEE</option>";
										}
										elseif($row['EtatICCIA']=="REFUSEE"){
											echo "<option name='REFUSEE' value='REFUSEE' Selected>REFUSEE</option>";
										}
										elseif($row['EtatICCIA']=="ANNULEE"){
											if(substr($_SESSION['DroitSP'],1,1)=='1'){
												echo "<option name='ANNULEE' value='ANNULEE' Selected>ANNULEE</option>";
												echo "<option name='A TRAITER' value='A TRAITER' >A TRAITER</option>";
												echo "<option name='A VALIDER PAR CE' value='A VALIDER PAR CE'>A VALIDER PAR CE</option>";
											}
											elseif(substr($_SESSION['DroitSP'],0,1)=='1'){
							...
							<tr class="infoIC">
								...
								<td width="20%" valign="top">
									<select id="typeIC" name="typeIC" <?php echo $disabledSTCE;?>>
										...
										<option name="-T" value="-T" <?php if($row['TypeCIA']=="-T"){echo "selected";} ?>>-T</option>
									</select>
								</td>
							...
							<tr class="infoIC"><td height="4" colspan="6"></td></tr>
							<tr class="infoIC" id="infoElec" <?php if($row['Id_ImpactElementCIA']==0){echo "style=\"display:none;\"";} ?>>
							...
							<tr class="infoIC">
								...
								<td width="13%" class="Libelle" valign="top">&nbsp; Commentaire<br>&nbsp; Power Off Partiel [IC] : </td>
								<td width="20%">
								...
								<td width="13%" class="Libelle" valign="top">&nbsp; Infos additionnelles [IC] : </td>
								<td width="20%" valign="top">
									<textarea id="infoAddionnelle" name="infoAddionnelle" rows="5" cols="30" style="resize:none;" <?php echo $readSTCE;?>><?php echo $row['InfoSuppPOCIA'];?></textarea>
								</td>
							</tr>
							...
							<td width="20%" valign="top">
								<textarea id="commentaireMI" name="commentaireMI" rows="5" cols="30" style="resize:none;" <?php echo $readSTCE;?>><?php echo stripslashes($row['CommentaireMICIA']);?></textarea>
							</td>
