...
if($_POST){
	if(isset($_POST['btnEnregistrer2'])){
		...
		if($_POST['typeSaisie']=="PROD"){
			...
			$req.=$_POST['idDossier'].",".$_SESSION['Id_PersonneSP'].",'".$DateJour."','',".$_POST['pole'].",'".addslashes($_POST['responsableZone'])."',".$_POST['deposeRepose'].",'".addslashes($_POST['travailRealise'])."','".$commentaire."','".addslashes($_POST['pieceauposte'])."'";
			if($_POST['ICaCreer']=="0"){
				if(substr($_SESSION['DroitSP'],0,1)=='1' || substr($_SESSION['DroitSP'],1,1)=='1'){
					$req.=",";
	...
	<tr>
		<td>
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="4"></td>
					<td class="TitrePage">Dupliquer une intervention</td>
				</tr>
			</table>
		</td>
	</tr>
