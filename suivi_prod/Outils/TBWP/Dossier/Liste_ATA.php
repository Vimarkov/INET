...
<head>
	...
	<script language="javascript">
		function OuvreFenetreAjout(){
			var w=window.open("Ajout_ATA.php?Mode=A&Id=0","PageUtilisateur","status=no,menubar=no,scrollbars=yes,width=400,height=120");
			w.focus();
			}
		function OuvreFenetreModif(Id){
			var w=window.open("Ajout_ATA.php?Mode=M&Id="+Id,"PageUtilisateur","status=no,menubar=no,scrollbars=yes,width=400,height=120");
			w.focus();
			}
		function OuvreFenetreSuppr(Id){
			if(window.confirm('Etes-vous sûr de vouloir supprimer ?')){
			var w=window.open("Ajout_ATA.php?Mode=S&Id="+Id,"PageUtilisateur","status=no,menubar=no,scrollbars=yes,width=60,height=40");
			w.focus();
			}
		}
	</script>
...
<form class="test" method="POST" action="Liste_ATA.php">
	<tr>
		<td>
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="4"></td>
					<td class="TitrePage">Liste des ATA/Sous-ATA</td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td align="left">
			<table align="left" style="width:30%;">
				<tr>
				<td align="center">
				<a style='text-decoration:none;' class='Bouton' href='javascript:OuvreFenetreAjout()'>&nbsp;Ajouter un ATA/Sous ATA&nbsp;</a>
				</td>
				</tr>
			</table>
		</td>
	...
	<tr><td height="4"></td></tr>
	<tr><td>
		<table cellpadding="0" cellspacing="0" align="left" class="GeneralInfo" style="width:20%;">
			<tr>
				<td class="EnTeteTableauCompetences" width="10%" >&nbsp;ATA</td>
				<td class="EnTeteTableauCompetences" width="10%" >Sous-ATA</td>
				<td class="EnTeteTableauCompetences" width="2%"></td>
				<td class="EnTeteTableauCompetences" width="2%"></td>
			</tr>
			<?php
				$req="SELECT Id,ATA,SousATA FROM sp_atasousata ORDER BY CAST(ATA as unsigned),CAST(SousATA as unsigned);";
					...
					while($row=mysqli_fetch_array($result)){
						?>
							<tr bgcolor="<?php echo $couleur;?>">
								<td width="10%">&nbsp;<?php echo $row['ATA'];?></td>
								<td width="16%"><?php echo $row['SousATA'];?></td>
