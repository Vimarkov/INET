...
<table width="100%" cellpadding="0" cellspacing="0" align="center">
	...
	<table width="100%" cellpadding="0" cellspacing="0" align="center" class="GeneralInfo">
		...
		if($dossierSelect<>""){
			...
			if ($nbBDD > 0 || $nbACP>0){
				if($nbBDD > 0){
					...
					echo "<tr>";
					echo "<td width='13%' class='Libelle'>&nbsp; Créateur : </td><td width='20%'>".$row['Prenom']." ".$row['Nom']."</td>";
					echo "<td width='13%' class='Libelle'>&nbsp; Date de création : </td><td width='15%'>".$row['DateCreation']."</td>";
					echo "</tr>";
		...
		if($modePoste==1){
			echo "<tr><td colspan='6' align='center' style='color:red;'>Le dossier a été planifié</td></tr>";
		}
		?>
