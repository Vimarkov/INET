...
?>
<form id="formulaire" class="test" method="POST" action="Ajouter_DossierSansACP.php" onSubmit="return VerifChampsSansACP()">
	...
	<tr>
		<td>
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="4"></td>
					<td class="TitrePage">Planifier un nouveau dossier <font color="red">(uniquement si dossier inexistant dans l'onglet "saisir un dossier")</font></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<table width="100%" cellpadding="0" cellspacing="0" align="center" class="GeneralInfo">
		...
		<tr>
			<td colspan="6" align="left">&nbsp; 
				<a style="text-decoration:none;color:#0066CC;" id="saisiePROD" class="Bouton" href="javascript:SaisiePROD()">&nbsp;Saisie PROD&nbsp;</a>&nbsp;&nbsp;
				<a style="text-decoration:none;color:#888888;" id="saisieQUALITE" class="Bouton2" href="javascript:SaisieQUALITE()">&nbsp;Saisie QUALITE&nbsp;</a>
			</td>
		</tr>
		<tr><td height="4"></td></tr>
		<tr>
			...
			<td width="20%">
				<input type="texte" id="numDossier" name="numDossier"/>
			</td>
			<?php
			/*
				//Vérification si le dossier n'existe pas déjà dans sp_dossier
				$req="SELECT Reference FROM sp_dossier ";
		...
		echo "<tr>";
		echo "<td width='13%' class='Libelle'>&nbsp; Type : ".$etoile2." </td>";
		echo "<td width='20%'>";
		?>
			<select id="typeDossier" name="typeDossier" onchange="AfficherOrigine();">
				<option value='DEROGATION'>DEROGATION</option>
				<option value='FORM A'>FORM A</option>
				<option value='OW-S01'>OW-S01</option>
				<option value='OW-S02'>OW-S02</option>
				<option value='OW-S03'>OW-S03</option>
				<option value='OW-S99'>OW-S99</option>
				<option value='OW-GTI'>OW-GTI</option>
				<option value='QSR'>QSR</option>
				<option value='REGUL TPS'>REGUL TPS</option>
				<option value='REAPPRO'>REAPPRO</option>
			</select>
		<?php
		echo "</td>";
		echo "<td width='13%' class='Libelle'>&nbsp; MSN : ".$etoile2." </td>";
		echo "<td width='20%'><input onKeyUp='nombre(this)' id='msn' name='msn' value='' size='5'></td>";
		...
		echo "<tr class='origine' id='LigneQualite0' style='display:none;'>";
		echo "<td width='13%' class='Libelle'>&nbsp; Origine : ".$etoile."</td><td width='20%'>";
			?>
		...
		echo "<td width='13%' class='Libelle'>&nbsp; Tps restant (h) : ".$etoile2." </td><td width='20%'><input onKeyUp='nombre(this)' id='tai' name='tai' value='' ></td>";
		echo "<td width='13%' class='Libelle'>&nbsp; CA/EC : ".$etoile2." </td><td width='20%'><input id='caec' name='caec' value='' ></td>";
		echo "</tr>";
		echo "<tr style='display:none;'>";
		echo "<td width='13%' class='Libelle'>&nbsp; Date création ACP : </td><td width='20%'><input id='dateCreationACP' name='dateCreationACP' value='".$DateJour."' readonly='readonly'></td>";
		echo "<td width='13%' class='Libelle'>&nbsp; ACP ID : </td><td width='20%'><input id='ACP_Id' name='ACP_Id' value='0' readonly='readonly'></td>";
		echo "</tr>";
		echo "</tr>";
		echo "<tr><td height='4'></td></tr>";
		echo "<tr>";
			echo "<td width='13%' id='LibelleUrgence' class='Libelle'>&nbsp; Urgence : </td><td width='20%'>";
		...
		echo "<tr id='LigneQualite3'>";
			...
			?>
				<tr>
				<td><input type="checkbox" id="Fuel" name="Fuel" value="Fuel" <?php echo $disabled;?> >Fuel &nbsp;&nbsp;</td>
				<td><input type="checkbox" id="Elec" name="Elec" value="Elec" <?php echo $disabled;?> >Elec &nbsp;&nbsp;</td>
				<td><input type="checkbox" id="Hydraulique" name="Hydraulique" value="Hydraulique" <?php echo $disabled;?>>Hydraulique &nbsp;&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
				<td><input type="checkbox" id="Oxygene" name="Oxygene" value="Oxygene" <?php echo $disabled;?>>Oxygene &nbsp;&nbsp;</td>
				</tr>
			<?php
			echo "</table>";
			echo "</td>";
			...
			echo "<td width='13%' class='Libelle'>";
				...
				echo "</tr>";
				echo "<tr valign='top'>";
				echo "<td bgcolor='#e4e7f0'>&nbsp;Isolation elec.<br> système : </td>";
				echo "<td bgcolor='#e4e7f0'>";
			...
			echo "<tr><td class='Libelle'>ATA</td><td class='Libelle'>Sous-ATA</td><td class='Libelle'>Isolation elec. système</td><td></td></tr>";
			$listeATA="";
			echo "</table></td>";
		echo "</tr>";
		$nbTempsDossier=0;
		...
		<td width="20%" valign="top">
			<select id="pne" name="pne">
				<option name="0" value="0" <?php if($modeDuplication==1){if($_POST['pne']=="0"){echo "selected";}} ?>>Non</option>
				<option name="1" value="1" <?php if($modeDuplication==1){if($_POST['pne']=="1"){echo "selected";}} ?>>Oui</option>
			</select>
		</td>
		</tr>
		<?php
		...
		<table width="100%" cellpadding="3" cellspacing="0" align="center" class="GeneralInfo">
			...
			<tr>
				<td colspan="2" width="25%" valign="top">
					<table width="100%" cellpadding="0" cellspacing="0" align="center">
						...
						<tr><td height="4" colspan="2"></td></tr>
						<tr>
							<td colspan="2" width="13%" id="LibelleTravailRealise" class="Libelle" valign="top">&nbsp; Travail à réaliser : <?php echo $etoile;?></td>
						</tr>
						<tr><td height="4" colspan="2"></td></tr>
						<tr>
						...
						<tr><td height="4" colspan="2"></td></tr>
						<tr>
							<td colspan="2" width="13%" id="LibelleCommentaire" class="Libelle" valign="top">&nbsp; Commentaire : </td>
						</tr>
						<tr><td height="4" colspan="2"></td></tr>
						<tr>
							<td colspan="2" width="20%">
			...
			<tr id="ligneSAP2">
				<td colspan="6" align="left">
				<input type="radio" id="ICaCreer" name="ICaCreer" onclick="javascript:AfficheIC()" value="0" <?php if($modeDuplication==1){if($_POST['ICaCreer']=="0"){echo "checked";}}else{echo "checked";}?>>IC à créer dans SAP &nbsp;&nbsp;
				...
				<td colspan="6" width="33%" valign="top">
					<table width="100%" cellpadding="0" cellspacing="0" align="center">
						...
						<td width="20%" valign="top">
							<table>
								<tr>
								<td><input type="checkbox" id='EclairageNeon' name='EclairageNeon' value='Eclairages néons' <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if(isset($_POST['EclairageNeon'])){echo "checked";}} ?>>Eclairages néons &nbsp;&nbsp;</td>
								...
								<tr>
								<td><input type="checkbox" id='PlateformeExterieur' name='PlateformeExterieur' value='Plateforme extérieur' <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if(isset($_POST['PlateformeExterieur'])){echo "checked";}} ?>>Plateforme extérieur &nbsp;&nbsp;</td>
								...
								<tr>
								<td><input type="checkbox" id='ScotchSecurite' name='ScotchSecurite' value='Scotch de sécurité' <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if(isset($_POST['ScotchSecurite'])){echo "checked";}} ?>>Scotch de sécurité &nbsp;&nbsp;</td>
								<td><input type="checkbox" id='MaterielSignaletique' name='MaterielSignaletique' value='Matériel de signalétique' <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if(isset($_POST['MaterielSignaletique'])){echo "checked";}} ?>>Matériel de signalétique &nbsp;&nbsp;</td>
								</tr>
								<tr>
						...
						<td colspan="5">
							<table>
								...
								<tr>
									...
									<td><input type="radio" id='alimElec' name='alimElec' value="PasImpact" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['alimElec']=="PasImpact"){echo "checked";}}else{echo "checked";} ?>>Pas d'impact sur le travail à effectuer &nbsp;&nbsp;</td>
									<td><input type="radio" id='alimElec' name='alimElec' value="ADefinir" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['alimElec']=="ADefinir"){echo "checked";}} ?>>A définir par le chef de poste &nbsp;&nbsp;</td>
								</tr>
								<tr>
									...
									<td><input type="radio" id='systemeHVert' name='systemeHVert' value="PasImpact" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['systemeHVert']=="PasImpact"){echo "checked";}}else{echo "checked";}  ?>>Pas d'impact sur le travail à effectuer &nbsp;&nbsp;</td>
									<td><input type="radio" id='systemeHVert' name='systemeHVert' value="ADefinir" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['systemeHVert']=="ADefinir"){echo "checked";}} ?>>A définir par le chef de poste &nbsp;&nbsp;</td>
								</tr>
								<tr>
									...
									<td><input type="radio" id='systemeHJaune' name='systemeHJaune' value="PasImpact" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['systemeHJaune']=="PasImpact"){echo "checked";}}else{echo "checked";}  ?>>Pas d'impact sur le travail à effectuer &nbsp;&nbsp;</td>
									<td><input type="radio" id='systemeHJaune' name='systemeHJaune' value="ADefinir" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['systemeHJaune']=="ADefinir"){echo "checked";}} ?>>A définir par le chef de poste &nbsp;&nbsp;</td>
								</tr>
								<tr>
									...
									<td><input type="radio" id='systemeHBleu' name='systemeHBleu' value="PasImpact" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['systemeHBleu']=="PasImpact"){echo "checked";}}else{echo "checked";}  ?>>Pas d'impact sur le travail à effectuer &nbsp;&nbsp;</td>
									<td><input type="radio" id='systemeHBleu' name='systemeHBleu' value="ADefinir" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['systemeHBleu']=="ADefinir"){echo "checked";}} ?>>A définir par le chef de poste &nbsp;&nbsp;</td>
								</tr>
								<tr>
									...
									<td><input type="radio" id='commandeVol' name='commandeVol' value="PasImpact" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['commandeVol']=="PasImpact"){echo "checked";}}else{echo "checked";}  ?>>Pas d'impact sur le travail à effectuer &nbsp;&nbsp;</td>
									<td><input type="radio" id='commandeVol' name='commandeVol' value="ADefinir" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['commandeVol']=="ADefinir"){echo "checked";}} ?>>A définir par le chef de poste &nbsp;&nbsp;</td>
								</tr>
								<tr>
									...
									<td><input type="radio" id='trainAtterissage' name='trainAtterissage' value="PasImpact" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['trainAtterissage']=="PasImpact"){echo "checked";}}else{echo "checked";}  ?>>Pas d'impact sur le travail à effectuer &nbsp;&nbsp;</td>
									<td><input type="radio" id='trainAtterissage' name='trainAtterissage' value="ADefinir" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['trainAtterissage']=="ADefinir"){echo "checked";}} ?>>A définir par le chef de poste &nbsp;&nbsp;</td>
								</tr>
								<tr>
									...
									<td><input type="radio" id='zeroStress' name='zeroStress' value="PasImpact" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['zeroStress']=="PasImpact"){echo "checked";}}else{echo "checked";}  ?>>Pas d'impact sur le travail à effectuer &nbsp;&nbsp;</td>
									<td><input type="radio" id='zeroStress' name='zeroStress' value="ADefinir" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['zeroStress']=="ADefinir"){echo "checked";}} ?>>A définir par le chef de poste &nbsp;&nbsp;</td>
								</tr>
								<tr>
									<td>Pneumatique   
										...
										<input type="texte" id='numMoteur' name='numMoteur' value="" style="width:30px;" />
									...
									<td><input type="radio" id='pneumatique' name='pneumatique' value="PasImpact" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['pneumatique']=="PasImpact"){echo "checked";}}else{echo "checked";}  ?>>Pas d'impact sur le travail à effectuer &nbsp;&nbsp;</td>
									<td><input type="radio" id='pneumatique' name='pneumatique' value="ADefinir" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['pneumatique']=="ADefinir"){echo "checked";}} ?>>A définir par le chef de poste &nbsp;&nbsp;</td>
								</tr>
								<tr>
									<td>Kérozène</td>
									...
									<td><input type="radio" id='kerozene' name='kerozene' value="PasImpact" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['kerozene']=="PasImpact"){echo "checked";}}else{echo "checked";}  ?>>Pas d'impact sur le travail à effectuer &nbsp;&nbsp;</td>
									<td><input type="radio" id='kerozene' name='kerozene' value="ADefinir" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['kerozene']=="ADefinir"){echo "checked";}} ?>>A définir par le chef de poste &nbsp;&nbsp;</td>
								</tr>
								<tr>
									...
									<td><input type="radio" id='systemeRefroidissementSupp' name='systemeRefroidissementSupp' value="PasImpact" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['systemeRefroidissementSupp']=="PasImpact"){echo "checked";}}else{echo "checked";}  ?>>Pas d'impact sur le travail à effectuer &nbsp;&nbsp;</td>
									<td><input type="radio" id='systemeRefroidissementSupp' name='systemeRefroidissementSupp' value="ADefinir" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['systemeRefroidissementSupp']=="ADefinir"){echo "checked";}} ?>>A définir par le chef de poste &nbsp;&nbsp;</td>
								</tr>
								<tr>
									<td>Eau potable</td>
									...
									<td><input type="radio" id='eauPotable' name='eauPotable' value="PasImpact" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['eauPotable']=="PasImpact"){echo "checked";}}else{echo "checked";}  ?>>Pas d'impact sur le travail à effectuer &nbsp;&nbsp;</td>
									<td><input type="radio" id='eauPotable' name='eauPotable' value="ADefinir" <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if($_POST['eauPotable']=="ADefinir"){echo "checked";}} ?>>A définir par le chef de poste &nbsp;&nbsp;</td>
								</tr>
							</table>
						</td>
						</tr>
						...
						<tr class="infoIC">
							...
							<td width="40%" valign="top" colspan="3">
								<table>
									...
									<td><input type="checkbox" id='TravailZoneConfinee' name='TravailZoneConfinee' value='Travail en zone confinée' <?php echo $disabledSTCE;?> <?php if($modeDuplication==1){if(isset($_POST['TravailZoneConfinee'])){echo "checked";}} ?>>Travail en zone confinée &nbsp;&nbsp;</td>
									</tr>
								</table>
							</td>
						</tr>
