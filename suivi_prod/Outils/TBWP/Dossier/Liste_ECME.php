...
<form class="test" method="POST" action="Liste_ECME.php">
	...
	<tr><td>
		<table cellpadding="0" cellspacing="0" align="left" class="GeneralInfo" style="width:30%;">
			...
			<?php
				$req="SELECT Id,Libelle,(SELECT Libelle FROM sp_typeecme WHERE sp_typeecme.Id=sp_ecme.Id_Type) AS Type FROM sp_ecme WHERE Id_Prestation=255 AND Supprime=false ORDER BY Libelle;";
