	...
	<tr><td>
		<table cellpadding="0" cellspacing="0" align="center" class="GeneralInfo" style="width:90%;">
			<tr>
				...
				<td class="EnTeteTableauCompetences" width="8%" >Plateforme</td>
				<td class="EnTeteTableauCompetences" width="2%"></td>
				<td class="EnTeteTableauCompetences" width="2%"></td>
				<td class="EnTeteTableauCompetences" width="2%"></td>
			</tr>
			<?php
				$req="SELECT Id,Nom,Prenom,Matricule,LoginSP,EmailPro FROM new_rh_etatcivil ORDER BY Nom, Prenom;";
				$result=mysqli_query($bdd,$req);
				$nbResulta=mysqli_num_rows($result);
				if ($nbResulta>0){
					$couleur="#ffffff";
					while($row=mysqli_fetch_array($result)){
						$result2=mysqli_query($bdd,"SELECT Id, Droit FROM sp_acces WHERE Id_Prestation=255 AND Id_Personne=".$row['Id']);
