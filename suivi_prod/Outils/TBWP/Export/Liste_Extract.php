...
<form id="formulaire2" class="test" method="POST" action="Liste_Extract.php">
	<tr><td>
	<table width="100%" cellpadding="0" cellspacing="0" align="center" class="GeneralInfo">
		<tr>
		...
		<?php
			...
			if($_POST){
				if(isset($_POST['duCT'])){
					$duCT=$_POST['duCT'];
					$auCT=$_POST['auCT'];
					$duEnvoiCT=TrsfDate_($_POST['duCT']);
					$auEnvoiCT=TrsfDate_($_POST['auCT']);
					echo "<script>ExtractCT('".$duEnvoiCT."','".$auEnvoiCT."');</script>";
				}
			}
		?>
		<tr>
			<td width="4%">&nbsp; Du <img src="../../../Images/etoile.png" width="8" height="8" border="0"></td>
			<td width="10%"><input type="date" name="duCT" id="duCT" value="<?php echo $duCT; ?>"/></td>
			<td width="4%" align="left">&nbsp; au </td>
			<td width="60%"><input type="date" name="auCT" id="auCT" value="<?php echo $auCT; ?>"/></td>
		</tr>
	</td></tr>
	<tr><td height="4"></td></tr>
	<tr>
	...
	<tr>
		<td align="left" colspan=4>
			<a style="text-decoration:none;" href="#" onClick="document.getElementById('formulaire2').submit()" >&nbsp; &bull; Extract "dossiers mis en production" &nbsp;&nbsp;</a>
		</td>
	</tr>
	</table>
	</td></tr>
...
<form id="formulaire3" class="test" method="POST" action="Liste_Extract.php">
<table width="100%" cellpadding="0" cellspacing="0" align="center">
	<tr><td height="4"></td></tr>
	<tr>
			...
			<table width="100%">
				...
				<tr><td>
					<table cellpadding="0" cellspacing="0" align="center" class="GeneralInfo" style="width:100%;">
						...
						<tr>
							<td align="left" colspan=4>
								<a style="text-decoration:none;" href="#" onClick="document.getElementById('formulaire3').submit()" >&nbsp; &bull; Extract "Suivi des mesures effectuées avec un ECME" &nbsp;&nbsp;</a>
							</td>
						</tr>
					</table>
				</td></tr>
