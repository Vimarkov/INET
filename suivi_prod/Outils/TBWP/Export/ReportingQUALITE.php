...
if($laVacation=="VSD"){
	...
	if($pole==-1){$req.=" sp_ficheintervention.DateInterventionQ='".$leJour."' AND sp_ficheintervention.Id_StatutQUALITE<>'' AND sp_ficheintervention.VacationQ='".$vacation."' AND sp_ficheintervention.Id_Pole IN (2,6))) ";}
	else{$req.=" sp_ficheintervention.DateInterventionQ='".$leJour."' AND sp_ficheintervention.Id_StatutQUALITE<>'' AND sp_ficheintervention.VacationQ='".$vacation."' AND sp_ficheintervention.Id_Pole=".$pole.")) ";}
}
