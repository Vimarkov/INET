...
$req="SELECT sp_olwdossier.Id, sp_olwdossier.MSN,sp_olwdossier.Reference,(SELECT Libelle FROM sp_client WHERE Id=Id_Client) AS Client,sp_olwficheintervention.DateTERC ";
$req.="FROM sp_olwficheintervention LEFT JOIN sp_olwdossier ON sp_olwficheintervention.Id_Dossier=sp_olwdossier.Id ";
$req.="WHERE sp_olwdossier.Id_Prestation=316 AND sp_olwficheintervention.Id_StatutQUALITE='TERC' ";
