...
if($_POST){
	if($_POST['Mode']=="A"){
		...
		$requete.="VALUES ('".$DateJour."',".$_SESSION['Id_PersonneSP'].",316,".$_POST['msn'].",'".$_POST['numCQLB']."','".$_POST['numCV']."',";
...
elseif($_GET)
{
	...
	if($_GET['Mode']=="A" || $_GET['Mode']=="M"){
		$req="SELECT OrdreMontage, Designation FROM sp_atrot WHERE Id_Prestation=16";
